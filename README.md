...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.8K · 🔀 23K · 📥 830 · 📦 440K · 📋 9.8K - 15% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 9.2K · 📋 30K - 32% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/torch) (📥 7.9M / month):
	```
	pip install torch
	```
...
- [GitHub](https://github.com/google/jax) (👨‍💻 490 · 🔀 1.9K · 📦 6.7K · 📋 3.8K - 25% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 280 · 🔀 3.6K · 📥 180K · 📦 17K · 📋 2.9K - 7% open · ⏱️ 03.01.2023):
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">StatsModels</a></b> (🥇43 ·  ⭐ 8.1K) - Statsmodels: statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 900 · 🔀 4.7K · 📥 15K · 📦 180 · 📋 16K - 12% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/PaddlePaddle/Paddle
	```
- [PyPi](https://pypi.org/project/paddlepaddle) (📥 88K / month):
	```
	pip install paddlepaddle
	```
</details>
<details><summary><b><a href="https://github.com/keras-team/keras">Keras</a></b> (🥈40 ·  ⭐ 57K) - Deep Learning for humans. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 230 · 🔀 7.1K · 📦 12K · 📋 1.7K - 7% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 160 · 🔀 2K · 📦 430 · 📋 1.8K - 1% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/jina-ai/jina
	```
- [PyPi](https://pypi.org/project/jina) (📥 64K / month):
	```
	pip install jina
	```
- [Conda](https://anaconda.org/conda-forge/jina-core) (📥 35K · ⏱️ 16.08.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/jinaai/jina) (📥 1.2M · ⭐ 7 · ⏱️ 03.01.2023):
	```
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.8K · 🔀 25K · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/Lightning-AI/lightning) (👨‍💻 810 · 🔀 2.6K · 📥 10K · 📋 5.7K - 9% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://github.com/catboost/catboost">Catboost</a></b> (🥈37 ·  ⭐ 6.9K) - A fast, scalable, high performance Gradient Boosting on Decision.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/catboost/catboost) (👨‍💻 1K · 🔀 1K · 📥 110K · 📋 1.9K - 23% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://github.com/google/flax">Flax</a></b> (🥈36 ·  ⭐ 3.9K) - Flax is a neural network library for JAX that is designed for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/flax) (👨‍💻 180 · 🔀 440 · 📥 42 · 📦 1.9K · 📋 620 - 11% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/flax) (📥 230K / month):
	...
	pip install flax
	```
- [Conda](https://anaconda.org/conda-forge/flax) (📥 17K · ⏱️ 04.10.2022):
	```
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 59 · 🔀 250 · 📦 26K · 📋 130 - 12% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 320 · 🔀 1.7K · 📋 1.2K - 9% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/VowpalWabbit/vowpal_wabbit
	```
- [PyPi](https://pypi.org/project/vowpalwabbit) (📥 150K / month):
	```
	pip install vowpalwabbit
	```
- [Conda](https://anaconda.org/conda-forge/vowpalwabbit) (📥 97K · ⏱️ 09.11.2022):
	```
...
- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 22 · 🔀 270 · 📦 6.2K · 📋 130 - 25% open · ⏱️ 27.12.2022):
...
- [PyPi](https://pypi.org/project/einops) (📥 1.5M / month):
	...
	pip install einops
	```
- [Conda](https://anaconda.org/conda-forge/einops) (📥 61K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 130 · 🔀 980 · 📦 140 · 📋 870 - 23% open · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/chainer/chainer">Chainer</a></b> (🥉32 ·  ⭐ 5.8K) - A flexible framework of neural networks for deep learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.7K · 🔀 11K · ⏱️ 05.01.2023):

	```
	git clone https://github.com/apache/flink
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 57K / month):
	```
...
- [PyPi](https://pypi.org/project/tensorpack) (📥 12K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorpack) (📥 6.2K · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 52 · 🔀 320 · 📦 640 · 📋 460 - 10% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 68 · 🔀 190 · 📦 690 · 📋 210 - 27% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/deepmind/dm-haiku
	```
- [PyPi](https://pypi.org/project/dm-haiku) (📥 100K / month):
	```
	pip install dm-haiku
	```
- [Conda](https://anaconda.org/conda-forge/dm-haiku) (📥 8.3K · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 4.2K · 🔀 74 · 📥 20 · 📋 330 - 17% open · ⏱️ 23.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-rocm) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/clab/dynet) (👨‍💻 160 · 🔀 670 · 📥 8.4K · 📦 230 · 📋 930 - 28% open · ⏱️ 14.08.2022):

	```
	git clone https://github.com/clab/dynet
	```
- [PyPi](https://pypi.org/project/dyNET) (📥 3K / month):
	```
	pip install dyNET
	```
</details>
...
- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 15 · 🔀 250 · 📦 370 · 📋 440 - 0% open · ⏱️ 13.12.2022):
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 180 · 🔀 550 · 📋 1.1K - 9% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 23 · 🔀 210 · 📥 260 · 📦 55 · 📋 130 - 37% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/nubank/fklearn) (👨‍💻 50 · 🔀 160 · 📦 13 · 📋 48 - 52% open · ⏱️ 21.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/fklearn) (📥 3K / month):
	```
	pip install fklearn
	```
</details>
...
- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 29 · 🔀 180 · 📥 860 · 📋 530 - 2% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/towhee-io/towhee
	```
- [PyPi](https://pypi.org/project/towhee) (📥 810 / month):
	```
	pip install towhee
	```
</details>
...
- [GitHub](https://github.com/itdxer/neupy) (👨‍💻 8 · 🔀 160 · 📦 140 · 📋 270 - 12% open · ⏱️ 03.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/neupy) (📥 4.9K / month):
	```
	pip install neupy
	```
</details>
...
- [GitHub](https://github.com/Xtra-Computing/thundersvm) (👨‍💻 34 · 🔀 200 · 📥 2.5K · 📋 210 - 29% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/thundersvm) (📥 320 / month):
	```
...
- [GitHub](https://github.com/poets-ai/elegy) (👨‍💻 18 · 🔀 31 · 📦 23 · 📋 100 - 36% open · ⏱️ 23.05.2022):

	```
	git clone https://github.com/poets-ai/elegy
	```
- [PyPi](https://pypi.org/project/elegy) (📥 380 / month):
	```
	pip install elegy
	```
</details>
...
- [GitHub](https://github.com/serengil/chefboost) (👨‍💻 6 · 🔀 92 · 📦 30 · 📋 30 - 10% open · ⏱️ 21.05.2022):
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.5K · 🔀 6.5K · 📦 690K · 📋 9.2K - 17% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/dash) (📥 870K / month):
	...
	pip install dash
	```
- [Conda](https://anaconda.org/conda-forge/dash) (📥 760K · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/plotly/plotly.py) (👨‍💻 210 · 🔀 2.2K · 📦 13 · 📋 2.5K - 50% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/plotly/plotly.py
	```
- [PyPi](https://pypi.org/project/plotly) (📥 6.6M / month):
	```
	pip install plotly
	```
- [Conda](https://anaconda.org/conda-forge/plotly) (📥 3.6M · ⏱️ 05.12.2022):
	```
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 38 · 🔀 2.7K · 📦 2.7K · 📋 1.7K - 0% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 110 · 🔀 290 · 📥 680 · 📦 1.1K · 📋 1K - 30% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 82K / month):
	```
	pip install pyvista
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 51 · 🔀 350 · 📦 1.7K · 📋 520 - 23% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/holoviz/datashader
	```
- [PyPi](https://pypi.org/project/datashader) (📥 41K / month):
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 19 · 🔀 180 · 📦 39K · 📋 150 - 4% open · ⏱️ 24.11.2022):

	```
	git clone https://github.com/xflr6/graphviz
	```
- [PyPi](https://pypi.org/project/graphviz) (📥 8.6M / month):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 29 · 🔀 310 · 📦 590 · 📋 490 - 9% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 130 · 🔀 360 · 📋 2.9K - 32% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 39 · 🔀 78 · 📦 2.2K · 📋 580 - 39% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/holoviz/hvplot
	```
- [PyPi](https://pypi.org/project/hvplot) (📥 100K / month):
	```
	pip install hvplot
	```
...
- [GitHub](https://github.com/amueller/word_cloud) (👨‍💻 67 · 🔀 2.2K · 📋 480 - 22% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/wordcloud) (📥 810K / month):
	```
...
- [GitHub](https://github.com/ResidentMario/missingno) (👨‍💻 17 · 🔀 430 · 📦 9.7K · 📋 120 - 7% open · ⏱️ 27.02.2022):
...
<details><summary><b><a href="https://github.com/voxel51/fiftyone">FiftyOne</a></b> (🥈29 ·  ⭐ 2.4K) - Visualize, create, and debug image and video datasets.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 68 · 🔀 280 · 📋 1.1K - 34% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 25 · 🔀 140 · 📥 370 · 📦 600 · 📋 150 - 13% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/pavlin-policar/openTSNE) (👨‍💻 10 · 🔀 130 · 📦 430 · 📋 110 - 3% open · ⏱️ 02.12.2022):
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 18 · 🔀 40 · 📥 370 · 📦 20 · 📋 300 - 23% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/spotify/chartify) (👨‍💻 23 · 🔀 290 · 📦 71 · 📋 72 - 56% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/chartify) (📥 7.2K / month):
	```
...
<details><summary><b><a href="https://github.com/AutoViML/AutoViz">AutoViz</a></b> (🥉23 ·  ⭐ 1K) - Automatically Visualize any dataset, any size with a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/AutoViz) (👨‍💻 14 · 🔀 140 · 📦 320 · 📋 62 - 6% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/AutoViML/AutoViz
	```
- [PyPi](https://pypi.org/project/autoviz) (📥 53K / month):
	```
	pip install autoviz
	```
...
- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 16 · 🔀 31 · 📥 38 · 📦 18 · 📋 44 - 25% open · ⏱️ 19.10.2022):

	```
	git clone https://github.com/ing-bank/popmon
	```
- [PyPi](https://pypi.org/project/popmon) (📥 29K / month):
	```
	pip install popmon
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/hiplot) (👨‍💻 8 · 🔀 120 · 📦 5 · 📋 83 - 14% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/facebookresearch/hiplot
	```
- [PyPi](https://pypi.org/project/hiplot) (📥 40K / month):
	```
	pip install hiplot
	```
...
- [GitHub](https://github.com/marcharper/python-ternary) (👨‍💻 27 · 🔀 140 · 📥 18 · 📦 110 · 📋 130 - 20% open · ⏱️ 31.12.2022):
...
<details><summary><b><a href="https://github.com/fbdesignpro/sweetviz">Sweetviz</a></b> (🥉21 ·  ⭐ 2.3K · 💤) - Visualize and compare datasets, target values and associations, with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gyli/PyWaffle) (👨‍💻 6 · 🔀 98 · 📦 180 · 📋 18 - 22% open · ⏱️ 08.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pywaffle) (📥 4.6K / month):
	```
...
- <b><a href="https://github.com/PAIR-code/facets">Facets Overview</a></b> (🥉27 ·  ⭐ 7.1K · 💀) - Visualizations for machine learning datasets. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/jupyter-widgets/pythreejs">pythreejs</a></b> (🥉25 ·  ⭐ 840) - A Jupyter - Three.js bridge. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/leotac/joypy">joypy</a></b> (🥉21 ·  ⭐ 460 · 💀) - Joyplots in Python with matplotlib & pandas. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 1.7K · 🔀 17K · 📥 630 · 📦 45K · 📋 11K - 4% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/transformers) (📥 7.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transformers) (📥 700K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 710 · 🔀 3.9K · 📦 48K · 📋 5.3K - 1% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/nltk/nltk) (👨‍💻 440 · 🔀 2.5K · 📦 170K · 📋 1.7K - 12% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 570 · 🔀 4.1K · 📦 2.9K · 📋 6.6K - 8% open · ⏱️ 16.12.2022):
...
- [GitHub](https://github.com/facebookresearch/fairseq) (👨‍💻 410 · 🔀 5K · 📥 280 · 📦 1.1K · 📋 3.7K - 20% open · ⏱️ 20.12.2022):

	```
	git clone https://github.com/pytorch/fairseq
	```
- [PyPi](https://pypi.org/project/fairseq) (📥 44K / month):
	```
	pip install fairseq
	```
...
- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 110 · 🔀 1.8K · 📦 5.2K · 📋 1.6K - 52% open · ⏱️ 28.11.2022):
...
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 1.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sentence-transformers) (📥 64K · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 130 · 🔀 610 · 📦 220 · 📋 750 - 2% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 72 · 🔀 820 · 📥 24K · 📦 21K · 📋 560 - 3% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/google/sentencepiece
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 7.5M / month):
	```
...
- [GitHub](https://github.com/facebookresearch/fastText) (👨‍💻 59 · 🔀 4.4K · 📦 3.7K · 📋 1K - 41% open · ⏱️ 04.03.2022):

	```
	git clone https://github.com/facebookresearch/fastText
	```
- [PyPi](https://pypi.org/project/fasttext) (📥 980K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 200 · 🔀 1.9K · 📦 100 · 📋 1.5K - 4% open · ⏱️ 03.01.2023):
...
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥈34 ·  ⭐ 6.3K) - Haystack is an open source NLP framework that leverages pre-trained.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 150 · 🔀 950 · 📥 15 · 📦 260 · 📋 1.8K - 13% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 180 · 🔀 2K · 📦 160 · 📋 1.3K - 2% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 65 · 🔀 510 · 📦 54 · 📋 700 - 30% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/tokenizers) (📥 8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tokenizers) (📥 650K · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/allenai/allennlp) (👨‍💻 260 · 🔀 2.2K · 📥 53 · 📋 2.6K - 3% open · ⏱️ 22.11.2022):

	```
	git clone https://github.com/allenai/allennlp
	```
- [PyPi](https://pypi.org/project/allennlp) (📥 95K / month):
	```
...
- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 200 · 🔀 1.3K · 📥 16K · 📋 1.4K - 2% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/deeppavlov/DeepPavlov) (👨‍💻 73 · 🔀 1.1K · 📦 310 · 📋 620 - 8% open · ⏱️ 22.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/deeppavlov) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 140 · 🔀 730 · 📋 700 - 33% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/pytorch/text
	```
- [PyPi](https://pypi.org/project/torchtext) (📥 860K / month):
	```
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 84 · 🔀 500 · 📦 1.1K · 📋 530 - 44% open · ⏱️ 25.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/gluonnlp) (📥 620K / month):
	```
...
- [GitHub](https://github.com/jamesturk/jellyfish) (👨‍💻 28 · 🔀 150 · 📦 4.8K · 📋 110 - 7% open · ⏱️ 31.12.2022):
...
- [PyPi](https://pypi.org/project/jellyfish) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jellyfish) (📥 430K · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 27 · 🔀 170 · 📦 570 · 📋 280 - 10% open · ⏱️ 06.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/scispacy) (📥 68K / month):
	```
	pip install scispacy
	```
</details>
<details><summary><b><a href="https://github.com/makcedward/nlpaug">nlpaug</a></b> (🥈28 ·  ⭐ 3.7K) - Data augmentation for NLP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/makcedward/nlpaug) (👨‍💻 33 · 🔀 410 · 📦 510 · 📋 200 - 23% open · ⏱️ 07.07.2022):

	```
	git clone https://github.com/makcedward/nlpaug
	```
- [PyPi](https://pypi.org/project/nlpaug) (📥 200K / month):
	```
	pip install nlpaug
	```
- [Conda](https://anaconda.org/conda-forge/nlpaug) (📥 6.4K · ⏱️ 07.07.2022):
	```
...
<details><summary><b><a href="https://github.com/miso-belica/sumy">Sumy</a></b> (🥈28 ·  ⭐ 3K) - Module for automatic summarization of text documents and HTML pages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 61 · 🔀 440 · 📥 66 · 📦 110 · 📋 200 - 24% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/fastnlp) (📥 3.4K / month):
	```
	pip install fastnlp
	```
</details>
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 20 · 🔀 150 · 📦 780 · ⏱️ 28.12.2022):
...
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spacy-transformers) (📥 7.5K · ⏱️ 29.12.2022):
	```
...
- [GitHub](https://github.com/cltk/cltk) (👨‍💻 120 · 🔀 310 · 📥 25 · 📦 220 · 📋 530 - 4% open · ⏱️ 16.10.2022):
...
<details><summary><b><a href="https://github.com/life4/textdistance">TextDistance</a></b> (🥈27 ·  ⭐ 3K) - Compute distance between sequences. 30+ algorithms, pure python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Ciphey/Ciphey) (👨‍💻 46 · 🔀 690 · 📋 300 - 14% open · ⏱️ 05.12.2022):
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 54 · 🔀 620 · 📦 140 · 📋 390 - 12% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/cjhutto/vaderSentiment) (👨‍💻 11 · 🔀 900 · 📦 4.6K · 📋 110 - 32% open · ⏱️ 01.04.2022):

	```
	git clone https://github.com/cjhutto/vaderSentiment
	```
- [PyPi](https://pypi.org/project/vadersentiment) (📥 110K / month):
	```
...
- [GitHub](https://github.com/argilla-io/argilla) (👨‍💻 34 · 🔀 130 · 📦 6 · 📋 800 - 16% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/recognai/rubrix
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 960 / month):
	```
	pip install rubrix
	```
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 18 · 🔀 230 · 📥 44K · 📦 210 · 📋 110 - 18% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 13 · 🔀 270 · 📦 330 · 📋 92 - 19% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/scattertext) (📥 4.4K / month):
	```
...
- [GitHub](https://github.com/dwyl/english-words) (👨‍💻 30 · 🔀 1.6K · 📋 94 - 65% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/english-words) (📥 170K / month):
	```
	pip install english-words
	```
</details>
<details><summary><b><a href="https://github.com/qdrant/qdrant">qdrant</a></b> (🥉23 ·  ⭐ 3.6K) - Qdrant - Vector Search Engine and Database for the next generation of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 28 · 🔀 160 · 📋 340 - 6% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 18 · 🔀 260 · 📦 28 · 📋 190 - 22% open · ⏱️ 09.11.2022):
...
<details><summary><b><a href="https://github.com/unitaryai/detoxify">detoxify</a></b> (🥉23 ·  ⭐ 530) - Trained models & code to predict toxic comments on all 3 Jigsaw.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 9 · 🔀 73 · 📥 110K · 📦 180 · 📋 45 - 55% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 35K / month):
	```
...
- [GitHub](https://github.com/nyu-mll/jiant) (👨‍💻 59 · 🔀 270 · 📦 2 · 📋 550 - 11% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/jiant) (📥 76 / month):
	```
	pip install jiant
	```
</details>
<details><summary><b><a href="https://github.com/RUCAIBox/TextBox">TextBox</a></b> (🥉21 ·  ⭐ 800) - TextBox 2.0 is a text generation library with pre-trained language models. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 18 · 🔀 91 · 📦 5 · ⏱️ 28.12.2022):

	```
	git clone https://github.com/RUCAIBox/TextBox
	```
- [PyPi](https://pypi.org/project/textbox) (📥 34 / month):
	```
	pip install textbox
	```
</details>
...
<details><summary><b><a href="https://github.com/jbesomi/texthero">Texthero</a></b> (🥉20 ·  ⭐ 2.7K) - Text preprocessing, representation and visualization from zero to hero. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jbesomi/texthero) (👨‍💻 20 · 🔀 230 · 📥 96 · 📋 120 - 46% open · ⏱️ 28.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/texthero) (📥 17K / month):
	```
	pip install texthero
	```
</details>
<details><summary><b><a href="https://github.com/EricFillion/happy-transformer">happy-transformer</a></b> (🥉20 ·  ⭐ 380) - A package built on top of Hugging Faces transformers.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/EricFillion/happy-transformer) (👨‍💻 14 · 🔀 47 · 📦 110 · 📋 110 - 15% open · ⏱️ 31.10.2022):
...
<details><summary><b><a href="https://github.com/thunlp/OpenNRE">OpenNRE</a></b> (🥉17 ·  ⭐ 3.9K) - An Open-Source Package for Neural Relation Extraction (NRE). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pytorch/translate) (👨‍💻 87 · 🔀 180 · 📋 38 - 28% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-translate) (📥 8 / month):
	```
	pip install pytorch-translate
	```
</details>
<details><summary><b><a href="https://github.com/Ki6an/fastT5">fastT5</a></b> (🥉15 ·  ⭐ 400 · 💤) - boost inference speed of T5 models by 5x & reduce the model size.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Ki6an/fastT5) (👨‍💻 5 · 🔀 47 · 📦 24 · 📋 54 - 25% open · ⏱️ 05.04.2022):

	```
	git clone https://github.com/Ki6an/fastT5
	```
- [PyPi](https://pypi.org/project/fastt5) (📥 750 / month):
	```
	pip install fastt5
	```
</details>
...
- <b><a href="https://github.com/nipunsadvilkar/pySBD">pySBD</a></b> (🥉23 ·  ⭐ 550 · 💀) - pySBD (Python Sentence Boundary Disambiguation) is a rule-based sentence.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/chartbeat-labs/textacy">textacy</a></b> (🥉22 ·  ⭐ 2K · 💤) - NLP, before and after spaCy. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/anhaidgroup/deepmatcher">DeepMatcher</a></b> (🥉17 ·  ⭐ 460 · 💀) - Python package for performing Entity and Text Matching using.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/rwightman/pytorch-image-models) (👨‍💻 89 · 🔀 3.7K · 📥 2.7M · 📦 6.8K · 📋 640 - 11% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/timm) (📥 1.3M / month):
	...
	pip install timm
	```
- [Conda](https://anaconda.org/conda-forge/timm) (📥 42K · ⏱️ 24.11.2022):
	```
	conda install -c conda-forge timm
	```
</details>
<details><summary><b><a href="https://github.com/open-mmlab/mmdetection">MMDetection</a></b> (🥇37 ·  ⭐ 23K) - OpenMMLab Detection Toolbox and Benchmark. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 380 · 🔀 7.4K · 📦 810 · 📋 6.6K - 7% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/open-mmlab/mmdetection
	```
- [PyPi](https://pypi.org/project/mmdet) (📥 79K / month):
	```
	pip install mmdet
	```
</details>
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 95 · 🔀 240 · 📥 430 · 📦 76K · 📋 500 - 13% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 520 · 🔀 6.3K · 📥 17K · 📋 2.7K - 24% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 7.8M / month):
	```
	pip install torchvision
	```
- [Conda](https://anaconda.org/conda-forge/torchvision) (📥 480K · ⏱️ 10.12.2022):
	```
...
<details><summary><b><a href="https://github.com/Zulko/moviepy">MoviePy</a></b> (🥇36 ·  ⭐ 10K) - Video editing with Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 150 · 🔀 1.3K · 📦 20K · 📋 1.2K - 20% open · ⏱️ 10.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 410K / month):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 230 · 🔀 6K · 📦 840 · 📋 3.2K - 8% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 120 · 🔀 2.3K · 📦 52 · 📋 4.3K - 20% open · ⏱️ 16.12.2022):
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 95 · 🔀 1.3K · 📦 780 · 📋 1.5K - 11% open · ⏱️ 26.12.2022):
...
- [GitHub](https://github.com/dmlc/gluon-cv) (👨‍💻 120 · 🔀 1.2K · 📦 980 · 📋 820 - 5% open · ⏱️ 11.08.2022):

	```
	git clone https://github.com/dmlc/gluon-cv
	```
- [PyPi](https://pypi.org/project/gluoncv) (📥 650K / month):
	```
	pip install gluoncv
	```
</details>
<details><summary><b><a href="https://github.com/deepinsight/insightface">InsightFace</a></b> (🥈32 ·  ⭐ 13K) - State-of-the-art 2D and 3D Face Analysis Project. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 51 · 🔀 4K · 📦 220 · 📋 2.1K - 56% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/deepinsight/insightface
	```
- [PyPi](https://pypi.org/project/insightface) (📥 33K / month):
	```
...
- [GitHub](https://github.com/OlafenwaMoses/ImageAI) (👨‍💻 16 · 🔀 2K · 📥 810K · 📦 1.2K · 📋 700 - 38% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/OlafenwaMoses/ImageAI
	```
- [PyPi](https://pypi.org/project/imageai) (📥 8.6K / month):
	```
	pip install imageai
	```
...
- [GitHub](https://github.com/kornia/kornia) (👨‍💻 200 · 🔀 740 · 📥 490 · 📋 680 - 28% open · ⏱️ 31.12.2022):

	```
	git clone https://github.com/kornia/kornia
	```
- [PyPi](https://pypi.org/project/kornia) (📥 930K / month):
	```
	pip install kornia
	```
- [Conda](https://anaconda.org/conda-forge/kornia) (📥 57K · ⏱️ 22.12.2022):
	```
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 31 · 🔀 1.1K · 📦 1K · 📋 570 - 0% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/serengil/deepface
	```
- [PyPi](https://pypi.org/project/deepface) (📥 75K / month):
	```
...
- [GitHub](https://github.com/obss/sahi) (👨‍💻 20 · 🔀 350 · 📥 11K · 📦 220 · ⏱️ 05.01.2023):

	```
	git clone https://github.com/obss/sahi
	```
- [PyPi](https://pypi.org/project/sahi) (📥 75K / month):
	```
	pip install sahi
	```
- [Conda](https://anaconda.org/conda-forge/sahi) (📥 26K · ⏱️ 05.01.2023):
	```
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 22 · 🔀 160 · 📦 78 · 📋 340 - 20% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/lightly-ai/lightly
	```
- [PyPi](https://pypi.org/project/lightly) (📥 4.2K / month):
	```
	pip install lightly
	```
</details>
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 40 · 🔀 610 · 📋 600 - 8% open · ⏱️ 29.12.2022):
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 24 · 🔀 170 · 📥 240 · 📦 69 · 📋 100 - 2% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/tryolabs/norfair
	```
- [PyPi](https://pypi.org/project/norfair) (📥 2.9K / month):
	```
	pip install norfair
	```
</details>
...
- [GitHub](https://github.com/mdbloice/Augmentor) (👨‍💻 22 · 🔀 830 · 📦 530 · 📋 190 - 61% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/idealo/imagededup) (👨‍💻 11 · 🔀 400 · 📦 30 · 📋 98 - 22% open · ⏱️ 15.11.2022):
...
- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 340 · 📦 120 · 📋 120 - 54% open · ⏱️ 06.08.2022):
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 110 · 🔀 860 · 📦 14 · 📋 640 - 31% open · ⏱️ 20.12.2022):
...
- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 49 · 🔀 320 · 📋 160 - 36% open · ⏱️ 02.11.2022):

	```
	git clone https://github.com/facebookresearch/pytorchvideo
	```
- [PyPi](https://pypi.org/project/pytorchvideo) (📥 12K / month):
	```
...
- [GitHub](https://github.com/airctic/icevision) (👨‍💻 41 · 🔀 140 · 📋 570 - 9% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/icevision) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/pycls) (👨‍💻 17 · 🔀 230 · 📦 9 · 📋 79 - 29% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/pycls) (📥 93K / month):
	```
	pip install pycls
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 28 · 🔀 1K · 📦 10 · 📋 590 - 54% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/google-research/scenic) (👨‍💻 54 · 🔀 220 · 📋 100 - 44% open · ⏱️ 04.01.2023):
...
- <b><a href="https://github.com/1adrianb/face-alignment">Face Alignment</a></b> (🥉26 ·  ⭐ 6.1K · 💀) - 2D and 3D Face alignment library build using pytorch. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/jasmcaus/caer">Caer</a></b> (🥉17 ·  ⭐ 660 · 💀) - A lightweight Computer Vision library. Scale your models, not boilerplate. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/qanastek/HugsVision">HugsVision</a></b> (🥉12 ·  ⭐ 170) - HugsVision is a easy to use huggingface wrapper for state-of-the-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>huggingface</code>
</details>
<br>
...
- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 240 · 🔀 2.6K · 📦 46 · 📋 2K - 13% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/dmlc/dgl
	```
- [PyPi](https://pypi.org/project/dgl) (📥 29K / month):
	```
	pip install dgl
	```
</details>
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 360 · 🔀 2.9K · 📋 2.8K - 21% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/pyg-team/pytorch_geometric
	```
- [PyPi](https://pypi.org/project/torch-geometric) (📥 76K / month):
	```
	pip install torch-geometric
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_geometric) (📥 15K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 24 · 🔀 340 · 📦 550 · 📋 240 - 1% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/snap-stanford/ogb
	```
- [PyPi](https://pypi.org/project/ogb) (📥 18K / month):
	```
	pip install ogb
	```
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 29 · 🔀 290 · 📦 37 · 📋 180 - 37% open · ⏱️ 03.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pgl) (📥 860 / month):
	```
	pip install pgl
	```
</details>
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 31 · 🔀 180 · 📦 81 · 📋 240 - 45% open · ⏱️ 23.12.2022):
...
<details><summary><b><a href="https://github.com/danielegrattarola/spektral">Spektral</a></b> (🥈25 ·  ⭐ 2.2K) - Graph Neural Networks with Keras and Tensorflow 2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/eliorc/node2vec) (👨‍💻 11 · 🔀 210 · 📦 340 · ⏱️ 19.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/node2vec) (📥 99K / month):
	```
...
<details><summary><b><a href="https://github.com/pykeen/pykeen">PyKEEN</a></b> (🥈23 ·  ⭐ 1.1K) - A Python library for learning and evaluating knowledge graph embeddings. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 33 · 🔀 140 · 📥 150 · 📋 460 - 15% open · ⏱️ 20.11.2022):
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 27 · 🔀 190 · 📋 170 - 2% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 95 / month):
	```
...
- [GitHub](https://github.com/deepmind/jraph) (👨‍💻 17 · 🔀 66 · 📦 47 · 📋 31 - 16% open · ⏱️ 31.08.2022):

	```
	git clone https://github.com/deepmind/jraph
	```
- [PyPi](https://pypi.org/project/jraph) (📥 1.8K / month):
	```
	pip install jraph
	```
...
<details><summary><b><a href="https://github.com/THUMNLab/AutoGL">AutoGL</a></b> (🥉19 ·  ⭐ 870) - An autoML framework & toolkit for machine learning on graphs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/deepmind/graph_nets) (👨‍💻 11 · 🔀 770 · 📋 120 - 3% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph-nets) (📥 630 / month):
	```
	pip install graph-nets
	```
</details>
<details><summary><b><a href="https://github.com/shenweichen/GraphEmbedding">GraphEmbedding</a></b> (🥉16 ·  ⭐ 3.1K · 💤) - Implementation and experiments of graph embedding.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/vaticle/typedb-ml">kglib</a></b> (🥉16 ·  ⭐ 530) - TypeDB-ML is the Machine Learning integrations library for TypeDB. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/microsoft/ptgnn) (👨‍💻 7 · 🔀 40 · 📦 1 · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ptgnn) (📥 80 / month):
	```
	pip install ptgnn
	```
</details>
...
- <b><a href="https://github.com/divelab/DIG">DIG</a></b> (🥉21 ·  ⭐ 1.3K) - A library for graph deep learning research. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 310 · 🔀 1.7K · 📥 77 · 📦 110 · 📋 2K - 17% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/espnet/espnet
	```
- [PyPi](https://pypi.org/project/espnet) (📥 9.7K / month):
	```
	pip install espnet
	```
</details>
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 200 · 🔀 960 · 📦 380 · 📋 820 - 12% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2.3K · 📥 2.1M · 📦 360 · 📋 700 - 22% open · ⏱️ 25.11.2022):
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 180 · 🔀 480 · 📋 710 - 21% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 530K / month):
	```
	pip install torchaudio
	```
</details>
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈28 ·  ⭐ 7.6K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 120 · 🔀 830 · 📥 450K · 📋 480 - 3% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/Uberi/speech_recognition) (👨‍💻 48 · 🔀 2.1K · 📋 530 - 45% open · ⏱️ 04.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/SpeechRecognition) (📥 360K / month):
	```
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 29 · 🔀 83 · 📥 9.4K · 📦 16K · 📋 190 - 39% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 23 · 🔀 150 · 📦 190 · 📋 140 - 27% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 32 · 🔀 380 · 📦 12 · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/KinWaiCheuk/nnAudio">nnAudio</a></b> (🥉19 ·  ⭐ 770) - Audio processing by using pytorch 1D convolution network. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 13 · 🔀 75 · 📦 76 · 📋 53 - 22% open · ⏱️ 09.10.2022):

	```
	git clone https://github.com/KinWaiCheuk/nnAudio
	```
- [PyPi](https://pypi.org/project/nnAudio) (📥 2K / month):
	```
	pip install nnAudio
	```
</details>
...
- [GitHub](https://github.com/adefossez/julius) (👨‍💻 2 · 🔀 20 · 📦 210 · ⏱️ 19.09.2022):

	```
	git clone https://github.com/adefossez/julius
	```
- [PyPi](https://pypi.org/project/julius) (📥 29K / month):
	```
	pip install julius
	```
</details>
...
- <b><a href="https://github.com/Ircam-WAM/TimeSide">TimeSide</a></b> (🥉23 ·  ⭐ 340) - scalable audio processing framework and server written in Python. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
- <b><a href="https://github.com/mozilla/TTS">TTS</a></b> (🥉21 ·  ⭐ 6.5K · 💀) - Deep learning for Text to Speech (Discussion forum:.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 210 · 🔀 1.8K · 📦 5.2K · 📋 2.6K - 6% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 900K / month):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 270K · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 150 · 🔀 2.1K · 📦 20K · 📋 960 - 4% open · ⏱️ 02.01.2023):
...
<details><summary><b><a href="https://github.com/geopandas/geopandas">GeoPandas</a></b> (🥇38 ·  ⭐ 3.5K) - Python tools for geographic data. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 190 · 🔀 740 · 📥 1.7K · 📦 18K · 📋 1.4K - 27% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 140 · 🔀 500 · 📥 370 · 📦 37K · 📋 990 - 18% open · ⏱️ 03.01.2023):
...
<details><summary><b><a href="https://github.com/pyproj4/pyproj">pyproj</a></b> (🥈37 ·  ⭐ 840) - Python interface to PROJ (cartographic projections and coordinate.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 58 · 🔀 190 · 📦 17K · 📋 530 - 3% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/pyproj4/pyproj
	```
- [PyPi](https://pypi.org/project/pyproj) (📥 4.3M / month):
	```
	pip install pyproj
	```
- [Conda](https://anaconda.org/conda-forge/pyproj) (📥 5M · ⏱️ 13.12.2022):
	```
...
- [PyPi](https://pypi.org/project/fiona) (📥 2.7M / month):
	...
	pip install fiona
	```
- [Conda](https://anaconda.org/conda-forge/fiona) (📥 3.9M · ⏱️ 14.12.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyleaflet) (📥 940K · ⏱️ 19.10.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-leaflet) (📥 42K / month):
	```
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 83 · 🔀 950 · 📥 6.8K · 📋 510 - 3% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/Esri/arcgis-python-api
	```
- [PyPi](https://pypi.org/project/arcgis) (📥 53K / month):
	```
	pip install arcgis
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 50 · 🔀 100 · 📦 11K · 📋 86 - 25% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geojson) (📥 730K / month):
	```
	pip install geojson
	```
...
<details><summary><b><a href="https://github.com/holoviz/geoviews">GeoViews</a></b> (🥉27 ·  ⭐ 450) - Simple, concise geographical visualization in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 28 · 🔀 65 · 📦 540 · 📋 310 - 33% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/geoviews) (📥 6.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/geoviews) (📥 150K · ⏱️ 08.03.2022):
	```
...
- [GitHub](https://github.com/pysal/pysal) (👨‍💻 77 · 🔀 260 · 📋 610 - 1% open · ⏱️ 23.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysal) (📥 11K / month):
	```
	pip install pysal
	```
...
- <b><a href="https://github.com/earthlab/earthpy">EarthPy</a></b> (🥉25 ·  ⭐ 410 · 💀) - A package built to support working with spatial data using open.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/geospace-code/pymap3d">pymap3d</a></b> (🥉25 ·  ⭐ 290) - pure-Python (Numpy optional) 3D coordinate conversions for geospace ecef.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code>
...
- [GitHub](https://github.com/ranaroussi/yfinance) (👨‍💻 69 · 🔀 1.7K · 📦 16K · 📋 920 - 45% open · ⏱️ 20.12.2022):

	```
	git clone https://github.com/ranaroussi/yfinance
	```
- [PyPi](https://pypi.org/project/yfinance) (📥 510K / month):
	```
	pip install yfinance
	```
- [Conda](https://anaconda.org/ranaroussi/yfinance) (📥 68K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 110 · 🔀 1.8K · 📥 330 · 📦 33 · 📋 670 - 26% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 29 · 🔀 740 · 📦 1.6K · 📋 200 - 51% open · ⏱️ 23.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/ta) (📥 200K / month):
	```
	pip install ta
	```
- [Conda](https://anaconda.org/conda-forge/ta) (📥 9.9K · ⏱️ 23.08.2022):
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 29 · 🔀 230 · 📦 260 · 📋 110 - 18% open · ⏱️ 21.12.2022):
...
<details><summary><b><a href="https://github.com/pmorissette/bt">bt</a></b> (🥈26 ·  ⭐ 1.6K) - bt - flexible backtesting for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 27 · 🔀 330 · 📦 160 · 📋 310 - 22% open · ⏱️ 22.11.2022):
...
- [PyPi](https://pypi.org/project/alpha_vantage) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alpha_vantage) (📥 2.4K · ⏱️ 14.01.2021):
	```
...
- [PyPi](https://pypi.org/project/ib_insync) (📥 10K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ib-insync) (📥 25K · ⏱️ 03.01.2023):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 45 · 🔀 460 · 📋 45 - 42% open · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/cuemacro/finmarketpy">finmarketpy</a></b> (🥉20 ·  ⭐ 3K) - Python library for backtesting trading strategies & analyzing.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- <b><a href="https://github.com/fmilthaler/FinQuant">FinQuant</a></b> (🥉17 ·  ⭐ 880 · 💀) - A program for financial portfolio management, analysis and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/sktime/sktime) (👨‍💻 220 · 🔀 970 · 📥 76 · 📦 790 · 📋 1.5K - 32% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/ourownstory/neural_prophet) (👨‍💻 35 · 🔀 360 · 📦 160 · 📋 380 - 23% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 160 · 🔀 4.3K · 📥 1.1K · 📋 1.9K - 15% open · ⏱️ 21.09.2022):
...
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prophet) (📥 290K · ⏱️ 10.09.2022):
	```
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 32 · 🔀 240 · 📦 320 · 📋 390 - 11% open · ⏱️ 30.12.2022):
...
- [PyPi](https://pypi.org/project/stumpy) (📥 160K / month):
	...
	pip install stumpy
	```
- [Conda](https://anaconda.org/conda-forge/stumpy) (📥 190K · ⏱️ 31.03.2022):
	```
...
- [PyPi](https://pypi.org/project/pmdarima) (📥 1.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pmdarima) (📥 210K · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 74 · 🔀 560 · 📦 160 · 📋 800 - 23% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/unit8co/darts
	```
- [PyPi](https://pypi.org/project/u8darts) (📥 9.8K / month):
	```
	pip install u8darts
	```
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 40 · 🔀 310 · 📦 660 · 📋 280 - 33% open · ⏱️ 22.12.2022):
...
- [PyPi](https://pypi.org/project/tslearn) (📥 130K / month):
	...
	pip install tslearn
	```
- [Conda](https://anaconda.org/conda-forge/tslearn) (📥 470K · ⏱️ 27.11.2022):
	```
...
- [GitHub](https://github.com/awslabs/gluonts) (👨‍💻 99 · 🔀 630 · 📋 790 - 30% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/tsfresh) (📥 270K / month):
	...
	pip install tsfresh
	```
- [Conda](https://anaconda.org/conda-forge/tsfresh) (📥 460K · ⏱️ 31.12.2022):
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 33 · 🔀 400 · 📋 560 - 53% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 95K / month):
	```
...
- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 16 · 🔀 120 · 📦 120 · 📋 120 - 33% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/statsforecast) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsforecast) (📥 22K · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/johannfaouzi/pyts) (👨‍💻 13 · 🔀 150 · 📦 300 · 📋 70 - 54% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/johannfaouzi/pyts
	```
- [PyPi](https://pypi.org/project/pyts) (📥 92K / month):
	```
	pip install pyts
	```
...
- [GitHub](https://github.com/python-streamz/streamz) (👨‍💻 48 · 🔀 140 · 📋 250 - 39% open · ⏱️ 22.12.2022):
...
- [GitHub](https://github.com/fraunhoferportugal/tsfel) (👨‍💻 14 · 🔀 95 · 📦 49 · 📋 59 - 25% open · ⏱️ 16.03.2022):
...
- [GitHub](https://github.com/X-DataInitiative/tick) (👨‍💻 17 · 🔀 87 · 📥 240 · 📦 67 · 📋 230 - 27% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 6 · 🔀 92 · 📋 76 - 7% open · ⏱️ 16.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/auto-ts) (📥 9.1K / month):
	```
	pip install auto-ts
	```
</details>
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 320 · 🔀 1.1K · 📦 2.1K · 📋 4.3K - 9% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 130 · 🔀 690 · 📦 650 · 📋 2.2K - 10% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/monai) (📥 44K / month):
	...
	pip install monai
	```
- [Conda](https://anaconda.org/conda-forge/monai) (📥 8K · ⏱️ 19.12.2022):
	```
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 82 · 🔀 220 · 📦 87 · 📋 2K - 0% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/google/deepvariant) (👨‍💻 24 · 🔀 650 · 📥 4.3K · 📋 550 - 1% open · ⏱️ 17.10.2022):
	...
	```
- [Conda](https://anaconda.org/bioconda/deepvariant) (📥 48K · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/nipy/nipy) (👨‍💻 64 · 🔀 130 · 📋 150 - 27% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/nipy/nipy
	```
- [PyPi](https://pypi.org/project/nipy) (📥 1K / month):
	```
	pip install nipy
	```
- [Conda](https://anaconda.org/conda-forge/nipy) (📥 99K · ⏱️ 04.05.2020):
	```
...
- [GitHub](https://github.com/carefree0910/carefree-learn) (🔀 30 · 📦 3 · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/manujosephv/pytorch_tabular">pytorch_tabular</a></b> (🥉18 ·  ⭐ 800) - A standard framework for modelling Deep Learning Models.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 11 · 🔀 88 · 📋 82 - 31% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 120 · 🔀 5.6K · 📦 1.1K · 📋 6.2K - 20% open · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/open-mmlab/mmocr">MMOCR</a></b> (🥈29 ·  ⭐ 3K) - OpenMMLab Text Detection, Recognition and Understanding Toolbox. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/open-mmlab/mmocr) (👨‍💻 65 · 🔀 570 · 📦 34 · 📋 740 - 11% open · ⏱️ 06.12.2022):
...
- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 76 · 🔀 630 · 📋 920 - 10% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ocrmypdf) (📥 36K · ⏱️ 04.10.2022):
	```
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 17 · 🔀 290 · 📥 420K · 📦 170 · 📋 180 - 41% open · ⏱️ 24.12.2022):

	```
	git clone https://github.com/faustomorales/keras-ocr
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 6.7K / month):
	```
...
- [GitHub](https://github.com/WZBSocialScienceCenter/pdftabextract) (👨‍💻 3 · 🔀 350 · 📦 42 · 📋 21 - 14% open · ⏱️ 24.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pdftabextract) (📥 320 / month):
	```
...
- [GitHub](https://github.com/apache/airflow) (👨‍💻 2.7K · 🔀 11K · 📥 400K · 📦 5K · 📋 6.6K - 10% open · ⏱️ 05.01.2023):
...
- [Conda](https://anaconda.org/conda-forge/airflow) (📥 820K · ⏱️ 03.12.2022):
	...
	```
- [Docker Hub](https://hub.docker.com/r/apache/airflow) (📥 97M · ⭐ 420 · ⏱️ 03.12.2022):
	```
...
<details><summary><b><a href="https://github.com/dagster-io/dagster">Dagster</a></b> (🥇39 ·  ⭐ 6.2K) - An orchestration platform for the development, production, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 260 · 🔀 760 · 📦 690 · 📋 4.8K - 25% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://github.com/apache/beam">Beam</a></b> (🥇38 ·  ⭐ 6.2K) - Unified programming model to define and execute data processing.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/apache/beam) (👨‍💻 1.4K · 🔀 3.6K · 📋 5K - 78% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/apache/beam
	```
- [PyPi](https://pypi.org/project/apache-beam) (📥 6.3M / month):
	```
...
<details><summary><b><a href="https://github.com/dbt-labs/dbt-core">dbt</a></b> (🥈37 ·  ⭐ 6.3K) - dbt enables data analysts and engineers to transform their data using the.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dbt-labs/dbt-core) (👨‍💻 250 · 🔀 1.1K · 📥 740 · 📦 980 · 📋 3.4K - 9% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 340 · 🔀 1.2K · 📋 1.5K - 13% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 8.3M / month):
	```
	pip install great_expectations
	```
- [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 570K · ⏱️ 15.12.2022):
	```
	conda install -c conda-forge great-expectations
	```
</details>
<details><summary><b><a href="https://github.com/kedro-org/kedro">Kedro</a></b> (🥈35 ·  ⭐ 8K) - A Python framework for creating reproducible, maintainable and modular.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kedro-org/kedro) (👨‍💻 180 · 🔀 740 · 📦 1.2K · 📋 1K - 20% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/petl-developers/petl) (👨‍💻 58 · 🔀 180 · 📦 890 · 📋 450 - 17% open · ⏱️ 23.11.2022):
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 160 · 🔀 610 · 📋 810 - 19% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/combust/mleap) (👨‍💻 80 · 🔀 300 · 📦 200 · 📋 450 - 20% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/activeloopai/deeplake) (👨‍💻 110 · 🔀 410 · 📦 16 · 📋 400 - 11% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 59 · 🔀 250 · 📥 1 · 📦 45 · 📋 140 - 10% open · ⏱️ 23.12.2022):

	```
	git clone https://github.com/zenml-io/zenml
	```
- [PyPi](https://pypi.org/project/zenml) (📥 7.8K / month):
	```
	pip install zenml
	```
</details>
...
- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 71 · 🔀 200 · 📦 62 · 📋 810 - 15% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/ploomber) (📥 11K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ploomber) (📥 45K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/whylabs/whylogs) (👨‍💻 14 · 🔀 88 · 📥 70 · 📦 54 · 📋 300 - 11% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/whylabs/whylogs
	```
- [PyPi](https://pypi.org/project/whylogs) (📥 41K / month):
	```
	pip install whylogs
	```
</details>
...
- [PyPi](https://pypi.org/project/arq) (📥 33K / month):
	...
	pip install arq
	```
- [Conda](https://anaconda.org/conda-forge/arq) (📥 5.3K · ⏱️ 02.12.2022):
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 220 · 📋 220 - 4% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/optimuspyspark) (📥 23K / month):
	```
...
- [GitHub](https://github.com/cgarciae/pypeln) (👨‍💻 13 · 🔀 84 · 📦 82 · 📋 62 - 27% open · ⏱️ 23.06.2022):

	```
	git clone https://github.com/cgarciae/pypeln
	```
- [PyPi](https://pypi.org/project/pypeln) (📥 11K / month):
	```
	pip install pypeln
	```
...
- [GitHub](https://github.com/pdpipe/pdpipe) (👨‍💻 11 · 🔀 43 · 📦 47 · 📋 52 - 26% open · ⏱️ 24.12.2022):

	```
	git clone https://github.com/pdpipe/pdpipe
	```
- [PyPi](https://pypi.org/project/pdpipe) (📥 1.5K / month):
	```
	pip install pdpipe
	```
...
- <b><a href="https://github.com/Yelp/mrjob">mrjob</a></b> (🥈29 ·  ⭐ 2.6K · 💀) - Run MapReduce jobs on Hadoop or Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/robinhood/faust">faust</a></b> (🥉26 ·  ⭐ 6.4K · 💀) - Python Stream Processing. <code>❗Unlicensed</code>
- <b><a href="https://github.com/analysiscenter/batchflow">BatchFlow</a></b> (🥉23 ·  ⭐ 180) - BatchFlow helps you conveniently work with random or sequential.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 790 · 🔀 4K · 📦 6.8K · 📋 12K - 19% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/ray) (📥 1.8M / month):
	...
	pip install ray
	```
- [Conda](https://anaconda.org/conda-forge/ray-tune) (📥 88K · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 300 · 🔀 650 · 📦 26K · 📋 3.1K - 33% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/distributed) (📥 4.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/distributed) (📥 9.1M · ⏱️ 16.12.2022):
	```
	conda install -c conda-forge distributed
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/DeepSpeed">DeepSpeed</a></b> (🥇36 ·  ⭐ 8.5K) - DeepSpeed is a deep learning optimization library that makes.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 150 · 🔀 950 · 📦 570 · 📋 1.1K - 43% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 180 · 🔀 1K · 📦 42 · 📋 1.6K - 31% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/Lightning-AI/metrics) (👨‍💻 160 · 🔀 260 · 📥 1.2K · 📦 6.6K · 📋 510 - 8% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/metrics) (📥 5.1K / month):
	...
	pip install metrics
	```
- [Conda](https://anaconda.org/conda-forge/torchmetrics) (📥 630K · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 64 · 🔀 200 · 📦 1.1K · 📋 330 - 18% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/fairscale) (📥 700K / month):
	```
...
<details><summary><b><a href="https://github.com/microsoft/SynapseML">SynapseML</a></b> (🥈28 ·  ⭐ 3.9K) - Simple and Distributed Machine Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 100 · 🔀 680 · 📋 620 - 40% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 57K / month):
	```
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 46 · 🔀 260 · 📥 340 · 📦 91 · 📋 290 - 50% open · ⏱️ 16.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/petastorm) (📥 43K / month):
	```
	pip install petastorm
	```
</details>
<details><summary><b><a href="https://github.com/dask/dask-ml">dask-ml</a></b> (🥉26 ·  ⭐ 830) - Scalable Machine Learning with Dask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/dask-ml) (📥 72K / month):
	...
	pip install dask-ml
	```
- [Conda](https://anaconda.org/conda-forge/dask-ml) (📥 640K · ⏱️ 27.05.2022):
	```
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 48 · 🔀 230 · 📦 760 · 📋 79 - 82% open · ⏱️ 04.10.2022):
...
<details><summary><b><a href="https://github.com/learning-at-home/hivemind">Hivemind</a></b> (🥉25 ·  ⭐ 1.3K) - Decentralized deep learning in PyTorch. Built to train models on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 27 · 🔀 78 · 📦 27 · 📋 140 - 30% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 22 · 🔀 87 · 📥 8.3K · 📋 99 - 8% open · ⏱️ 25.11.2022):
...
- [GitHub](https://github.com/apache/singa) (👨‍💻 79 · 🔀 830 · 📦 2 · 📋 83 - 21% open · ⏱️ 01.06.2022):
	...
	```
- [Conda](https://anaconda.org/nusdbsystem/singa) (📥 560 · ⏱️ 09.08.2021):
	```
...
- [GitHub](https://github.com/bytedance/byteps) (👨‍💻 21 · 🔀 460 · 📋 260 - 38% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/byteps) (📥 36 / month):
	```
	pip install byteps
	```
...
- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 23 · 🔀 86 · 📋 86 - 41% open · ⏱️ 28.09.2022):
...
<details><summary><b><a href="https://github.com/tunib-ai/parallelformers">parallelformers</a></b> (🥉18 ·  ⭐ 560) - Parallelformers: An Efficient Model Parallelization.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tunib-ai/parallelformers) (👨‍💻 5 · 🔀 40 · 📦 12 · 📋 38 - 55% open · ⏱️ 27.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/parallelformers) (📥 1.9K / month):
	```
	pip install parallelformers
	```
</details>
<details><summary><b><a href="https://github.com/kingoflolz/mesh-transformer-jax">mesh-transformer-jax</a></b> (🥉16 ·  ⭐ 4.9K · 💤) - Model parallel transformers in JAX and Haiku. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- <b><a href="https://github.com/ipython/ipyparallel">ipyparallel</a></b> (🥉23 ·  ⭐ 2.3K · 📉) - IPython Parallel: Interactive Parallel Computing in.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/optuna/optuna">Optuna</a></b> (🥇40 ·  ⭐ 7.4K) - A hyperparameter optimization framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/optuna/optuna) (👨‍💻 220 · 🔀 780 · 📦 5.2K · 📋 1.3K - 6% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 180 · 🔀 1.7K · 📦 330 · 📋 1.8K - 14% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 69 · 🔀 810 · 📦 1.2K · 📋 900 - 17% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/fmfn/BayesianOptimization) (👨‍💻 37 · 🔀 1.3K · 📥 110 · 📦 1.5K · 📋 290 - 3% open · ⏱️ 04.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/bayesian-optimization) (📥 140K / month):
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 88 · 🔀 1.2K · 📥 40 · 📦 380 · 📋 950 - 14% open · ⏱️ 07.12.2022):
...
- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 98 · 🔀 660 · 📦 200 · 📋 820 - 23% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 86 · 🔀 280 · 📦 390 · 📋 340 - 18% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 140 · 🔀 230 · 📦 380 · 📋 480 - 3% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/ax-platform) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ax-platform) (📥 5.6K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 52 · 🔀 350 · 📦 1.9K · 📋 420 - 43% open · ⏱️ 29.12.2022):
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 49 · 🔀 320 · 📦 420 · 📋 230 - 30% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/facebookresearch/nevergrad
	```
- [PyPi](https://pypi.org/project/nevergrad) (📥 24K / month):
	```
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 20 · 🔀 310 · 📦 60 · 📋 520 - 22% open · ⏱️ 30.12.2022):
...
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 5.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mljar-supervised) (📥 6K · ⏱️ 30.12.2022):
	```
...
- [GitHub](https://github.com/maxpumperla/hyperas) (👨‍💻 22 · 🔀 310 · 📦 270 · 📋 250 - 37% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 18 · 🔀 130 · 📦 390 · 📋 81 - 54% open · ⏱️ 28.09.2022):
...
- [GitHub](https://github.com/autonomio/talos) (👨‍💻 22 · 🔀 260 · 📦 160 · 📋 400 - 2% open · ⏱️ 18.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/talos) (📥 720 / month):
	```
	pip install talos
	```
</details>
...
- [GitHub](https://github.com/automl/HpBandSter) (👨‍💻 11 · 🔀 110 · 📦 280 · 📋 89 - 60% open · ⏱️ 22.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/hpbandster) (📥 11K / month):
	```
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 7 · 🔀 56 · 📦 39 · 📋 320 - 16% open · ⏱️ 16.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 260 / month):
	```
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 6 · 🔀 38 · 📥 110 · 📦 17 · 📋 53 - 16% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/SimonBlanke/Hyperactive
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 550 / month):
	```
...
- [GitHub](https://github.com/AutoViML/featurewiz) (👨‍💻 6 · 🔀 64 · 📦 27 · 📋 56 - 1% open · ⏱️ 30.12.2022):
...
<details><summary><b><a href="https://github.com/ScottfreeLLC/AlphaPy">AlphaPy</a></b> (🥉18 ·  ⭐ 840 · 💤) - Automated Machine Learning [AutoML] with Python, scikit-learn,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 6 · 🔀 82 · 📦 20 · 📋 23 - 17% open · ⏱️ 16.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/autoviml) (📥 890 / month):
	```
...
- <b><a href="https://github.com/automl/SMAC3">SMAC3</a></b> (🥉22 ·  ⭐ 780) - SMAC3: A Versatile Bayesian Optimization Package for Hyperparameter.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 130 · 🔀 640 · 📦 1K · 📋 600 - 25% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 82 · 🔀 1.5K · 📦 19 · 📋 490 - 19% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/AI4Finance-Foundation/FinRL
	```
- [PyPi](https://pypi.org/project/finrl) (📥 450 / month):
	```
	pip install finrl
	```
</details>
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 80 · 🔀 360 · 📦 120 · 📋 230 - 14% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/dm-acme) (📥 2K / month):
	...
	pip install dm-acme
	```
- [Conda](https://anaconda.org/conda-forge/dm-acme) (📥 5.3K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 35 · 🔀 760 · 📦 100 · 📋 460 - 18% open · ⏱️ 06.12.2022):
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 79 · 🔀 280 · 📦 59 · 📋 1K - 19% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 15 · 🔀 1.3K · 📋 150 - 43% open · ⏱️ 28.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 19K / month):
	```
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 82 · 🔀 520 · 📋 660 - 4% open · ⏱️ 10.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorforce) (📥 840 / month):
	```
...
- [GitHub](https://github.com/hill-a/stable-baselines) (👨‍💻 110 · 🔀 700 · 📋 930 - 11% open · ⏱️ 04.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/stable-baselines) (📥 5.2K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 150 · 🔀 480 · 📋 110 - 29% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/facebookresearch/ReAgent
	```
- [PyPi](https://pypi.org/project/reagent) (📥 11 / month):
	```
	pip install reagent
	```
</details>
...
- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 18 · 🔀 130 · 📦 68 · 📋 67 - 40% open · ⏱️ 21.09.2022):

	```
	git clone https://github.com/pfnet/pfrl
	```
- [PyPi](https://pypi.org/project/pfrl) (📥 610 / month):
	```
	pip install pfrl
	```
</details>
...
- <b><a href="https://github.com/Farama-Foundation/ViZDoom">ViZDoom</a></b> (🥈26 ·  ⭐ 1.5K) - Doom-based AI Research Platform for Reinforcement Learning from.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉21 ·  ⭐ 960) -  <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/microsoft/recommenders">Recommenders</a></b> (🥇34 ·  ⭐ 15K) - Best Practices on Recommendation Systems. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 120 · 🔀 2.6K · 📥 280 · 📦 53 · 📋 740 - 19% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 57 · 🔀 440 · 📋 600 - 11% open · ⏱️ 24.12.2022):
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">scikit-surprise</a></b> (🥈24 ·  ⭐ 5.7K) - A Python scikit for building and analyzing recommender.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 15 · 🔀 110 · 📦 140 · 📋 110 - 7% open · ⏱️ 18.10.2022):

	```
	git clone https://github.com/PreferredAI/cornac
	```
- [PyPi](https://pypi.org/project/cornac) (📥 26K / month):
	```
	pip install cornac
	```
...
- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 16 · 🔀 86 · 📥 1 · 📦 33 · 📋 21 - 42% open · ⏱️ 17.04.2022):

	```
	git clone https://github.com/statisticianinstilettos/recmetrics
	```
- [PyPi](https://pypi.org/project/recmetrics) (📥 1.6K / month):
	```
...
- <b><a href="https://github.com/ShopRunner/collie">Collie</a></b> (🥉14 ·  ⭐ 97) - A library for preparing, training, and evaluating scalable deep.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 480 · 🔀 1.8K · 📋 3.4K - 3% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://github.com/FederatedAI/FATE">FATE</a></b> (🥈28 ·  ⭐ 4.8K) - An Industrial Grade Federated Learning Framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/FederatedAI/FATE) (👨‍💻 88 · 🔀 1.4K · 📋 1.5K - 38% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/ETAF) (📥 39 / month):
	```
	pip install ETAF
	```
</details>
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 65 · 🔀 250 · 📥 51 · 📦 180 · 📋 220 - 21% open · ⏱️ 19.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/opacus) (📥 9.9K / month):
	```
	pip install opacus
	```
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 50 · 🔀 380 · 📥 93 · 📋 160 - 44% open · ⏱️ 22.12.2022):
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 290 · 🔀 1.5K · 📦 140K · 📋 1.7K - 32% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/tensorflow/tensorboard
	```
- [PyPi](https://pypi.org/project/tensorboard) (📥 16M / month):
	```
...
- [GitHub](https://github.com/iterative/dvc) (👨‍💻 280 · 🔀 990 · 📥 110K · 📦 5.8K · 📋 4K - 14% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 530 · 🔀 3K · 📋 2.7K - 32% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 110 · 🔀 1.5K · 📥 620 · 📦 3K · 📋 1.9K - 14% open · ⏱️ 31.12.2022):

	```
	git clone https://github.com/pycaret/pycaret
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 740K / month):
	```
	pip install pycaret
	```
...
- [GitHub](https://github.com/wandb/wandb) (👨‍💻 140 · 🔀 400 · 📦 15K · 📋 2.2K - 26% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 310 · 🔀 880 · 📦 1.9K · 📋 1.2K - 34% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 63 · 🔀 510 · 📥 630 · 📦 380 · 📋 690 - 45% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 280 · 🔀 390 · 📦 1.3K · 📋 1.2K - 58% open · ⏱️ 16.12.2022):
...
- [PyPi](https://pypi.org/project/snakemake) (📥 28K / month):
	...
	```
- [Conda](https://anaconda.org/bioconda/snakemake) (📥 620K · ⏱️ 13.12.2022):
	```
	conda install -c bioconda snakemake
	```
</details>
<details><summary><b><a href="https://github.com/Netflix/metaflow">Metaflow</a></b> (🥈32 ·  ⭐ 6.3K) - Build and manage real-life data science projects with ease!. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 64 · 🔀 560 · 📦 360 · 📋 450 - 44% open · ⏱️ 22.12.2022):
...
- [PyPi](https://pypi.org/project/metaflow) (📥 62K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/metaflow) (📥 91K · ⏱️ 05.12.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 32 · 🔀 600 · 📥 250 · 📦 1.6K · 📋 440 - 22% open · ⏱️ 07.12.2022):
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 73 · 🔀 850 · 📥 350 · 📦 25K · 📋 440 - 15% open · ⏱️ 02.01.2023):
...
- [PyPi](https://pypi.org/project/tensorboardX) (📥 1.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorboardx) (📥 920K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 100 · 🔀 350 · 📦 1.8K · 📋 540 - 16% open · ⏱️ 30.11.2022):
...
- [PyPi](https://pypi.org/project/sacred) (📥 30K / month):
	...
	pip install sacred
	```
- [Conda](https://anaconda.org/conda-forge/sacred) (📥 2.2K · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 15 · 🔀 100 · 📥 1.8K · 📦 290 · 📋 93 - 25% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/google/ml-metadata
	```
- [PyPi](https://pypi.org/project/ml-metadata) (📥 860K / month):
	```
	pip install ml-metadata
	```
</details>
<details><summary><b><a href="https://github.com/catalyst-team/catalyst">Catalyst</a></b> (🥈27 ·  ⭐ 3.1K · 💤) - Accelerated deep learning R&D. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 100 · 🔀 360 · 📦 700 · 📋 340 - 1% open · ⏱️ 29.04.2022):
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 23 · 🔀 69 · 📥 7 · 📦 65 · 📋 390 - 46% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/instacart/lore) (👨‍💻 27 · 🔀 120 · 📦 20 · 📋 35 - 45% open · ⏱️ 27.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/lore) (📥 680 / month):
	```
	pip install lore
	```
</details>
...
- [GitHub](https://github.com/replicate/keepsake) (👨‍💻 17 · 🔀 65 · 📋 180 - 63% open · ⏱️ 24.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/keepsake) (📥 180 / month):
	```
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 260 · 🔀 3.2K · 📥 18K · 📦 10K · 📋 2.2K - 12% open · ⏱️ 01.01.2023):
...
- [PyPi](https://pypi.org/project/onnx) (📥 2.1M / month):
	...
	pip install onnx
	```
- [Conda](https://anaconda.org/conda-forge/onnx) (📥 620K · ⏱️ 15.12.2022):
	```
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 140 · 🔀 500 · 📥 1.7K · 📦 460 · 📋 770 - 13% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 140 · 🔀 450 · 📥 4.7K · 📦 1.2K · 📋 1.1K - 15% open · ⏱️ 16.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/coremltools) (📥 470K / month):
	```
...
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 34K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hummingbird-ml) (📥 20K · ⏱️ 29.11.2022):
	```
...
- [GitHub](https://github.com/openai/triton) (👨‍💻 61 · 🔀 370 · 📦 220 · 📋 350 - 40% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 140 · 🔀 650 · 📥 2.4K · 📋 1.1K - 16% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/torchserve) (📥 18K / month):
	...
	```
- [Conda](https://anaconda.org/pytorch/torchserve) (📥 57K · ⏱️ 12.12.2022):
	```
...
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈28 ·  ⭐ 650) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 77 · 🔀 150 · 📋 380 - 21% open · ⏱️ 23.12.2022):
...
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 6.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/huggingface_hub) (📥 640K · ⏱️ 28.11.2022):
	```
...
- [GitHub](https://github.com/microsoft/MMdnn) (👨‍💻 86 · 🔀 950 · 📥 3.6K · 📦 98 · 📋 610 - 52% open · ⏱️ 22.09.2022):
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 14 · 🔀 200 · 📥 42 · 📦 81 · 📋 94 - 25% open · ⏱️ 05.10.2022):
...
- [GitHub](https://github.com/nok/sklearn-porter) (👨‍💻 12 · 🔀 160 · 📦 47 · 📋 68 - 50% open · ⏱️ 22.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-porter) (📥 300 / month):
	```
	pip install sklearn-porter
	```
</details>
<details><summary><b><a href="https://github.com/nebuly-ai/nebullvm">nebullvm</a></b> (🥉19 ·  ⭐ 1.8K) - Plug and play modules to boost the performances of AI systems. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/nebuly-ai/nebullvm) (👨‍💻 13 · 🔀 94 · 📦 7 · 📋 72 - 25% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/slundberg/shap) (👨‍💻 200 · 🔀 2.7K · 📦 7.9K · 📋 2.1K - 70% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/slundberg/shap
	```
- [PyPi](https://pypi.org/project/shap) (📥 6.1M / month):
	```
	pip install shap
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 140 · 🔀 310 · 📥 110 · 📦 3.2K · 📋 790 - 19% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 31 · 🔀 620 · 📦 340 · 📋 330 - 31% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/lutzroeder/netron) (🔀 2.3K · 📥 23K · 📦 8 · 📋 890 - 2% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://github.com/pytorch/captum">Captum</a></b> (🥇32 ·  ⭐ 3.7K) - Model interpretability and understanding for PyTorch. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytorch/captum) (👨‍💻 97 · 🔀 380 · 📦 840 · 📋 420 - 27% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/pytorch/captum
	```
- [PyPi](https://pypi.org/project/captum) (📥 100K / month):
	```
	pip install captum
	```
- [Conda](https://anaconda.org/conda-forge/captum) (📥 4.7K · ⏱️ 04.03.2022):
	```
...
- [GitHub](https://github.com/py-why/dowhy) (👨‍💻 66 · 🔀 770 · 📥 31 · 📦 170 · 📋 320 - 30% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/Microsoft/dowhy
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 77K / month):
	```
	pip install dowhy
	```
...
- [GitHub](https://github.com/parrt/dtreeviz) (👨‍💻 21 · 🔀 290 · 📦 570 · 📋 140 - 22% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/parrt/dtreeviz
	```
- [PyPi](https://pypi.org/project/dtreeviz) (📥 64K / month):
	```
	pip install dtreeviz
	```
- [Conda](https://anaconda.org/conda-forge/dtreeviz) (📥 32K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 35 · 🔀 260 · 📦 94 · 📋 140 - 13% open · ⏱️ 02.12.2022):
...
- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 18 · 🔀 210 · 📦 220 · 📋 320 - 37% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 52 · 🔀 240 · 📋 68 - 26% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/tensorflow/model-analysis
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 760K / month):
	```
	pip install tensorflow-model-analysis
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/responsible-ai-toolbox">responsible-ai-widgets</a></b> (🥈29 ·  ⭐ 650) - This project provides responsible AI user interfaces.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 29 · 🔀 160 · 📦 43 · 📋 260 - 13% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 18 · 🔀 180 · 📦 210 · 📋 190 - 6% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/oegedijk/explainerdashboard
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 18K / month):
	```
...
- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 69 · 🔀 320 · 📋 380 - 38% open · ⏱️ 22.12.2022):
...
- [GitHub](https://github.com/PAIR-code/lit) (👨‍💻 27 · 🔀 320 · 📦 12 · 📋 110 - 36% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/lit-nlp) (📥 830 / month):
	```
	pip install lit-nlp
	```
...
<details><summary><b><a href="https://github.com/Trusted-AI/AIF360">Fairness 360</a></b> (🥈26 ·  ⭐ 1.9K) - A comprehensive set of fairness metrics for datasets and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 63 · 🔀 620 · 📦 200 · 📋 210 - 60% open · ⏱️ 04.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/aif360) (📥 7.8K / month):
	```
	pip install aif360
	```
- [Conda](https://anaconda.org/conda-forge/aif360) (📥 4.7K · ⏱️ 04.09.2022):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 30 · 🔀 200 · 📦 65 · 📋 120 - 10% open · ⏱️ 14.11.2022):

	```
	git clone https://github.com/quantumblacklabs/causalnex
	```
- [PyPi](https://pypi.org/project/causalnex) (📥 5.9K / month):
	```
...
<details><summary><b><a href="https://github.com/csinva/imodels">imodels</a></b> (🥈26 ·  ⭐ 980) - Interpretable ML package for concise, transparent, and accurate predictive.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/csinva/imodels) (👨‍💻 15 · 🔀 94 · 📦 32 · 📋 53 - 33% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/DistrictDataLabs/yellowbrick) (👨‍💻 110 · 🔀 520 · 📋 680 - 11% open · ⏱️ 05.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/yellowbrick) (📥 850K / month):
	```
	pip install yellowbrick
	```
- [Conda](https://anaconda.org/conda-forge/yellowbrick) (📥 49K · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/albermax/innvestigate) (👨‍💻 19 · 🔀 230 · 📥 40 · 📦 88 · 📋 240 - 20% open · ⏱️ 12.10.2022):
...
<details><summary><b><a href="https://github.com/ploomber/sklearn-evaluation">sklearn-evaluation</a></b> (🥉24 ·  ⭐ 360) - Machine learning model evaluation made easy: plots,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ploomber/sklearn-evaluation) (👨‍💻 19 · 🔀 38 · 📦 58 · 📋 130 - 49% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/edublancas/sklearn-evaluation
	```
- [PyPi](https://pypi.org/project/sklearn-evaluation) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 13 · 🔀 180 · 📦 180 · 📋 83 - 2% open · ⏱️ 12.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/checklist) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/jalammar/ecco) (👨‍💻 10 · 🔀 110 · 📥 23 · 📦 18 · 📋 43 - 34% open · ⏱️ 18.01.2022):
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉19 ·  ⭐ 980) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/tensorflow/model-card-toolkit">model-card-toolkit</a></b> (🥉19 ·  ⭐ 340) - A toolkit that streamlines and automates the generation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tensorflow/model-card-toolkit) (👨‍💻 19 · 🔀 71 · 📦 12 · 📋 18 - 27% open · ⏱️ 26.12.2022):

	```
	git clone https://github.com/tensorflow/model-card-toolkit
	```
- [PyPi](https://pypi.org/project/model-card-toolkit) (📥 550 / month):
	```
...
- [GitHub](https://github.com/dssg/aequitas) (👨‍💻 17 · 🔀 90 · 📦 120 · 📋 62 - 66% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/aequitas) (📥 920 / month):
	```
...
- [GitHub](https://github.com/explainX/explainx) (👨‍💻 4 · 🔀 43 · 📥 6 · 📋 26 - 34% open · ⏱️ 15.09.2022):
...
- <b><a href="https://github.com/interpretml/interpret-text">interpret-text</a></b> (🥉14 ·  ⭐ 350 · 💀) - A library that incorporates state-of-the-art explainers.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 120 · 🔀 2.7K · 📦 850 · 📋 2K - 12% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/facebookresearch/faiss
	```
- [PyPi](https://pypi.org/project/pymilvus) (📥 220K / month):
	```
	pip install pymilvus
	```
- [Conda](https://anaconda.org/conda-forge/faiss) (📥 610K · ⏱️ 02.11.2022):
	```
...
- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 230 · 🔀 1.7K · 📥 26K · 📋 6.8K - 4% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 220K / month):
	...
	pip install pymilvus
	```
- [Docker Hub](https://hub.docker.com/r/milvusdb/milvus) (📥 2.6M · ⭐ 23 · ⏱️ 05.01.2023):
	```
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 48 · 🔀 400 · 📦 730 · 📋 410 - 14% open · ⏱️ 31.05.2022):

	```
	git clone https://github.com/nmslib/nmslib
	```
- [PyPi](https://pypi.org/project/nmslib) (📥 180K / month):
	```
	pip install nmslib
	```
...
- [PyPi](https://pypi.org/project/hnswlib) (📥 350K / month):
	...
	pip install hnswlib
	```
- [Conda](https://anaconda.org/conda-forge/hnswlib) (📥 68K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 24 · 🔀 90 · 📦 2.6K · 📋 110 - 47% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/lmcinnes/pynndescent
	```
- [PyPi](https://pypi.org/project/pynndescent) (📥 650K / month):
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 130 · 🔀 920 · 📦 960 · 📋 980 - 20% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 290K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyro-ppl) (📥 36K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 460 · 🔀 990 · 📋 1.2K - 42% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 110 · 🔀 450 · 📦 890 · 📋 1.2K - 24% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/gpytorch) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gpytorch) (📥 69K · ⏱️ 08.09.2022):
	```
...
- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 45 · 🔀 680 · 📦 1K · 📋 460 - 19% open · ⏱️ 24.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pandas-ta) (📥 74K / month):
	```
	pip install pandas-ta
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 4.5K · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 41 · 🔀 680 · 📦 1.5K · 📋 400 - 12% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/hmmlearn/hmmlearn
	```
- [PyPi](https://pypi.org/project/hmmlearn) (📥 95K / month):
	```
...
<details><summary><b><a href="https://github.com/pgmpy/pgmpy">pgmpy</a></b> (🥈30 ·  ⭐ 2.3K) - Python Library for learning (Structure and Parameter), inference.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 110 · 🔀 640 · 📥 180 · 📦 480 · 📋 780 - 24% open · ⏱️ 03.01.2023):
...
<details><summary><b><a href="https://github.com/bambinos/bambi">bambi</a></b> (🥉26 ·  ⭐ 860) - BAyesian Model-Building Interface (Bambi) in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 27 · 🔀 92 · 📦 46 · 📋 310 - 21% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/bambinos/bambi
	```
- [PyPi](https://pypi.org/project/bambi) (📥 7.3K / month):
	```
	pip install bambi
	```
...
<details><summary><b><a href="https://github.com/SALib/SALib">SALib</a></b> (🥉24 ·  ⭐ 660) - Sensitivity Analysis Library in Python. Contains Sobol, Morris, FAST, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SALib/SALib) (👨‍💻 39 · 🔀 200 · 📋 290 - 12% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/baal-org/baal) (👨‍💻 18 · 🔀 65 · 📦 24 · 📋 92 - 23% open · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/baal) (📥 650 / month):
	```
	pip install baal
	```
...
- <b><a href="https://github.com/pymc-devs/pymc">PyMC3</a></b> (🥇37 ·  ⭐ 7.2K) - Probabilistic Programming in Python: Bayesian Modeling and.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 58 · 🔀 270 · 📦 110 · 📋 230 - 7% open · ⏱️ 21.12.2022):
...
<details><summary><b><a href="https://github.com/MadryLab/robustness">robustness</a></b> (🥉17 ·  ⭐ 760 · 💤) - A library for experimenting with, training and evaluating neural.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MadryLab/robustness) (👨‍💻 13 · 🔀 150 · 📦 97 · 📋 77 - 27% open · ⏱️ 14.02.2022):

	```
	git clone https://github.com/MadryLab/robustness
	```
- [PyPi](https://pypi.org/project/robustness) (📥 420 / month):
	```
...
- <b><a href="https://github.com/cleverhans-lab/cleverhans">CleverHans</a></b> (🥈28 ·  ⭐ 5.7K · 💀) - An adversarial example library for constructing attacks,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 260 · 🔀 660 · 📋 5.1K - 13% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 160 · 🔀 440 · 📦 1 · 📋 2.1K - 31% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 87 · 🔀 500 · 📥 3.1K · 📋 1.6K - 16% open · ⏱️ 21.12.2022):

	```
	git clone https://github.com/arrayfire/arrayfire
	```
- [PyPi](https://pypi.org/project/arrayfire) (📥 520 / month):
	```
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 80 · 🔀 530 · 📋 1.3K - 16% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 92 · 🔀 220 · 📦 2 · 📋 1.2K - 20% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/rapidsai/cugraph
	```
- [PyPi](https://pypi.org/project/cugraph) (📥 89 / month):
	```
	pip install cugraph
	```
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 21 · 🔀 71 · 📥 220 · 📦 5 · 📋 180 - 32% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/rapidsai/cusignal) (👨‍💻 42 · 🔀 100 · 📋 140 - 12% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 100 · 🔀 1.6K · 📦 15K · 📋 660 - 0% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/tensorflow-hub) (📥 4.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-hub) (📥 74K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 200 · 🔀 540 · 📦 8.3K · 📋 940 - 23% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 280 · 🔀 1.3K · 📋 1K - 36% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/tensorflow/datasets
	```
- [PyPi](https://pypi.org/project/tensorflow-datasets) (📥 1M / month):
	```
	pip install tensorflow-datasets
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-datasets) (📥 12K · ⏱️ 03.01.2023):
	```
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 190 · 📦 1.1K · 📋 190 - 17% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/tensorflow/tensor2tensor) (👨‍💻 240 · 🔀 3.1K · 📦 1.3K · 📋 1.2K - 46% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensor2tensor) (📥 6.9K / month):
	```
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 74 · 🔀 280 · 📦 2.4K · 📋 310 - 49% open · ⏱️ 19.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 130K / month):
	```
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 37 · 🔀 180 · 📦 290 · 📋 68 - 4% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 96 · 🔀 230 · 📋 570 - 38% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/tensorflow/io
	```
- [PyPi](https://pypi.org/project/tensorflow-io) (📥 600K / month):
	```
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 27 · 🔀 73 · 📦 200 · 📋 87 - 68% open · ⏱️ 22.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-cloud) (📥 75K / month):
	```
	pip install tensorflow-cloud
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/compression">TF Compression</a></b> (🥉21 ·  ⭐ 700) - Data compression in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/PAIR-code/saliency">Saliency</a></b> (🥉20 ·  ⭐ 850 · 💤) - Framework-agnostic implementation for state-of-the-art.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 16 · 🔀 170 · 📦 50 · 📋 30 - 10% open · ⏱️ 13.05.2022):

	```
	git clone https://github.com/PAIR-code/saliency
	```
- [PyPi](https://pypi.org/project/saliency) (📥 4.8K / month):
	```
...
<details><summary><b><a href="https://github.com/patrick-kidger/equinox">equinox</a></b> (🥇23 ·  ⭐ 910) - Callable PyTrees and filtered transforms = neural networks in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/patrick-kidger/equinox) (👨‍💻 16 · 🔀 51 · 📦 74 · 📋 120 - 23% open · ⏱️ 01.12.2022):

	```
	git clone https://github.com/patrick-kidger/equinox
	```
- [PyPi](https://pypi.org/project/equinox) (📥 7.9K / month):
	```
	pip install equinox
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/category_encoders) (👨‍💻 57 · 🔀 360 · 📦 4.3K · 📋 260 - 21% open · ⏱️ 29.12.2022):
...
- [GitHub](https://github.com/scikit-multilearn/scikit-multilearn) (👨‍💻 17 · 🔀 150 · 📦 940 · 📋 180 - 48% open · ⏱️ 09.07.2022):

	```
	git clone https://github.com/scikit-multilearn/scikit-multilearn
	```
- [PyPi](https://pypi.org/project/scikit-multilearn) (📥 86K / month):
	```
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 56 · 🔀 98 · 📦 77 · 📋 260 - 9% open · ⏱️ 21.12.2022):
...
- [GitHub](https://github.com/guofei9987/scikit-opt) (👨‍💻 16 · 🔀 840 · 📦 99 · 📋 160 - 32% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/scikit-opt) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/yzhao062/combo) (👨‍💻 2 · 🔀 99 · 📦 520 · 📋 14 - 78% open · ⏱️ 07.07.2022):

	```
	git clone https://github.com/yzhao062/combo
	```
- [PyPi](https://pypi.org/project/combo) (📥 41K / month):
	```
	pip install combo
	```
</details>
...
<details><summary><b><a href="https://github.com/huggingface/accelerate">accelerate</a></b> (🥇34 ·  ⭐ 3.5K) - A simple way to train and use PyTorch models with multi-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 79 · 🔀 290 · 📦 2.1K · 📋 460 - 9% open · ⏱️ 04.01.2023):
...
- [PyPi](https://pypi.org/project/accelerate) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/accelerate) (📥 15K · ⏱️ 04.12.2022):
	```
...
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/metric-learning/pytorch-metric-learning) (📥 9.3K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 21 · 🔀 760 · 📦 650 · 📋 180 - 23% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/rtqichen/torchdiffeq
	```
- [PyPi](https://pypi.org/project/torchdiffeq) (📥 630K / month):
	```
	pip install torchdiffeq
	```
- [Conda](https://anaconda.org/conda-forge/torchdiffeq) (📥 9.1K · ⏱️ 03.06.2021):
	```
...
- [GitHub](https://github.com/Lightning-AI/lightning-flash) (👨‍💻 81 · 🔀 190 · 📦 150 · 📋 500 - 4% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/lightning-flash) (📥 2.5K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lightning-flash) (📥 9.4K · ⏱️ 08.11.2022):
	```
	conda install -c conda-forge lightning-flash
	```
</details>
<details><summary><b><a href="https://github.com/geohot/tinygrad">tinygrad</a></b> (🥈25 ·  ⭐ 9.7K · 📈) - You like pytorch? You like micrograd? You love tinygrad!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 70 · 🔀 840 · 📦 5 · 📋 120 - 11% open · ⏱️ 15.11.2022):
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 110 · 📋 25 - 4% open · ⏱️ 25.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch_toolbelt) (📥 9.3K / month):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥈23 ·  ⭐ 760) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 36 · 🔀 120 · 📋 220 - 12% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 390 · 📋 250 - 6% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 22K / month):
	```
	pip install pytorch-tabnet
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-tabnet) (📥 2.9K · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/lucidrains/performer-pytorch) (👨‍💻 6 · 🔀 130 · 📦 70 · 📋 82 - 47% open · ⏱️ 02.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/performer-pytorch) (📥 3K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/madgrad) (👨‍💻 2 · 🔀 55 · 📦 41 · 📋 9 - 22% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.4K · 🔀 4.4K · 📥 360K · 📦 620K · 📋 8.8K - 16% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/scipy/scipy
	```
- [PyPi](https://pypi.org/project/scipy) (📥 44M / month):
	```
	pip install scipy
	```
- [Conda](https://anaconda.org/conda-forge/scipy) (📥 31M · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 160 · 🔀 1.9K · 📦 550 · 📋 2.9K - 19% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/streamlit/streamlit
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 970K / month):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 68 · 🔀 1.9K · 📥 580 · 📦 1.1K · 📋 1.2K - 42% open · ⏱️ 29.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/paddlehub) (📥 8.3K / month):
	```
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 120 · 🔀 740 · 📋 1.5K - 16% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 800K / month):
	```
	pip install gradio
	```
</details>
<details><summary><b><a href="https://github.com/simonw/datasette">Datasette</a></b> (🥇33 ·  ⭐ 6.8K) - An open source multi-tool for exploring and publishing data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/simonw/datasette) (👨‍💻 73 · 🔀 450 · 📥 41 · 📦 820 · 📋 1.5K - 27% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 210 · 🔀 1.4K · 📦 150 · 📋 1.5K - 30% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 9.3K / month):
	```
	pip install deepchem
	```
- [Conda](https://anaconda.org/conda-forge/deepchem) (📥 72K · ⏱️ 02.12.2022):
	```
	conda install -c conda-forge deepchem
	```
</details>
<details><summary><b><a href="https://github.com/adapter-hub/adapter-transformers">adapter-transformers</a></b> (🥇33 ·  ⭐ 1.2K) - Huggingface Transformers + Adapters =. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/adapter-hub/adapter-transformers) (👨‍💻 1.6K · 🔀 190 · 📦 110 · 📋 250 - 15% open · ⏱️ 20.12.2022):
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 52 · 🔀 810 · 📦 4.4K · 📋 380 - 39% open · ⏱️ 29.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/autograd) (📥 850K / month):
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 91 · 🔀 440 · 📦 200 · 📋 390 - 0% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 9.6K / month):
	```
	pip install river
	```
- [Conda](https://anaconda.org/conda-forge/river) (📥 24K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 68 · 🔀 180 · 📦 420 · 📋 780 - 13% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/serge-sans-paille/pythran
	```
- [PyPi](https://pypi.org/project/pythran) (📥 500K / month):
	```
	pip install pythran
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 51 · 🔀 140 · 📦 1.4K · 📋 640 - 1% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 110 · 🔀 160 · 📦 270 · 📋 520 - 20% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 130 · 🔀 420 · 📥 63 · 📋 860 - 23% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 14K / month):
	```
	pip install pennylane
	```
- [Conda](https://anaconda.org/conda-forge/pennylane) (📥 6.6K · ⏱️ 01.05.2022):
	```
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 60 · 🔀 200 · 📥 4 · 📦 16 · 📋 610 - 10% open · ⏱️ 15.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 650 / month):
	```
...
- [GitHub](https://github.com/nicodv/kmodes) (👨‍💻 21 · 🔀 380 · 📦 1.7K · 📋 150 - 11% open · ⏱️ 10.12.2022):
...
- [PyPi](https://pypi.org/project/kmodes) (📥 400K / month):
	...
	pip install kmodes
	```
- [Conda](https://anaconda.org/conda-forge/kmodes) (📥 23K · ⏱️ 06.09.2022):
	```
...
- [GitHub](https://github.com/deepmind/pysc2) (👨‍💻 36 · 🔀 1.1K · 📥 30K · 📦 460 · 📋 270 - 16% open · ⏱️ 07.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysc2) (📥 1.9K / month):
	```
	pip install pysc2
	```
</details>
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 17 · 🔀 160 · 📦 140 · 📋 300 - 31% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/SeldonIO/alibi-detect
	```
- [PyPi](https://pypi.org/project/alibi-detect) (📥 21K / month):
	```
...
- [GitHub](https://github.com/tableau/TabPy) (👨‍💻 46 · 🔀 510 · 📦 100 · 📋 300 - 4% open · ⏱️ 06.10.2022):
...
- [GitHub](https://github.com/mars-project/mars) (👨‍💻 45 · 🔀 310 · 📋 1.2K - 17% open · ⏱️ 23.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pymars) (📥 22K / month):
	```
	pip install pymars
	```
</details>
...
- [GitHub](https://github.com/google/trax) (👨‍💻 78 · 🔀 740 · 📦 91 · 📋 220 - 42% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 44 · 🔀 310 · 📦 220 · 📋 210 - 5% open · ⏱️ 03.07.2022):

	```
	git clone https://github.com/ljvmiranda921/pyswarms
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 5.9K / month):
	```
	pip install pyswarms
	```
</details>
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉24 ·  ⭐ 920) - Python factor analysis library (PCA, CA, MCA, MFA, FAMD). <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 13 · 🔀 160 · 📦 270 · 📋 110 - 37% open · ⏱️ 07.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/prince) (📥 23K / month):
	```
	pip install prince
	```
...
<details><summary><b><a href="https://github.com/Project-MONAI/MONAILabel">MONAILabel</a></b> (🥉24 ·  ⭐ 350) - MONAI Label is an intelligent open source image labeling and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Project-MONAI/MONAILabel) (👨‍💻 38 · 🔀 100 · 📥 35K · 📋 350 - 11% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/rasbt/biopandas) (👨‍💻 9 · 🔀 100 · 📦 140 · 📋 47 - 36% open · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/dstackai/dstack">dstack</a></b> (🥉22 ·  ⭐ 460 · 📈) - An open-source ML workflow orchestration system designed for.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/dstackai/dstack) (👨‍💻 6 · 🔀 25 · 📦 10 · 📋 130 - 23% open · ⏱️ 27.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/dstack) (📥 340 / month):
	```
	pip install dstack
	```
</details>
...
<details><summary><b><a href="https://github.com/pykale/pykale">pykale</a></b> (🥉18 ·  ⭐ 370) - Knowledge-Aware machine LEarning (KALE): accessible machine learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pykale/pykale) (👨‍💻 18 · 🔀 49 · ⏱️ 16.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/pykale) (📥 71 / month):
	```
	pip install pykale
	```
</details>
...
- [GitHub](https://github.com/yzhao062/SUOD) (👨‍💻 2 · 🔀 43 · 📦 460 · 📋 10 - 70% open · ⏱️ 07.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/suod) (📥 33K / month):
	```
	pip install suod
	```
</details>
...
- <b><a href="https://github.com/carla-simulator/carla">carla</a></b> (🥇35 ·  ⭐ 8.7K) - Open-source simulator for autonomous driving research. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/kLabUM/rrcf">rrcf</a></b> (🥉19 ·  ⭐ 420 · 💀) - Implementation of the Robust Random Cut Forest algorithm for anomaly.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
