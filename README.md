...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.7K · 🔀 22K · 📥 800 · 📦 370K · 📋 9.5K - 16% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.4K · 🔀 15K · 📥 4.1K · 📋 27K - 32% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/torch) (📥 9.1M / month):
	```
	pip install torch
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 570 · 🔀 7.9K · 📥 4.4K · 📦 33K · 📋 4.4K - 5% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/google/jax) (👨‍💻 420 · 🔀 1.7K · 📦 4.8K · 📋 3.3K - 26% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/google/jax
	```
- [PyPi](https://pypi.org/project/jax) (📥 680K / month):
	```
	pip install jax
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 380 · 🔀 2.3K · 📥 26 · 📦 66K · 📋 4.8K - 46% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.9M / month):
	```
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 260 · 🔀 3.5K · 📥 160K · 📦 14K · 📋 2.7K - 7% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 200 · 🔀 7.1K · 📦 11K · 📋 1.6K - 5% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 770 · 🔀 4.4K · 📥 15K · 📦 130 · 📋 15K - 13% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.1K · 🔀 18K · 📋 11K - 2% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 150 · 🔀 1.9K · 📦 310 · 📋 1.6K - 2% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/jina) (📥 87K / month):
	...
	pip install jina
	```
- [Conda](https://anaconda.org/conda-forge/jina-core) (📥 9.4K · ⏱️ 22.04.2022):
	```
	conda install -c conda-forge jina-core
	```
- [Docker Hub](https://hub.docker.com/r/jinaai/jina) (📥 1.1M · ⭐ 7 · ⏱️ 30.06.2022):
	```
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 52 · 🔀 240 · 📦 22K · 📋 120 - 11% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/explosion/thinc
	```
- [PyPi](https://pypi.org/project/thinc) (📥 4.7M / month):
	```
	pip install thinc
	```
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.7K · 🔀 25K · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/pyspark) (📥 24M / month):
	...
	pip install pyspark
	```
- [Conda](https://anaconda.org/conda-forge/pyspark) (📥 1.7M · ⏱️ 16.06.2022):
	```
...
- [GitHub](https://github.com/Lightning-AI/lightning) (👨‍💻 690 · 🔀 2.4K · 📥 7.1K · 📋 5K - 7% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/catboost/catboost) (👨‍💻 1K · 🔀 980 · 📥 83K · 📋 1.8K - 21% open · ⏱️ 29.06.2022):
...
<details><summary><b><a href="https://github.com/google/flax">Flax</a></b> (🥈36 ·  ⭐ 3.2K) - Flax is a neural network library for JAX that is designed for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/flax) (👨‍💻 160 · 🔀 350 · 📥 42 · 📦 1.1K · 📋 510 - 18% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/flax) (📥 340K / month):
	...
	pip install flax
	```
- [Conda](https://anaconda.org/conda-forge/flax) (📥 5.8K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 25K · 📋 9.5K - 18% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/mxnet) (📥 340K / month):
	...
	pip install mxnet
	```
- [Conda](https://anaconda.org/anaconda/mxnet) (📥 7.7K · ⏱️ 02.05.2022):
	```
...
- [PyPi](https://pypi.org/project/chainer) (📥 26K / month):
	...
	pip install chainer
	```
- [Conda](https://anaconda.org/conda-forge/chainer) (📥 8.3K · ⏱️ 21.01.2022):
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 120 · 🔀 950 · 📦 130 · 📋 770 - 24% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 320 · 🔀 1.7K · 📋 1.2K - 10% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/vowpalwabbit) (📥 72K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/vowpalwabbit) (📥 64K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/apple/turicreate) (👨‍💻 85 · 🔀 1.1K · 📥 6.1K · 📦 310 · 📋 1.8K - 27% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/turicreate) (📥 24K / month):
	```
...
- [GitHub](https://github.com/deepmind/sonnet) (👨‍💻 53 · 🔀 1.2K · 📦 860 · 📋 180 - 14% open · ⏱️ 07.03.2022):
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.6K · 🔀 11K · ⏱️ 30.06.2022):

	```
	git clone https://github.com/apache/flink
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/tensorpack) (📥 16K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorpack) (📥 1.8K · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/clab/dynet) (👨‍💻 160 · 🔀 670 · 📥 6.2K · 📦 220 · 📋 920 - 27% open · ⏱️ 11.03.2022):
...
- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 61 · 🔀 150 · 📦 480 · 📋 170 - 24% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/dm-haiku) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dm-haiku) (📥 3.3K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 4K · 🔀 69 · 📥 20 · 📋 320 - 16% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 15 · 🔀 240 · 📦 300 · 📋 420 - 0% open · ⏱️ 22.05.2022):
...
<details><summary><b><a href="https://github.com/arogozhnikov/einops">einops</a></b> (🥉29 ·  ⭐ 5.3K) - Deep learning operations reinvented (for pytorch, tensorflow, jax and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 17 · 🔀 230 · 📦 3.2K · 📋 120 - 32% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/einops) (📥 2M / month):
	...
	pip install einops
	```
- [Conda](https://anaconda.org/conda-forge/einops) (📥 19K · ⏱️ 04.03.2022):
	```
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 49 · 🔀 300 · 📦 530 · 📋 440 - 10% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 67 · 🔀 310 · 📥 540 · 📋 69 - 31% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 22 · 🔀 200 · 📥 240 · 📦 42 · 📋 120 - 32% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/XiaoMi/mace) (👨‍💻 64 · 🔀 790 · 📥 1.4K · 📋 660 - 6% open · ⏱️ 30.05.2022):
...
- [GitHub](https://github.com/nubank/fklearn) (👨‍💻 43 · 🔀 160 · 📦 12 · 📋 47 - 53% open · ⏱️ 18.04.2022):
...
<details><summary><b><a href="https://github.com/towhee-io/towhee">Towhee</a></b> (🥉21 ·  ⭐ 600) - A framework that provides a simple API for developing ML-driven data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 27 · 🔀 97 · 📥 25 · 📋 390 - 6% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/towhee-io/towhee
	```
- [PyPi](https://pypi.org/project/towhee) (📥 580 / month):
	```
	pip install towhee
	```
</details>
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 31 · 🔀 110 · 📋 61 - 22% open · ⏱️ 29.06.2022):
...
<details><summary><b><a href="https://github.com/poets-ai/elegy">elegy</a></b> (🥉17 ·  ⭐ 380) - A High Level API for Deep Learning in JAX. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/poets-ai/elegy) (👨‍💻 17 · 🔀 26 · 📋 93 - 29% open · ⏱️ 23.05.2022):
...
- [GitHub](https://github.com/serengil/chefboost) (👨‍💻 6 · 🔀 89 · 📦 24 · 📋 26 - 3% open · ⏱️ 21.05.2022):

	```
	git clone https://github.com/serengil/chefboost
	```
- [PyPi](https://pypi.org/project/chefboost) (📥 730 / month):
	```
...
- <b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉28 ·  ⭐ 8.2K) - In-Database Machine Learning. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.4K · 🔀 6.2K · 📦 580K · 📋 8.7K - 17% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 170 · 🔀 1.5K · 📥 220 · 📦 170K · 📋 2K - 4% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 120 · 🔀 1.7K · 📦 200 · 📋 1.3K - 46% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/plotly/dash
	```
- [PyPi](https://pypi.org/project/dash) (📥 910K / month):
	```
	pip install dash
	```
- [Conda](https://anaconda.org/conda-forge/dash) (📥 510K · ⏱️ 14.06.2022):
	```
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈36 ·  ⭐ 7.6K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 140 · 🔀 640 · 📦 29K · 📋 1.6K - 13% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 7.7M / month):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 100 · 🔀 620 · 📦 5.6K · 📋 620 - 52% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 93 · 🔀 250 · 📥 650 · 📦 810 · 📋 850 - 28% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/pyvista) (📥 150K / month):
	...
	pip install pyvista
	```
- [Conda](https://anaconda.org/conda-forge/pyvista) (📥 190K · ⏱️ 17.06.2022):
	```
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 48 · 🔀 340 · 📦 1.2K · 📋 500 - 24% open · ⏱️ 23.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/datashader) (📥 48K / month):
	```
...
- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 43 · 🔀 190 · 📦 130 · 📋 830 - 30% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 28K / month):
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 19 · 🔀 180 · 📦 33K · 📋 140 - 4% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/graphviz) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/anaconda/python-graphviz) (📥 26K · ⏱️ 04.02.2021):
	```
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 30 · 🔀 2.7K · 📦 2.3K · 📋 1.6K - 1% open · ⏱️ 25.04.2022):

	```
	git clone https://github.com/pyecharts/pyecharts
	```
- [PyPi](https://pypi.org/project/pyecharts) (📥 80K / month):
	```
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 120 · 🔀 350 · 📋 2.8K - 30% open · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥈30 ·  ⭐ 4.7K) - A data visualization and analytics component, especially.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/holoviz/hvplot">hvPlot</a></b> (🥈30 ·  ⭐ 580) - A high-level plotting API for pandas, dask, xarray, and networkx built on.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 36 · 🔀 68 · 📦 1.4K · 📋 420 - 33% open · ⏱️ 23.06.2022):
...
- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 24 · 🔀 120 · 📥 360 · 📦 500 · 📋 150 - 17% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 2.1M / month):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 96 · 🔀 170 · 📋 500 - 12% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 16 · 🔀 32 · 📥 290 · 📦 17 · 📋 250 - 26% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/JetBrains/lets-plot
	```
- [PyPi](https://pypi.org/project/lets-plot) (📥 2.2K / month):
	```
...
<details><summary><b><a href="https://github.com/AutoViML/AutoViz">AutoViz</a></b> (🥉23 ·  ⭐ 730) - Automatically Visualize any dataset, any size with a single line of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/autoviz) (📥 68K / month):
	...
	pip install autoviz
	```
- [Conda](https://anaconda.org/conda-forge/autoviz) (📥 7.3K · ⏱️ 20.06.2022):
	```
	conda install -c conda-forge autoviz
	```
</details>
<details><summary><b><a href="https://github.com/ing-bank/popmon">Popmon</a></b> (🥉23 ·  ⭐ 350) - Monitor the stability of a Pandas or Spark dataframe. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 14 · 🔀 27 · 📥 22 · 📦 14 · 📋 36 - 50% open · ⏱️ 21.06.2022):
...
- [GitHub](https://github.com/facebookresearch/hiplot) (👨‍💻 8 · 🔀 120 · 📦 5 · 📋 78 - 15% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/hiplot) (📥 26K / month):
	...
	pip install hiplot
	```
- [Conda](https://anaconda.org/conda-forge/hiplot) (📥 91K · ⏱️ 31.05.2022):
	```
...
- [GitHub](https://github.com/fbdesignpro/sweetviz) (👨‍💻 6 · 🔀 200 · 📋 100 - 28% open · ⏱️ 08.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/sweetviz) (📥 85K / month):
	```
...
- [GitHub](https://github.com/marcharper/python-ternary) (👨‍💻 27 · 🔀 140 · 📥 18 · 📦 95 · 📋 120 - 23% open · ⏱️ 27.02.2022):
...
- [PyPi](https://pypi.org/project/pywaffle) (📥 4.9K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pywaffle) (📥 5.1K · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/leotac/joypy) (👨‍💻 6 · 🔀 47 · 📦 170 · 📋 47 - 21% open · ⏱️ 19.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/joypy) (📥 18K / month):
	```
	pip install joypy
	```
...
- [PyPi](https://pypi.org/project/transformers) (📥 6.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transformers) (📥 280K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 690 · 🔀 3.8K · 📥 3.1K · 📦 41K · 📋 5.1K - 1% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/explosion/spaCy
	```
- [PyPi](https://pypi.org/project/spacy) (📥 5.3M / month):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/nltk/nltk) (👨‍💻 420 · 🔀 2.5K · 📦 150K · 📋 1.6K - 13% open · ⏱️ 13.06.2022):
...
<details><summary><b><a href="https://github.com/facebookresearch/fairseq">fairseq</a></b> (🥇39 ·  ⭐ 17K · 📈) - Facebook AI Research Sequence-to-Sequence Toolkit written in.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/fairseq) (👨‍💻 400 · 🔀 4.4K · 📥 240 · 📦 860 · 📋 3.4K - 16% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/pytorch/fairseq
	```
- [PyPi](https://pypi.org/project/fairseq) (📥 60K / month):
	```
	pip install fairseq
	```
...
- [GitHub](https://github.com/gunthercox/ChatterBot) (👨‍💻 100 · 🔀 4K · 📦 4.5K · 📋 1.6K - 19% open · ⏱️ 01.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/chatterbot) (📥 76K / month):
	```
...
- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 92 · 🔀 1.5K · 📦 3.5K · 📋 1.5K - 50% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sentence-transformers) (📥 25K · ⏱️ 27.06.2022):
	```
	conda install -c conda-forge sentence-transformers
	```
</details>
<details><summary><b><a href="https://github.com/RasaHQ/rasa">Rasa</a></b> (🥇35 ·  ⭐ 14K) - Open source machine learning framework to automate text- and voice-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 540 · 🔀 3.9K · 📋 6.5K - 12% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 190 · 🔀 1.8K · 📦 85 · 📋 1.4K - 5% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 66 · 🔀 790 · 📥 21K · 📦 16K · 📋 530 - 5% open · ⏱️ 20.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 6.1M / month):
	```
...
- [GitHub](https://github.com/facebookresearch/fastText) (👨‍💻 59 · 🔀 4.3K · 📦 3.1K · 📋 1K - 41% open · ⏱️ 04.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/fasttext) (📥 540K / month):
	```
...
- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 120 · 🔀 560 · 📋 660 - 4% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/JohnSnowLabs/spark-nlp
	```
- [PyPi](https://pypi.org/project/spark-nlp) (📥 2M / month):
	```
...
- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 56 · 🔀 470 · 📦 49 · 📋 630 - 28% open · ⏱️ 10.06.2022):

	```
	git clone https://github.com/huggingface/tokenizers
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 6.6M / month):
	```
	pip install tokenizers
	```
- [Conda](https://anaconda.org/conda-forge/tokenizers) (📥 240K · ⏱️ 21.05.2022):
	```
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 64 · 🔀 460 · 📦 230 · 📋 750 - 6% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/dedupe) (📥 330K / month):
	...
	pip install dedupe
	```
- [Conda](https://anaconda.org/conda-forge/dedupe) (📥 6.6K · ⏱️ 11.06.2022):
	```
...
- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 150 · 🔀 1K · 📥 9.4K · 📋 1.1K - 2% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 130 · 🔀 690 · 📋 660 - 34% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 82 · 🔀 500 · 📦 860 · 📋 530 - 43% open · ⏱️ 24.08.2021):

	```
	git clone https://github.com/dmlc/gluon-nlp
	```
- [PyPi](https://pypi.org/project/gluonnlp) (📥 88K / month):
	```
...
- [PyPi](https://pypi.org/project/textdistance) (📥 560K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 130K · ⏱️ 29.06.2022):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 23K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 1.3K · ⏱️ 22.04.2022):
	```
...
- [PyPi](https://pypi.org/project/jellyfish) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jellyfish) (📥 250K · ⏱️ 08.04.2022):
	```
...
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥈28 ·  ⭐ 4.9K) - Haystack is an open source NLP framework that leverages pre-trained.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 120 · 🔀 780 · 📥 13 · 📋 1.4K - 14% open · ⏱️ 27.06.2022):
...
<details><summary><b><a href="https://github.com/makcedward/nlpaug">nlpaug</a></b> (🥈28 ·  ⭐ 3.3K) - Data augmentation for NLP. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/makcedward/nlpaug) (👨‍💻 30 · 🔀 370 · 📦 350 · 📋 190 - 22% open · ⏱️ 03.04.2022):

	```
	git clone https://github.com/makcedward/nlpaug
	```
- [PyPi](https://pypi.org/project/nlpaug) (📥 66K / month):
	```
	pip install nlpaug
	```
- [Conda](https://anaconda.org/conda-forge/nlpaug) (📥 2.5K · ⏱️ 25.12.2021):
	```
...
- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 18 · 🔀 130 · 📦 540 · ⏱️ 21.06.2022):
...
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 93K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spacy-transformers) (📥 2K · ⏱️ 02.06.2022):
	```
...
- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 54 · 🔀 420 · 📥 66 · 📦 85 · 📋 190 - 21% open · ⏱️ 06.12.2021):
...
<details><summary><b><a href="https://github.com/huggingface/neuralcoref">neuralcoref</a></b> (🥈27 ·  ⭐ 2.6K · 💤) - Fast Coreference Resolution in spaCy with Neural Networks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/huggingface/neuralcoref) (👨‍💻 21 · 🔀 440 · 📥 420 · 📦 510 · 📋 300 - 15% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/huggingface/neuralcoref
	```
- [PyPi](https://pypi.org/project/neuralcoref) (📥 280K / month):
	```
...
- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 18 · 🔀 300 · 📦 260 · 📋 87 - 29% open · ⏱️ 07.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytextrank) (📥 30K / month):
	```
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 48 · 🔀 580 · 📦 110 · 📋 380 - 11% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/vadersentiment) (📥 210K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/vadersentiment) (📥 8.9K · ⏱️ 22.03.2021):
	```
...
- [GitHub](https://github.com/NTMC-Community/MatchZoo) (👨‍💻 36 · 🔀 900 · 📦 11 · 📋 460 - 6% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/matchzoo) (📥 120 / month):
	```
...
- [GitHub](https://github.com/BrikerMan/Kashgari) (👨‍💻 21 · 🔀 440 · 📦 52 · 📋 370 - 11% open · ⏱️ 09.07.2021):

	```
	git clone https://github.com/BrikerMan/Kashgari
	```
- [PyPi](https://pypi.org/project/kashgari-tf) (📥 67 / month):
	```
	pip install kashgari-tf
	```
</details>
<details><summary><b><a href="https://github.com/qdrant/qdrant">qdrant</a></b> (🥉23 ·  ⭐ 1.9K) - Qdrant - Vector Search Engine for the next generation of AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 26 · 🔀 99 · 📋 240 - 13% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 12 · 🔀 250 · 📦 290 · 📋 87 - 18% open · ⏱️ 26.03.2022):
...
- [PyPi](https://pypi.org/project/scattertext) (📥 3.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scattertext) (📥 63K · ⏱️ 26.03.2022):
	```
...
- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 16 · 🔀 170 · 📦 13 · 📋 130 - 2% open · ⏱️ 19.06.2022):

	```
	git clone https://github.com/thunlp/OpenPrompt
	```
- [PyPi](https://pypi.org/project/openprompt) (📥 850 / month):
	```
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 17 · 🔀 220 · 📥 33K · 📦 150 · 📋 110 - 18% open · ⏱️ 16.08.2021):
...
- [GitHub](https://github.com/recognai/rubrix) (👨‍💻 19 · 🔀 93 · 📋 560 - 5% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/recognai/rubrix
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 1.9K / month):
	```
	pip install rubrix
	```
- [Conda](https://anaconda.org/conda-forge/rubrix) (📥 3.6K · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 57 · 🔀 290 · 📥 14 · 📋 280 - 1% open · ⏱️ 14.06.2022):
...
<details><summary><b><a href="https://github.com/unitaryai/detoxify">detoxify</a></b> (🥉23 ·  ⭐ 440) - Trained models & code to predict toxic comments on all 3 Jigsaw.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 7 · 🔀 56 · 📥 49K · 📦 97 · 📋 31 - 45% open · ⏱️ 13.06.2022):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 5.8K / month):
	```
...
- [PyPi](https://pypi.org/project/farm) (📥 4K / month):
	...
	pip install farm
	```
- [Conda](https://anaconda.org/conda-forge/farm) (📥 1.2K · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/nyu-mll/jiant) (👨‍💻 58 · 🔀 270 · 📦 2 · 📋 550 - 11% open · ⏱️ 23.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jiant) (📥 61 / month):
	```
	pip install jiant
	```
</details>
...
<details><summary><b><a href="https://github.com/anhaidgroup/deepmatcher">DeepMatcher</a></b> (🥉17 ·  ⭐ 430 · 💤) - Python package for performing Entity and Text Matching using.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/anhaidgroup/deepmatcher) (👨‍💻 7 · 🔀 95 · 📦 19 · 📋 84 - 72% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/anhaidgroup/deepmatcher
	```
- [PyPi](https://pypi.org/project/deepmatcher) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/PKSHATechnology-Research/camphr) (👨‍💻 7 · 🔀 17 · 📋 28 - 7% open · ⏱️ 18.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/camphr) (📥 320 / month):
	```
	pip install camphr
	```
</details>
...
<details><summary><b><a href="https://github.com/pytorch/translate">Translate</a></b> (🥉16 ·  ⭐ 740) - Translate - a PyTorch Language Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/RUCAIBox/TextBox">TextBox</a></b> (🥉16 ·  ⭐ 370) - TextBox is an open-source library for building text generation system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 14 · 🔀 65 · 📦 5 · 📋 20 - 15% open · ⏱️ 06.05.2022):
...
- [GitHub](https://github.com/Ki6an/fastT5) (👨‍💻 5 · 🔀 35 · 📦 17 · 📋 47 - 21% open · ⏱️ 05.04.2022):

	```
	git clone https://github.com/Ki6an/fastT5
	```
- [PyPi](https://pypi.org/project/fastt5) (📥 1.6K / month):
	```
	pip install fastt5
	```
</details>
...
- <b><a href="https://github.com/VKCOM/YouTokenToMe">YouTokenToMe</a></b> (🥉23 ·  ⭐ 810 · 💀) - Unsupervised text tokenizer focused on computational efficiency. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/jaidevd/numerizer">numerizer</a></b> (🥉15 ·  ⭐ 160) - A Python module to convert natural language numerics into ints and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/MartinoMensio/spacy-dbpedia-spotlight">spacy-dbpedia-spotlight</a></b> (🥉13 ·  ⭐ 67) - A spaCy wrapper for DBpedia Spotlight. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>spacy</code>
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 400 · 🔀 1.7K · 📦 780K · 📋 2.5K - 3% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 47M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/pillow) (📥 16M · ⏱️ 15.06.2022):
	```
...
- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 340 · 🔀 6.7K · 📦 440 · 📋 6K - 9% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/open-mmlab/mmdetection
	```
- [PyPi](https://pypi.org/project/mmdet) (📥 44K / month):
	```
	pip install mmdet
	```
</details>
...
- [GitHub](https://github.com/rwightman/pytorch-image-models) (👨‍💻 76 · 🔀 3.1K · 📥 1.4M · 📦 3.5K · 📋 520 - 10% open · ⏱️ 25.06.2022):

	```
	git clone https://github.com/rwightman/pytorch-image-models
	```
- [PyPi](https://pypi.org/project/timm) (📥 2M / month):
	```
	pip install timm
	```
- [Conda](https://anaconda.org/conda-forge/timm) (📥 21K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 490 · 🔀 5.9K · 📥 7.9K · 📋 2.4K - 24% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 4.5M / month):
	```
	pip install torchvision
	```
- [Conda](https://anaconda.org/conda-forge/torchvision) (📥 280K · ⏱️ 29.03.2022):
	```
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 150 · 🔀 1.2K · 📦 17K · 📋 1.2K - 24% open · ⏱️ 01.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 980K / month):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 90 · 🔀 210 · 📥 300 · 📦 64K · 📋 450 - 12% open · ⏱️ 30.05.2022):
...
- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 110 · 🔀 1.3K · 📦 8.4K · 📋 620 - 40% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/albumentations) (📥 300K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/albumentations) (📥 42K · ⏱️ 15.07.2021):
	```
...
- [GitHub](https://github.com/kornia/kornia) (👨‍💻 170 · 🔀 660 · 📥 340 · 📦 1.4K · 📋 580 - 26% open · ⏱️ 15.06.2022):
...
- [PyPi](https://pypi.org/project/kornia) (📥 440K / month):
	...
	pip install kornia
	```
- [Conda](https://anaconda.org/conda-forge/kornia) (📥 20K · ⏱️ 17.05.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 210 · 🔀 5.5K · 📦 650 · 📋 3K - 6% open · ⏱️ 16.06.2022):
...
- [PyPi](https://pypi.org/project/detectron2):
	...
	```
- [Conda](https://anaconda.org/conda-forge/detectron2) (📥 64K · ⏱️ 25.04.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 98 · 🔀 2K · 📦 19 · 📋 3.6K - 19% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleDetection
	```
- [PyPi](https://pypi.org/project/paddledet) (📥 220 / month):
	```
	pip install paddledet
	```
</details>
<details><summary><b><a href="https://github.com/dmlc/gluon-cv">GluonCV</a></b> (🥈31 ·  ⭐ 5.2K) - Gluon CV Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/dmlc/gluon-cv) (👨‍💻 120 · 🔀 1.2K · 📦 800 · 📋 810 - 5% open · ⏱️ 19.05.2022):
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈30 ·  ⭐ 45K) - The worlds simplest facial recognition api for Python and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 460 · 📋 1.2K - 53% open · ⏱️ 10.06.2022):
...
- [PyPi](https://pypi.org/project/face_recognition) (📥 50K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 7.5K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 46 · 🔀 3.8K · 📦 170 · 📋 1.9K - 54% open · ⏱️ 10.06.2022):
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleSeg">PaddleSeg</a></b> (🥈30 ·  ⭐ 5K) - Easy-to-use image segmentation library with awesome pre-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 79 · 🔀 1.1K · 📦 580 · 📋 1.2K - 50% open · ⏱️ 23.06.2022):
...
- [PyPi](https://pypi.org/project/imutils) (📥 320K / month):
	...
	pip install imutils
	```
- [Conda](https://anaconda.org/conda-forge/imutils) (📥 90K · ⏱️ 09.12.2021):
	```
...
<details><summary><b><a href="https://github.com/lucidrains/vit-pytorch">vit-pytorch</a></b> (🥈29 ·  ⭐ 11K) - Implementation of Vision Transformer, a simple way to achieve.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 15 · 🔀 1.7K · 📦 120 · 📋 190 - 47% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/obss/sahi) (👨‍💻 14 · 🔀 270 · 📥 1.6K · 📦 78 · 📋 160 - 7% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/sahi) (📥 64K / month):
	...
	pip install sahi
	```
- [Conda](https://anaconda.org/conda-forge/sahi) (📥 5.8K · ⏱️ 28.05.2022):
	```
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 26 · 🔀 900 · 📦 660 · ⏱️ 22.06.2022):
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 39 · 🔀 560 · 📋 550 - 7% open · ⏱️ 24.06.2022):
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥉27 ·  ⭐ 2.3K) - A High-performance cross-platform Video Processing Python framework.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 9 · 🔀 180 · 📥 600 · 📦 220 · 📋 220 - 0% open · ⏱️ 11.02.2022):
...
<details><summary><b><a href="https://github.com/Layout-Parser/layout-parser">layout-parser</a></b> (🥉26 ·  ⭐ 3.1K) - A Unified Toolkit for Deep Learning Based Document Image.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 300 · 📦 74 · 📋 94 - 48% open · ⏱️ 05.04.2022):

	```
	git clone https://github.com/Layout-Parser/layout-parser
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 19 · 🔀 130 · 📦 37 · 📋 320 - 19% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/mdbloice/Augmentor) (👨‍💻 22 · 🔀 820 · 📦 470 · 📋 180 - 61% open · ⏱️ 24.05.2022):

	```
	git clone https://github.com/mdbloice/Augmentor
	```
- [PyPi](https://pypi.org/project/Augmentor) (📥 23K / month):
	```
...
- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 14 · 🔀 630 · 📥 330K · 📦 810 · 📋 150 - 39% open · ⏱️ 13.12.2021):
...
- [PyPi](https://pypi.org/project/mtcnn) (📥 26K / month):
	...
	pip install mtcnn
	```
- [Conda](https://anaconda.org/conda-forge/mtcnn) (📥 5.1K · ⏱️ 17.08.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 38 · 🔀 270 · 📋 140 - 43% open · ⏱️ 19.06.2022):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 13 · 🔀 38 · 📦 340 · 📋 290 - 37% open · ⏱️ 12.06.2022):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 19K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 22K · ⏱️ 18.04.2022):
	```
...
- [GitHub](https://github.com/lucidrains/deep-daze) (👨‍💻 14 · 🔀 300 · 📦 42 · 📋 160 - 55% open · ⏱️ 13.03.2022):
...
- [GitHub](https://github.com/facebookresearch/vissl) (👨‍💻 32 · 🔀 270 · 📦 8 · 📋 150 - 34% open · ⏱️ 10.06.2022):

	```
	git clone https://github.com/facebookresearch/vissl
	```
- [PyPi](https://pypi.org/project/vissl) (📥 540 / month):
	```
	pip install vissl
	```
</details>
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 14 · 🔀 140 · 📥 140 · 📋 63 - 17% open · ⏱️ 29.06.2022):
...
<details><summary><b><a href="https://github.com/idealo/image-super-resolution">Image Super-Resolution</a></b> (🥉22 ·  ⭐ 3.7K · 💤) - Super-scale your images and run experiments with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/idealo/image-super-resolution) (👨‍💻 10 · 🔀 620 · 📦 89 · 📋 200 - 44% open · ⏱️ 02.06.2021):
...
- [GitHub](https://github.com/facebookresearch/pycls) (👨‍💻 17 · 🔀 220 · 📦 6 · 📋 77 - 27% open · ⏱️ 03.06.2022):

	```
	git clone https://github.com/facebookresearch/pycls
	```
- [PyPi](https://pypi.org/project/pycls) (📥 8.6K / month):
	```
	pip install pycls
	```
</details>
...
<details><summary><b><a href="https://github.com/tensorflow/graphics">tensorflow-graphics</a></b> (🥉20 ·  ⭐ 2.6K) - TensorFlow Graphics: Differentiable Graphics Layers.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/graphics) (👨‍💻 36 · 🔀 330 · 📋 160 - 45% open · ⏱️ 04.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-graphics) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 27 · 🔀 940 · 📦 9 · 📋 520 - 51% open · ⏱️ 21.06.2022):
...
<details><summary><b><a href="https://github.com/google-research/scenic">scenic</a></b> (🥉19 ·  ⭐ 1.1K) - Scenic: A Jax Library for Computer Vision Research and Beyond. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/scenic) (👨‍💻 39 · 🔀 140 · 📦 23 · 📋 41 - 26% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/jasmcaus/caer) (👨‍💻 8 · 🔀 70 · 📥 19 · 📋 15 - 13% open · ⏱️ 13.10.2021):
...
- <b><a href="https://github.com/nicolas-chaulet/torch-points3d">Torch Points 3D</a></b> (🥉12 ·  ⭐ 80 · 🐣) - Pytorch framework for doing deep learning on point.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 220 · 🔀 2.3K · 📦 19 · 📋 1.5K - 10% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 280 · 🔀 2.6K · 📋 2.6K - 36% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/torch-geometric) (📥 88K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_geometric) (📥 7.7K · ⏱️ 16.05.2022):
	```
...
- [GitHub](https://github.com/danielegrattarola/spektral) (👨‍💻 22 · 🔀 290 · 📦 130 · 📋 230 - 18% open · ⏱️ 23.06.2022):
...
- [GitHub](https://github.com/stellargraph/stellargraph) (👨‍💻 36 · 🔀 360 · 📦 150 · 📋 1K - 26% open · ⏱️ 29.10.2021):
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 19 · 🔀 300 · 📦 330 · 📋 220 - 3% open · ⏱️ 24.06.2022):
...
- [PyPi](https://pypi.org/project/ogb) (📥 11K / month):
	...
	pip install ogb
	```
- [Conda](https://anaconda.org/conda-forge/ogb) (📥 9.1K · ⏱️ 23.02.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 26 · 🔀 250 · 📦 28 · 📋 130 - 36% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/PaddlePaddle/PGL
	```
- [PyPi](https://pypi.org/project/pgl) (📥 3.4K / month):
	```
	pip install pgl
	```
</details>
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 23 · 🔀 160 · 📦 71 · 📋 210 - 43% open · ⏱️ 26.06.2022):
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 21 · 🔀 240 · 📋 120 - 3% open · ⏱️ 24.04.2022):
...
<details><summary><b><a href="https://github.com/pykeen/pykeen">PyKEEN</a></b> (🥈24 ·  ⭐ 900) - A Python library for learning and evaluating knowledge graph embeddings. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 29 · 🔀 120 · 📥 140 · 📋 400 - 23% open · ⏱️ 26.06.2022):

	```
	git clone https://github.com/pykeen/pykeen
	```
- [PyPi](https://pypi.org/project/pykeen) (📥 1K / month):
	```
	pip install pykeen
	```
</details>
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 27 · 🔀 170 · 📋 160 - 7% open · ⏱️ 28.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 98 / month):
	```
	pip install graph4nlp
	```
</details>
<details><summary><b><a href="https://github.com/eliorc/node2vec">Node2Vec</a></b> (🥉21 ·  ⭐ 930) - Implementation of the node2vec algorithm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_cluster">torch-cluster</a></b> (🥉21 ·  ⭐ 530) - PyTorch Extension Library of Optimized Graph Cluster.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_cluster) (👨‍💻 21 · 🔀 99 · 📋 100 - 15% open · ⏱️ 30.06.2022):
...
<details><summary><b><a href="https://github.com/deepmind/jraph">jraph</a></b> (🥉20 ·  ⭐ 960) - A Graph Neural Network Library in Jax. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/jraph) (📥 1.8K / month):
	...
	pip install jraph
	```
- [Conda](https://anaconda.org/conda-forge/jraph) (📥 520 · ⏱️ 31.10.2021):
	```
...
- [GitHub](https://github.com/THUMNLab/AutoGL) (👨‍💻 13 · 🔀 94 · 📋 20 - 30% open · ⏱️ 19.04.2022):
...
<details><summary><b><a href="https://github.com/shenweichen/GraphEmbedding">GraphEmbedding</a></b> (🥉16 ·  ⭐ 2.8K) - Implementation and experiments of graph embedding algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/vaticle/kglib) (👨‍💻 8 · 🔀 89 · 📥 210 · 📋 59 - 16% open · ⏱️ 28.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/grakn-kglib) (📥 40 / month):
	```
...
- [GitHub](https://github.com/microsoft/ptgnn) (👨‍💻 7 · 🔀 40 · 📦 1 · ⏱️ 01.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ptgnn) (📥 68 / month):
	```
	pip install ptgnn
	```
</details>
...
- <b><a href="https://github.com/phanein/deepwalk">DeepWalk</a></b> (🥉20 ·  ⭐ 2.4K · 💀) - DeepWalk - Deep Learning for Graphs. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 280 · 🔀 1.6K · 📥 76 · 📦 55 · 📋 1.8K - 15% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/mozilla/DeepSpeech) (👨‍💻 160 · 🔀 3.4K · 📥 860K · 📦 770 · 📋 2.1K - 5% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/mozilla/DeepSpeech
	```
- [PyPi](https://pypi.org/project/deepspeech) (📥 8.2K / month):
	```
	pip install deepspeech
	```
- [Conda](https://anaconda.org/conda-forge/deepspeech) (📥 650 · ⏱️ 29.07.2021):
	```
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 170 · 🔀 790 · 📦 200 · 📋 700 - 23% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.5K · 📦 370 · 📋 880 - 34% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 92 · 🔀 830 · 📦 13K · 📋 480 - 46% open · ⏱️ 14.05.2022):
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 160 · 🔀 410 · 📋 610 - 22% open · ⏱️ 29.06.2022):
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥈29 ·  ⭐ 5.2K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 99 · 🔀 790 · 📋 990 - 4% open · ⏱️ 27.06.2022):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 840K / month):
	```
	pip install librosa
	```
...
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈28 ·  ⭐ 5.3K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 95 · 🔀 550 · 📥 200K · 📋 360 - 5% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/tts) (📥 5.1K / month):
	...
	pip install tts
	```
- [Conda](https://anaconda.org/conda-forge/tts) (📥 2.5K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 21 · 🔀 94 · 📦 8.8K · 📋 79 - 39% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 820K / month):
	```
...
<details><summary><b><a href="https://github.com/Uberi/speech_recognition">SpeechRecognition</a></b> (🥉26 ·  ⭐ 6.3K) - Speech recognition module for Python, supporting several.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Uberi/speech_recognition) (👨‍💻 45 · 🔀 2K · 📋 510 - 45% open · ⏱️ 26.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/SpeechRecognition) (📥 310K / month):
	```
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 31 · 🔀 380 · 📦 9 · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 21 · 🔀 87 · 📦 540 · 📋 92 - 14% open · ⏱️ 15.03.2022):
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉23 ·  ⭐ 840) - kapre: Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 22 · 📦 1.7K · 📋 94 - 12% open · ⏱️ 21.01.2022):
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 24 · 🔀 70 · 📥 3.4K · 📋 170 - 39% open · ⏱️ 23.02.2022):

	```
	git clone https://github.com/bastibe/python-soundfile
	```
- [PyPi](https://pypi.org/project/soundfile) (📥 910K / month):
	```
...
<details><summary><b><a href="https://github.com/KinWaiCheuk/nnAudio">nnAudio</a></b> (🥉20 ·  ⭐ 690) - Audio processing by using pytorch 1D convolution network. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 13 · 🔀 66 · 📦 56 · 📋 49 - 24% open · ⏱️ 24.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/nnAudio) (📥 5.2K / month):
	```
	pip install nnAudio
	```
</details>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 200 · 🔀 1.7K · 📦 4.2K · 📋 2.5K - 5% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 130 · 🔀 450 · 📥 53 · 📦 31K · 📋 880 - 17% open · ⏱️ 20.06.2022):
...
- [PyPi](https://pypi.org/project/shapely) (📥 7.3M / month):
	...
	pip install shapely
	```
- [Conda](https://anaconda.org/conda-forge/shapely) (📥 3.9M · ⏱️ 04.06.2022):
	```
...
- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 170 · 🔀 690 · 📥 1.5K · 📦 14K · 📋 1.3K - 27% open · ⏱️ 26.06.2022):
...
- [PyPi](https://pypi.org/project/folium) (📥 930K / month):
	...
	pip install folium
	```
- [Conda](https://anaconda.org/conda-forge/folium) (📥 880K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 49 · 🔀 180 · 📦 15K · 📋 490 - 2% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/geopy) (📥 4.7M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 730K · ⏱️ 12.07.2021):
	```
...
- [PyPi](https://pypi.org/project/fiona) (📥 2.7M / month):
	...
	pip install fiona
	```
- [Conda](https://anaconda.org/conda-forge/fiona) (📥 3M · ⏱️ 30.05.2022):
	```
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 80 · 🔀 890 · 📥 3.9K · 📋 450 - 6% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 48 · 🔀 90 · 📦 9.6K · 📋 84 - 25% open · ⏱️ 07.05.2022):
...
- [PyPi](https://pypi.org/project/geojson) (📥 850K / month):
	...
	pip install geojson
	```
- [Conda](https://anaconda.org/conda-forge/geojson) (📥 520K · ⏱️ 11.08.2019):
	```
	conda install -c conda-forge geojson
	```
</details>
<details><summary><b><a href="https://github.com/earthlab/earthpy">EarthPy</a></b> (🥉26 ·  ⭐ 380) - A package built to support working with spatial data using open source.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- <b><a href="https://github.com/rasterio/rasterio">Rasterio</a></b> (🥇36 ·  ⭐ 1.7K) - Rasterio reads and writes geospatial raster datasets. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/sentinelsat/sentinelsat">Sentinelsat</a></b> (🥉28 ·  ⭐ 780) - Search and download Copernicus Sentinel satellite images. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
- <b><a href="https://github.com/marceloprates/prettymaps">prettymaps</a></b> (🥉17 ·  ⭐ 8.3K) - A small set of Python functions to draw pretty maps from.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/ranaroussi/yfinance">yfinance</a></b> (🥇35 ·  ⭐ 7.2K) - Download market data from Yahoo! Finances API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 95 · 🔀 1.6K · 📥 280 · 📦 23 · 📋 560 - 27% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/ta) (📥 72K / month):
	...
	pip install ta
	```
- [Conda](https://anaconda.org/conda-forge/ta) (📥 4.1K · ⏱️ 21.04.2022):
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 28 · 🔀 210 · 📦 200 · 📋 99 - 18% open · ⏱️ 22.06.2022):
...
- [PyPi](https://pypi.org/project/ffn) (📥 30K / month):
	...
	pip install ffn
	```
- [Conda](https://anaconda.org/conda-forge/ffn) (📥 1K · ⏱️ 22.04.2021):
	```
...
- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 25 · 🔀 320 · 📦 120 · 📋 290 - 21% open · ⏱️ 26.05.2022):

	```
	git clone https://github.com/pmorissette/bt
	```
- [PyPi](https://pypi.org/project/bt) (📥 4K / month):
	```
	pip install bt
	```
- [Conda](https://anaconda.org/conda-forge/bt) (📥 5.3K · ⏱️ 24.06.2022):
	```
...
- [GitHub](https://github.com/tensortrade-org/tensortrade) (👨‍💻 61 · 🔀 880 · 📦 36 · 📋 230 - 16% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensortrade) (📥 500 / month):
	```
	pip install tensortrade
	```
- [Conda](https://anaconda.org/conda-forge/tensortrade) (📥 1.2K · ⏱️ 10.05.2021):
	```
...
- [PyPi](https://pypi.org/project/alpha_vantage) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alpha_vantage) (📥 1.4K · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 39 · 🔀 410 · 📋 39 - 35% open · ⏱️ 15.06.2022):
...
- [GitHub](https://github.com/scrtlabs/catalyst) (👨‍💻 150 · 🔀 700 · 📦 25 · 📋 480 - 25% open · ⏱️ 22.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/enigma-catalyst) (📥 620 / month):
	```
...
- [GitHub](https://github.com/erdewit/ib_insync) (👨‍💻 30 · 🔀 480 · 📋 410 - 1% open · ⏱️ 24.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/ib_insync) (📥 6.8K / month):
	```
	pip install ib_insync
	```
- [Conda](https://anaconda.org/conda-forge/ib-insync) (📥 17K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/cuemacro/finmarketpy) (👨‍💻 14 · 🔀 430 · 📥 40 · 📦 5 · 📋 26 - 88% open · ⏱️ 05.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/finmarketpy) (📥 74 / month):
	```
...
- <b><a href="https://github.com/mementum/backtrader">backtrader</a></b> (🥈28 ·  ⭐ 8.9K · 💤) - Python Backtesting library for trading strategies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
- <b><a href="https://github.com/bashtage/arch">arch</a></b> (🥈28 ·  ⭐ 940) - ARCH models in Python. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/peerchemist/finta">FinTA</a></b> (🥉25 ·  ⭐ 1.6K · 💤) - Common financial technical indicators implemented in Pandas. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code>
...
- <b><a href="https://github.com/fmilthaler/FinQuant">FinQuant</a></b> (🥉17 ·  ⭐ 780 · 💀) - A program for financial portfolio management, analysis and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/alvarobartt/pyrtfolio">pyrtfolio</a></b> (🥉9 ·  ⭐ 110 · 💀) - Python package to generate stock portfolios. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
</details>
<br>
...
- [GitHub](https://github.com/alan-turing-institute/sktime) (👨‍💻 180 · 🔀 860 · 📥 76 · 📦 480 · 📋 1.2K - 32% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/alan-turing-institute/sktime
	```
- [PyPi](https://pypi.org/project/sktime) (📥 210K / month):
	```
	pip install sktime
	```
- [Conda](https://anaconda.org/conda-forge/sktime-all-extras) (📥 6.8K · ⏱️ 21.06.2022):
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 21 · 🔀 210 · 📦 2.2K · 📋 280 - 8% open · ⏱️ 15.06.2022):
...
- [PyPi](https://pypi.org/project/pmdarima) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pmdarima) (📥 46K · ⏱️ 14.06.2022):
	```
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 150 · 🔀 4.2K · 📥 670 · 📋 1.8K - 12% open · ⏱️ 25.06.2022):
...
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prophet) (📥 56K · ⏱️ 28.06.2022):
	```
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 31 · 🔀 230 · 📦 230 · 📋 320 - 10% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/stumpy) (📥 300K / month):
	...
	pip install stumpy
	```
- [Conda](https://anaconda.org/conda-forge/stumpy) (📥 42K · ⏱️ 31.03.2022):
	```
...
- [GitHub](https://github.com/ourownstory/neural_prophet) (👨‍💻 24 · 🔀 300 · 📦 94 · 📋 260 - 22% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 39 · 🔀 280 · 📦 520 · 📋 270 - 31% open · ⏱️ 17.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/tslearn) (📥 92K / month):
	```
	pip install tslearn
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 56 · 🔀 440 · 📦 71 · 📋 510 - 35% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/u8darts) (📥 4.9K / month):
	...
	pip install u8darts
	```
- [Conda](https://anaconda.org/conda-forge/u8darts-all) (📥 6.8K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 30 · 🔀 330 · 📋 480 - 47% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/jdb78/pytorch-forecasting
	```
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 80K / month):
	```
	pip install pytorch-forecasting
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-forecasting) (📥 21K · ⏱️ 23.05.2022):
	```
...
- [GitHub](https://github.com/awslabs/gluon-ts) (👨‍💻 88 · 🔀 560 · 📋 700 - 34% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/gluonts) (📥 120K / month):
	...
	pip install gluonts
	```
- [Conda](https://anaconda.org/anaconda/gluonts) (📥 74 · ⏱️ 14.10.2021):
	```
	conda install -c anaconda gluonts
	```
</details>
<details><summary><b><a href="https://github.com/blue-yonder/tsfresh">tsfresh</a></b> (🥈27 ·  ⭐ 6.5K) - Automatic extraction of relevant features from time series:. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/blue-yonder/tsfresh) (👨‍💻 82 · 🔀 980 · 📋 490 - 9% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/tsfresh) (📥 460K / month):
	```
	pip install tsfresh
	```
- [Conda](https://anaconda.org/conda-forge/tsfresh) (📥 180K · ⏱️ 21.12.2021):
	```
...
- [GitHub](https://github.com/johannfaouzi/pyts) (👨‍💻 11 · 🔀 130 · 📦 220 · 📋 62 - 58% open · ⏱️ 16.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyts) (📥 170K / month):
	```
	pip install pyts
	```
...
<details><summary><b><a href="https://github.com/Nixtla/statsforecast">StatsForecast</a></b> (🥉22 ·  ⭐ 720) - Lightning fast forecasting with statistical and econometric models. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 9 · 🔀 45 · 📋 49 - 40% open · ⏱️ 27.06.2022):

	```
	git clone https://github.com/Nixtla/statsforecast
	```
- [PyPi](https://pypi.org/project/statsforecast) (📥 39K / month):
	```
	pip install statsforecast
	```
- [Conda](https://anaconda.org/conda-forge/statsforecast) (📥 6.2K · ⏱️ 28.06.2022):
	```
	conda install -c conda-forge statsforecast
	```
</details>
<details><summary><b><a href="https://github.com/Nixtla/neuralforecast">NeuralForecast</a></b> (🥉21 ·  ⭐ 790) - Scalable and user friendly neural forecasting algorithms for time.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Nixtla/neuralforecast) (👨‍💻 22 · 🔀 74 · 📋 85 - 43% open · ⏱️ 23.06.2022):

	```
	git clone https://github.com/Nixtla/neuralforecast
	```
- [PyPi](https://pypi.org/project/neuralforecast) (📥 760 / month):
	```
	pip install neuralforecast
	```
- [Conda](https://anaconda.org/conda-forge/neuralforecast) (📥 760 · ⏱️ 03.06.2022):
	```
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 7 · 🔀 70 · 📦 10 · 📋 65 - 16% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/fraunhoferportugal/tsfel) (👨‍💻 14 · 🔀 73 · 📦 36 · 📋 53 - 18% open · ⏱️ 16.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/tsfel) (📥 5.5K / month):
	```
	pip install tsfel
	```
</details>
...
- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 6 · 🔀 83 · 📋 72 - 11% open · ⏱️ 13.02.2022):

	```
	git clone https://github.com/AutoViML/Auto_TS
	```
- [PyPi](https://pypi.org/project/auto-ts) (📥 2.1K / month):
	```
	pip install auto-ts
	```
</details>
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 300 · 🔀 1K · 📦 1.7K · 📋 4.1K - 9% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 240 · 🔀 460 · 📦 970 · 📋 1.3K - 28% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/nipy/nipype
	```
- [PyPi](https://pypi.org/project/nipype) (📥 49K / month):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 110 · 🔀 610 · 📦 370 · 📋 1.7K - 11% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/monai) (📥 43K / month):
	...
	pip install monai
	```
- [Conda](https://anaconda.org/conda-forge/monai) (📥 1.6K · ⏱️ 14.06.2022):
	```
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 100 · 🔀 470 · 📦 950 · 📋 860 - 25% open · ⏱️ 26.06.2022):
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 79 · 🔀 210 · 📦 70 · 📋 2K - 0% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 10 · 🔀 66 · 📋 63 - 28% open · ⏱️ 07.06.2022):
...
- <b><a href="https://github.com/upgini/upgini">upgini</a></b> (🥉14 ·  ⭐ 46 · 🐣) - Free automated data enrichment library for machine learning searches.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 110 · 🔀 4.6K · 📦 700 · 📋 4.7K - 23% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/PaddlePaddle/PaddleOCR
	```
- [PyPi](https://pypi.org/project/paddleocr) (📥 52K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 100 · 🔀 2.1K · 📥 1.8M · 📦 1.3K · 📋 590 - 21% open · ⏱️ 23.06.2022):

	```
	git clone https://github.com/JaidedAI/EasyOCR
	```
- [PyPi](https://pypi.org/project/easyocr) (📥 96K / month):
	```
	pip install easyocr
	```
</details>
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 40 · 🔀 590 · 📋 300 - 4% open · ⏱️ 13.06.2022):
...
- [GitHub](https://github.com/open-mmlab/mmocr) (👨‍💻 54 · 🔀 460 · 📦 14 · 📋 600 - 12% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/open-mmlab/mmocr
	```
- [PyPi](https://pypi.org/project/mmocr) (📥 3.9K / month):
	```
	pip install mmocr
	```
</details>
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 220 · 📦 670 · 📋 240 - 31% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/tesserocr) (📥 57K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 75K · ⏱️ 04.05.2022):
	```
...
- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 72 · 🔀 570 · 📋 870 - 10% open · ⏱️ 24.06.2022):
...
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 25K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ocrmypdf) (📥 14K · ⏱️ 20.06.2022):
	```
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 15 · 🔀 260 · 📥 270K · 📋 170 - 39% open · ⏱️ 19.05.2022):
...
- [PyPi](https://pypi.org/project/keras-ocr) (📥 6.4K / month):
	...
	```
- [Conda](https://anaconda.org/anaconda/keras-ocr) (📥 75 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/Calamari-OCR/calamari) (👨‍💻 19 · 🔀 190 · 📋 250 - 20% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/calamari_ocr) (📥 690 / month):
	```
...
- <b><a href="https://github.com/aashrafh/Mozart">Mozart</a></b> (🥉10 ·  ⭐ 380 · 💀) - An optical music recognition (OMR) system. Converts sheet.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/apache/airflow) (👨‍💻 2.4K · 🔀 10K · 📥 310K · 📋 5.7K - 12% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/apache/airflow
	```
- [PyPi](https://pypi.org/project/apache-airflow) (📥 6.9M / month):
	```
	pip install apache-airflow
	```
- [Conda](https://anaconda.org/conda-forge/airflow) (📥 650K · ⏱️ 16.06.2022):
	```
	conda install -c conda-forge airflow
	```
- [Docker Hub](https://hub.docker.com/r/apache/airflow) (📥 76M · ⭐ 360 · ⏱️ 17.06.2022):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 330 · 🔀 910 · 📦 930 · 📋 2.3K - 24% open · ⏱️ 21.06.2022):
...
- [PyPi](https://pypi.org/project/prefect) (📥 290K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 280K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/apache/beam) (👨‍💻 1.3K · 🔀 3.4K · 📋 4K - 93% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/apache/beam
	```
- [PyPi](https://pypi.org/project/apache-beam) (📥 5.8M / month):
	```
	pip install apache-beam
	```
- [Conda](https://anaconda.org/conda-forge/apache-beam-with-aws) (📥 16K · ⏱️ 27.05.2022):
	```
	conda install -c conda-forge apache-beam-with-aws
	```
</details>
<details><summary><b><a href="https://github.com/dagster-io/dagster">Dagster</a></b> (🥇38 ·  ⭐ 4.9K) - An orchestration platform for the development, production, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 220 · 🔀 610 · 📦 420 · 📋 4.2K - 22% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/dagster) (📥 430K / month):
	...
	pip install dagster
	```
- [Conda](https://anaconda.org/conda-forge/dagster) (📥 560K · ⏱️ 25.06.2022):
	```
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 110 · 🔀 320 · 📦 190K · 📋 700 - 43% open · ⏱️ 20.05.2022):
...
- [PyPi](https://pypi.org/project/joblib) (📥 25M / month):
	...
	pip install joblib
	```
- [Conda](https://anaconda.org/conda-forge/joblib) (📥 9.7M · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/kedro-org/kedro) (👨‍💻 150 · 🔀 660 · 📦 920 · 📋 800 - 14% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 300 · 🔀 980 · 📋 1.3K - 12% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 6M / month):
	```
	pip install great_expectations
	```
- [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 410K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/dbt-labs/dbt-core) (👨‍💻 220 · 🔀 920 · 📥 400 · 📦 540 · 📋 2.9K - 10% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/dbt-labs/dbt-core
	```
- [PyPi](https://pypi.org/project/dbt) (📥 220K / month):
	```
	pip install dbt
	```
...
- [GitHub](https://github.com/petl-developers/petl) (👨‍💻 55 · 🔀 180 · 📦 750 · 📋 440 - 17% open · ⏱️ 08.06.2022):

	```
	git clone https://github.com/petl-developers/petl
	```
- [PyPi](https://pypi.org/project/petl) (📥 210K / month):
	```
	pip install petl
	```
- [Conda](https://anaconda.org/conda-forge/petl) (📥 98K · ⏱️ 08.06.2022):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 340 · 📦 950 · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/ploomber/ploomber">ploomber</a></b> (🥈29 ·  ⭐ 2.5K) - The fastest way to build data pipelines. Develop iteratively,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 53 · 🔀 160 · 📦 43 · 📋 730 - 28% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/ploomber/ploomber
	```
- [PyPi](https://pypi.org/project/ploomber) (📥 6.8K / month):
	```
	pip install ploomber
	```
- [Conda](https://anaconda.org/conda-forge/ploomber) (📥 13K · ⏱️ 02.06.2022):
	```
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 140 · 🔀 570 · 📋 760 - 29% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/activeloopai/Hub) (👨‍💻 98 · 🔀 380 · 📋 370 - 11% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 40 · 🔀 170 · 📋 92 - 19% open · ⏱️ 30.06.2022):
...
<details><summary><b><a href="https://github.com/Parsely/streamparse">streamparse</a></b> (🥉27 ·  ⭐ 1.5K) - Run Python in Apache Storm topologies. Pythonic API, CLI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/combust/mleap) (👨‍💻 75 · 🔀 290 · 📦 190 · 📋 440 - 19% open · ⏱️ 03.05.2022):

	```
	git clone https://github.com/combust/mleap
	```
- [PyPi](https://pypi.org/project/mleap) (📥 260K / month):
	```
	pip install mleap
	```
- [Conda](https://anaconda.org/conda-forge/mleap) (📥 48K · ⏱️ 05.04.2022):
	```
...
<details><summary><b><a href="https://github.com/whylabs/whylogs">whylogs</a></b> (🥉25 ·  ⭐ 1.6K) - Open standard for end-to-end data and ML monitoring for any scale in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/whylabs/whylogs) (👨‍💻 9 · 🔀 67 · 📥 50 · 📋 160 - 9% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/samuelcolvin/arq) (👨‍💻 39 · 🔀 100 · 📦 240 · 📋 140 - 28% open · ⏱️ 28.03.2022):
...
- [GitHub](https://github.com/pdpipe/pdpipe) (👨‍💻 10 · 🔀 40 · 📦 41 · 📋 47 - 29% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/pdpipe) (📥 2K / month):
	...
	pip install pdpipe
	```
- [Conda](https://anaconda.org/conda-forge/pdpipe) (📥 6.2K · ⏱️ 24.06.2022):
	```
...
<details><summary><b><a href="https://github.com/cgarciae/pypeln">Pypeline</a></b> (🥉20 ·  ⭐ 1.3K) - Concurrent data pipelines in Python . <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/cgarciae/pypeln) (👨‍💻 13 · 🔀 80 · 📋 59 - 25% open · ⏱️ 23.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pypeln) (📥 7.4K / month):
	```
	pip install pypeln
	```
- [Conda](https://anaconda.org/conda-forge/pypeln) (📥 7.5K · ⏱️ 06.01.2022):
	```
...
- [GitHub](https://github.com/mara/mara-pipelines) (👨‍💻 17 · 🔀 90 · 📋 30 - 53% open · ⏱️ 19.06.2022):

	```
	git clone https://github.com/mara/mara-pipelines
	```
- [PyPi](https://pypi.org/project/mara-pipelines) (📥 330 / month):
	```
...
- [GitHub](https://github.com/nerevu/riko) (👨‍💻 18 · 🔀 68 · 📋 29 - 72% open · ⏱️ 28.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/riko) (📥 210 / month):
	```
	pip install riko
	```
</details>
...
- <b><a href="https://github.com/bodywork-ml/bodywork-core">bodywork-core</a></b> (🥉17 ·  ⭐ 350) - ML pipeline orchestration and model deployments on.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 720 · 🔀 3.6K · 📦 5.2K · 📋 10K - 22% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/ray) (📥 1.3M / month):
	...
	pip install ray
	```
- [Conda](https://anaconda.org/conda-forge/ray-tune) (📥 37K · ⏱️ 23.05.2022):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 540 · 🔀 1.5K · 📦 38K · 📋 4.3K - 15% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 8.7M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 5.9M · ⏱️ 24.06.2022):
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 280 · 🔀 610 · 📦 24K · 📋 2.8K - 32% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/distributed) (📥 4.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/distributed) (📥 7.2M · ⏱️ 24.06.2022):
	```
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 150 · 🔀 950 · 📦 36 · 📋 1.3K - 30% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/intel-analytics/BigDL
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 6.4K / month):
	```
	pip install bigdl
	```
...
- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 110 · 🔀 760 · 📦 290 · 📋 900 - 49% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 63 · 🔀 180 · 📦 360 · 📋 310 - 19% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/fairscale) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fairscale) (📥 29K · ⏱️ 20.06.2022):
	```
	conda install -c conda-forge fairscale
	```
</details>
<details><summary><b><a href="https://github.com/Lightning-AI/metrics">metrics</a></b> (🥈31 ·  ⭐ 940) - Machine learning metrics for distributed, scalable PyTorch.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Lightning-AI/metrics) (👨‍💻 140 · 🔀 190 · 📥 760 · 📦 3.5K · 📋 380 - 14% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/metrics) (📥 2.6K / month):
	...
	pip install metrics
	```
- [Conda](https://anaconda.org/conda-forge/torchmetrics) (📥 380K · ⏱️ 30.06.2022):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 230 · 🔀 1.9K · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/dask-ml) (📥 130K / month):
	...
	pip install dask-ml
	```
- [Conda](https://anaconda.org/conda-forge/dask-ml) (📥 340K · ⏱️ 27.05.2022):
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 93 · 🔀 650 · 📋 550 - 39% open · ⏱️ 25.06.2022):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 50K / month):
	```
...
- [GitHub](https://github.com/uber/petastorm) (👨‍💻 45 · 🔀 240 · 📥 310 · 📦 72 · 📋 270 - 48% open · ⏱️ 24.06.2022):
...
- [GitHub](https://github.com/yahoo/TensorFlowOnSpark) (👨‍💻 34 · 🔀 920 · 📋 360 - 2% open · ⏱️ 21.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflowonspark) (📥 410K / month):
	```
...
- [PyPi](https://pypi.org/project/elephas) (📥 110K / month):
	...
	pip install elephas
	```
- [Conda](https://anaconda.org/conda-forge/elephas) (📥 8.6K · ⏱️ 02.06.2021):
	```
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 100 · 🔀 700 · 📦 3 · 📋 1.3K - 32% open · ⏱️ 01.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/analytics-zoo) (📥 6.2K / month):
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 93 · 🔀 650 · 📋 550 - 39% open · ⏱️ 25.06.2022):
	...
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/mmlspark) (📥 6 / month):
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 21 · 🔀 66 · 📦 8 · 📋 120 - 29% open · ⏱️ 24.06.2022):
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 20 · 🔀 77 · 📥 5.3K · 📋 79 - 12% open · ⏱️ 23.06.2022):
...
- [GitHub](https://github.com/apache/singa) (👨‍💻 79 · 🔀 790 · 📦 1 · 📋 75 - 24% open · ⏱️ 01.06.2022):
...
<details><summary><b><a href="https://github.com/facebookincubator/submitit">Submit it</a></b> (🥉19 ·  ⭐ 640) - Python 3.6+ toolbox for submitting jobs to Slurm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 20 · 🔀 71 · 📋 67 - 31% open · ⏱️ 31.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/submitit) (📥 23K / month):
	```
	pip install submitit
	```
- [Conda](https://anaconda.org/conda-forge/submitit) (📥 6.9K · ⏱️ 10.02.2021):
	```
...
<details><summary><b><a href="https://github.com/kingoflolz/mesh-transformer-jax">mesh-transformer-jax</a></b> (🥉17 ·  ⭐ 4.3K) - Model parallel transformers in JAX and Haiku. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tunib-ai/parallelformers) (👨‍💻 4 · 🔀 28 · 📦 7 · 📋 19 - 42% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/parallelformers) (📥 200 / month):
	```
...
- <b><a href="https://github.com/horovod/horovod">horovod</a></b> (🥇34 ·  ⭐ 13K) - Distributed training framework for TensorFlow, Keras, PyTorch,.. <code>❗Unlicensed</code>
...
<details><summary><b><a href="https://github.com/optuna/optuna">Optuna</a></b> (🥇41 ·  ⭐ 6.6K · 📈) - A hyperparameter optimization framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/optuna/optuna) (👨‍💻 200 · 🔀 710 · 📦 3.6K · 📋 1.2K - 8% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/optuna) (📥 3.4M / month):
	...
	pip install optuna
	```
- [Conda](https://anaconda.org/conda-forge/optuna) (📥 290K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 170 · 🔀 1.6K · 📦 240 · 📋 1.6K - 17% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/microsoft/nni
	```
- [PyPi](https://pypi.org/project/nni) (📥 8.7K / month):
	```
	pip install nni
	```
</details>
...
- [GitHub](https://github.com/keras-team/autokeras) (👨‍💻 140 · 🔀 1.3K · 📥 5.6K · 📦 340 · 📋 830 - 10% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/auto-sklearn) (📥 37K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/auto-sklearn) (📥 5.8K · ⏱️ 18.02.2022):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 48 · 🔀 330 · 📦 1.5K · 📋 390 - 44% open · ⏱️ 20.06.2022):
...
- [PyPi](https://pypi.org/project/keras-tuner) (📥 580K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keras-tuner) (📥 7.3K · ⏱️ 12.01.2022):
	```
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 75 · 🔀 250 · 📦 280 · 📋 280 - 14% open · ⏱️ 17.06.2022):
...
- [PyPi](https://pypi.org/project/botorch) (📥 190K / month):
	...
	pip install botorch
	```
- [Conda](https://anaconda.org/conda-forge/botorch) (📥 29K · ⏱️ 22.04.2022):
	```
	conda install -c conda-forge botorch
	```
</details>
<details><summary><b><a href="https://github.com/fmfn/BayesianOptimization">Bayesian Optimization</a></b> (🥈32 ·  ⭐ 6.1K) - A Python implementation of global optimization with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 120 · 🔀 200 · 📦 290 · 📋 410 - 6% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/ax-platform) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ax-platform) (📥 1.8K · ⏱️ 27.04.2022):
	```
...
- [GitHub](https://github.com/awslabs/autogluon) (👨‍💻 77 · 🔀 590 · 📦 140 · 📋 700 - 22% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/scikit-optimize/scikit-optimize) (👨‍💻 76 · 🔀 420 · 📦 2.8K · 📋 600 - 35% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/scikit-optimize/scikit-optimize
	```
- [PyPi](https://pypi.org/project/scikit-optimize) (📥 980K / month):
	```
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 66 · 🔀 800 · 📋 810 - 19% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/featuretools) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/featuretools) (📥 91K · ⏱️ 29.06.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 49 · 🔀 310 · 📦 350 · 📋 220 - 29% open · ⏱️ 24.06.2022):
...
- [PyPi](https://pypi.org/project/nevergrad) (📥 49K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nevergrad) (📥 28K · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/maxpumperla/hyperas) (👨‍💻 21 · 🔀 300 · 📦 240 · 📋 250 - 37% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/hyperas) (📥 15K / month):
	```
	pip install hyperas
	```
</details>
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 17 · 🔀 270 · 📦 46 · 📋 490 - 19% open · ⏱️ 14.04.2022):

	```
	git clone https://github.com/mljar/mljar-supervised
	```
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 13K / month):
	```
	pip install mljar-supervised
	```
- [Conda](https://anaconda.org/conda-forge/mljar-supervised) (📥 2.3K · ⏱️ 02.03.2022):
	```
...
- [GitHub](https://github.com/tensorflow/adanet) (👨‍💻 27 · 🔀 520 · 📦 44 · 📋 110 - 57% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/adanet) (📥 500 / month):
	```
	pip install adanet
	```
</details>
<details><summary><b><a href="https://github.com/Neuraxio/Neuraxle">Neuraxle</a></b> (🥉23 ·  ⭐ 520) - The worlds cleanest AutoML framework - Do hyperparameter tuning with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 7 · 🔀 53 · 📦 32 · 📋 310 - 20% open · ⏱️ 11.05.2022):

	```
	git clone https://github.com/Neuraxio/Neuraxle
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 540 / month):
	```
...
- [GitHub](https://github.com/automl/HpBandSter) (👨‍💻 11 · 🔀 110 · 📦 230 · 📋 89 - 60% open · ⏱️ 22.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/hpbandster) (📥 31K / month):
	```
	pip install hpbandster
	```
- [Conda](https://anaconda.org/conda-forge/hpbandster) (📥 2K · ⏱️ 11.12.2020):
	```
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 4 · 🔀 32 · 📥 100 · 📦 15 · 📋 45 - 11% open · ⏱️ 21.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 560 / month):
	```
...
- [GitHub](https://github.com/ScottfreeLLC/AlphaPy) (👨‍💻 3 · 🔀 160 · 📦 3 · 📋 41 - 29% open · ⏱️ 23.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/alphapy) (📥 47 / month):
	```
	pip install alphapy
	```
</details>
...
- [GitHub](https://github.com/rsteca/sklearn-deap) (👨‍💻 22 · 🔀 110 · 📦 33 · 📋 50 - 32% open · ⏱️ 30.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-deap) (📥 710 / month):
	```
...
- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 17 · 🔀 65 · 📦 310 · 📋 64 - 46% open · ⏱️ 25.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/lazypredict) (📥 5.4K / month):
	```
	pip install lazypredict
	```
- [Conda](https://anaconda.org/conda-forge/lazypredict) (📥 520 · ⏱️ 24.08.2021):
	```
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 6 · 🔀 77 · 📦 16 · 📋 20 - 20% open · ⏱️ 15.06.2022):
...
- <b><a href="https://github.com/AutoViML/featurewiz">featurewiz</a></b> (🥉21 ·  ⭐ 250) - Use advanced feature engineering strategies and select best.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/HunterMcGushion/hyperparameter_hunter">HyperparameterHunter</a></b> (🥉17 ·  ⭐ 690 · 💀) - Easy hyperparameter optimization and automatic result.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 360 · 🔀 7.4K · 📦 31K · 📋 1.6K - 1% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 70 · 🔀 1.3K · 📦 12 · 📋 410 - 14% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/AI4Finance-Foundation/FinRL
	```
- [PyPi](https://pypi.org/project/finrl) (📥 210 / month):
	```
	pip install finrl
	```
</details>
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 120 · 🔀 600 · 📦 840 · 📋 560 - 22% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 72 · 🔀 330 · 📦 84 · 📋 200 - 13% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/dm-acme) (📥 6.4K / month):
	...
	pip install dm-acme
	```
- [Conda](https://anaconda.org/conda-forge/dm-acme) (📥 2.8K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 31 · 🔀 710 · 📦 92 · 📋 390 - 17% open · ⏱️ 14.06.2022):
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 15 · 🔀 1.3K · 📋 150 - 43% open · ⏱️ 13.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 57K / month):
	```
...
- [GitHub](https://github.com/rlworkgroup/garage) (👨‍💻 78 · 🔀 260 · 📦 45 · 📋 1K - 19% open · ⏱️ 20.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/garage) (📥 350 / month):
	```
	pip install garage
	```
</details>
...
- [GitHub](https://github.com/deepmind/trfl) (👨‍💻 13 · 🔀 380 · 📦 82 · 📋 20 - 20% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/trfl) (📥 5.6K / month):
	```
	pip install trfl
	```
</details>
...
- [GitHub](https://github.com/IntelLabs/coach) (👨‍💻 35 · 🔀 420 · 📋 260 - 30% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/rl_coach) (📥 140 / month):
	```
...
<details><summary><b><a href="https://github.com/pfnet/pfrl">PFRL</a></b> (🥉18 ·  ⭐ 860) - PFRL: a PyTorch-based deep reinforcement learning library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 16 · 🔀 120 · 📋 63 - 38% open · ⏱️ 14.03.2022):
...
<details><summary><b><a href="https://github.com/google-research/rliable">rliable</a></b> (🥉14 ·  ⭐ 430) - [NeurIPS21 Outstanding Paper] Library for reliable evaluation on RL.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google-research/rliable) (👨‍💻 3 · 🔀 24 · 📦 11 · ⏱️ 22.06.2022):
...
- <b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉22 ·  ⭐ 850) -  <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 120 · 🔀 2.3K · 📥 180 · 📦 30 · 📋 700 - 19% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 31 · 🔀 520 · 📦 620 · 📋 410 - 18% open · ⏱️ 22.06.2022):
...
- [GitHub](https://github.com/tensorflow/recommenders) (👨‍💻 34 · 🔀 200 · 📦 120 · 📋 270 - 50% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/tensorflow/recommenders
	```
- [PyPi](https://pypi.org/project/tensorflow-recommenders) (📥 1.3M / month):
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 620 · 📦 760 · 📋 450 - 23% open · ⏱️ 09.03.2022):
...
- [GitHub](https://github.com/tensorflow/ranking) (👨‍💻 28 · 🔀 430 · 📋 290 - 18% open · ⏱️ 26.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow_ranking) (📥 73K / month):
	```
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 45 · 🔀 360 · 📋 420 - 9% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 14 · 🔀 100 · 📦 110 · 📋 98 - 10% open · ⏱️ 17.06.2022):
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 52 · 🔀 210 · 📥 47 · 📦 120 · 📋 180 - 17% open · ⏱️ 25.06.2022):

	```
	git clone https://github.com/pytorch/opacus
	```
- [PyPi](https://pypi.org/project/opacus) (📥 4.8K / month):
	```
	pip install opacus
	```
- [Conda](https://anaconda.org/conda-forge/opacus) (📥 1.5K · ⏱️ 06.05.2022):
	```
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 47 · 🔀 350 · 📥 72 · 📋 150 - 42% open · ⏱️ 24.06.2022):
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 29 · 🔀 170 · 📦 21 · 📋 150 - 14% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/crypten) (📥 190 / month):
	```
	pip install crypten
	```
</details>
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 280 · 🔀 1.5K · 📦 110K · 📋 1.6K - 31% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 440 · 🔀 2.7K · 📋 2.3K - 35% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/mlflow) (📥 11M / month):
	...
	pip install mlflow
	```
- [Conda](https://anaconda.org/conda-forge/mlflow) (📥 610K · ⏱️ 30.06.2022):
	```
...
- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 87 · 🔀 1.3K · 📥 590 · 📦 2.2K · 📋 1.6K - 15% open · ⏱️ 14.06.2022):
...
- [PyPi](https://pypi.org/project/pycaret) (📥 430K / month):
	...
	pip install pycaret
	```
- [Conda](https://anaconda.org/conda-forge/pycaret) (📥 12K · ⏱️ 18.04.2022):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 260 · 🔀 780 · 📦 1.5K · 📋 1K - 31% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/sagemaker) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sagemaker-python-sdk) (📥 310K · ⏱️ 29.06.2022):
	```
	conda install -c conda-forge sagemaker-python-sdk
	```
</details>
<details><summary><b><a href="https://github.com/iterative/dvc">DVC</a></b> (🥈34 ·  ⭐ 9.9K) - Data Version Control | Git for Data & Models | ML Experiments Management. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/iterative/dvc) (👨‍💻 270 · 🔀 930 · 📥 95K · 📋 3.7K - 16% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/tensorboardX) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorboardx) (📥 720K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 260 · 🔀 340 · 📦 1.2K · 📋 1K - 59% open · ⏱️ 30.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 46K / month):
	```
	pip install snakemake
	```
- [Conda](https://anaconda.org/bioconda/snakemake) (📥 470K · ⏱️ 23.06.2022):
	```
	conda install -c bioconda snakemake
	```
</details>
<details><summary><b><a href="https://github.com/allegroai/clearml">ClearML</a></b> (🥈32 ·  ⭐ 3.4K) - ClearML - Auto-Magical CI/CD to streamline your ML workflow... <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 49 · 🔀 440 · 📥 430 · 📦 260 · 📋 560 - 42% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 52 · 🔀 490 · 📦 290 · 📋 410 - 43% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 51K / month):
	```
	pip install metaflow
	```
- [Conda](https://anaconda.org/conda-forge/metaflow) (📥 48K · ⏱️ 23.06.2022):
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 32 · 🔀 580 · 📥 180 · 📦 1.2K · 📋 420 - 19% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/PaddlePaddle/VisualDL
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 73K / month):
	```
...
- [GitHub](https://github.com/wandb/client) (👨‍💻 120 · 🔀 320 · 📋 1.8K - 21% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 2.2M / month):
	```
	pip install wandb
	```
- [Conda](https://anaconda.org/conda-forge/wandb) (📥 68K · ⏱️ 29.06.2022):
	```
	conda install -c conda-forge wandb
	```
</details>
<details><summary><b><a href="https://github.com/catalyst-team/catalyst">Catalyst</a></b> (🥈31 ·  ⭐ 3K) - Accelerated deep learning R&D. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 100 · 🔀 340 · 📦 570 · 📋 340 - 1% open · ⏱️ 29.04.2022):

	```
	git clone https://github.com/catalyst-team/catalyst
	```
- [PyPi](https://pypi.org/project/catalyst) (📥 1.1M / month):
	```
...
- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 39 · 🔀 150 · 📦 90 · 📋 560 - 20% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/aim) (📥 49K / month):
	...
	pip install aim
	```
- [Conda](https://anaconda.org/conda-forge/aim) (📥 14K · ⏱️ 15.10.2021):
	```
...
- [PyPi](https://pypi.org/project/sacred) (📥 25K / month):
	...
	pip install sacred
	```
- [Conda](https://anaconda.org/conda-forge/sacred) (📥 660 · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 60 · 🔀 2.1K · 📥 460 · 📋 1.3K - 19% open · ⏱️ 27.06.2022):

	```
	git clone https://github.com/Azure/MachineLearningNotebooks
	```
- [PyPi](https://pypi.org/project/azureml-sdk) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 20 · 🔀 63 · 📥 4 · 📦 53 · 📋 370 - 44% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/guildai/guildai
	```
- [PyPi](https://pypi.org/project/guildai) (📥 4.3K / month):
	```
	pip install guildai
	```
</details>
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 7 · 🔀 75 · 📦 50 · 📋 28 - 57% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/stared/livelossplot) (👨‍💻 17 · 🔀 140 · 📦 810 · 📋 75 - 6% open · ⏱️ 04.04.2022):
...
- [GitHub](https://github.com/replicate/keepsake) (👨‍💻 17 · 🔀 63 · 📋 180 - 63% open · ⏱️ 24.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/keepsake) (📥 370 / month):
	```
...
- <b><a href="https://github.com/neptune-ai/neptune-client">Neptune.ai</a></b> (🥈29 ·  ⭐ 300) - Experiment tracking tool and model registry. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/MrPowers/quinn">quinn</a></b> (🥉17 ·  ⭐ 340 · 💀) - pyspark methods to enhance developer productivity. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 240 · 🔀 2.8K · 📥 18K · 📦 7.3K · 📋 2K - 10% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/onnx) (📥 1.3M / month):
	...
	pip install onnx
	```
- [Conda](https://anaconda.org/conda-forge/onnx) (📥 440K · ⏱️ 18.06.2022):
	```
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 120 · 🔀 400 · 📥 4.3K · 📦 940 · 📋 950 - 28% open · ⏱️ 23.06.2022):
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 120 · 🔀 540 · 📥 1.8K · 📋 920 - 13% open · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈28 ·  ⭐ 460) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 67 · 🔀 110 · 📋 240 - 26% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/huggingface/huggingface_hub
	```
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 5.3M / month):
	```
	pip install huggingface_hub
	```
- [Conda](https://anaconda.org/conda-forge/huggingface_hub) (📥 200K · ⏱️ 25.06.2022):
	```
...
- [GitHub](https://github.com/openai/triton) (👨‍💻 37 · 🔀 280 · 📦 110 · 📋 210 - 33% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 83K / month):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 110 · 🔀 410 · 📥 1.5K · 📋 620 - 9% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 30 · 🔀 230 · 📥 170 · 📦 34 · 📋 240 - 17% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/microsoft/hummingbird
	```
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 3.5K / month):
	```
	pip install hummingbird-ml
	```
- [Conda](https://anaconda.org/conda-forge/hummingbird-ml) (📥 9.2K · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 13 · 🔀 190 · 📥 21 · 📦 37 · 📋 89 - 25% open · ⏱️ 26.06.2022):

	```
	git clone https://github.com/BayesWitnesses/m2cgen
	```
- [PyPi](https://pypi.org/project/m2cgen) (📥 49K / month):
	```
	pip install m2cgen
	```
</details>
...
- [GitHub](https://github.com/cortexlabs/cortex) (👨‍💻 24 · 🔀 580 · 📋 1.1K - 9% open · ⏱️ 23.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/cortex) (📥 1.4K / month):
	```
	pip install cortex
	```
</details>
...
- [GitHub](https://github.com/gmalivenko/pytorch2keras) (👨‍💻 13 · 🔀 140 · 📦 49 · 📋 120 - 44% open · ⏱️ 06.08.2021):

	```
	git clone https://github.com/gmalivenko/pytorch2keras
	```
- [PyPi](https://pypi.org/project/pytorch2keras) (📥 680 / month):
	```
...
- [GitHub](https://github.com/nebuly-ai/nebullvm) (👨‍💻 9 · 🔀 56 · 📦 1 · 📋 39 - 56% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/slundberg/shap) (👨‍💻 200 · 🔀 2.5K · 📦 5.8K · 📋 2K - 69% open · ⏱️ 16.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/shap) (📥 4.2M / month):
	```
	pip install shap
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 120 · 🔀 280 · 📥 110 · 📦 2.5K · 📋 730 - 20% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/arviz-devs/arviz
	```
- [PyPi](https://pypi.org/project/arviz) (📥 820K / month):
	```
	pip install arviz
	```
- [Conda](https://anaconda.org/conda-forge/arviz) (📥 760K · ⏱️ 17.05.2022):
	```
...
- [GitHub](https://github.com/lutzroeder/netron) (🔀 2.2K · 📥 68K · 📦 8 · 📋 810 - 2% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 29 · 🔀 580 · 📦 230 · 📋 300 - 31% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/marcotcr/lime) (👨‍💻 61 · 🔀 1.6K · 📦 2.4K · 📋 570 - 7% open · ⏱️ 29.07.2021):

	```
	git clone https://github.com/marcotcr/lime
	```
- [PyPi](https://pypi.org/project/lime) (📥 430K / month):
	```
	pip install lime
	```
...
<details><summary><b><a href="https://github.com/py-why/dowhy">DoWhy</a></b> (🥇31 ·  ⭐ 4.8K · 📈) - DoWhy is a Python library for causal inference that supports explicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/py-why/dowhy) (👨‍💻 53 · 🔀 670 · 📥 31 · 📦 110 · 📋 210 - 26% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/dowhy) (📥 130K / month):
	...
	pip install dowhy
	```
- [Conda](https://anaconda.org/conda-forge/dowhy) (📥 6.4K · ⏱️ 21.03.2022):
	```
...
- [GitHub](https://github.com/pytorch/captum) (👨‍💻 85 · 🔀 340 · 📦 590 · 📋 370 - 22% open · ⏱️ 24.06.2022):
...
- [PyPi](https://pypi.org/project/captum) (📥 51K / month):
	...
	pip install captum
	```
- [Conda](https://anaconda.org/conda-forge/captum) (📥 1.5K · ⏱️ 04.03.2022):
	```
	conda install -c conda-forge captum
	```
</details>
<details><summary><b><a href="https://github.com/MAIF/shapash">shapash</a></b> (🥈30 ·  ⭐ 1.9K) - Shapash makes Machine Learning models transparent and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 34 · 🔀 240 · 📦 75 · 📋 120 - 14% open · ⏱️ 09.05.2022):
...
- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 18 · 🔀 190 · 📦 180 · 📋 300 - 40% open · ⏱️ 17.06.2022):
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 15 · 🔀 160 · 📦 110 · 📋 180 - 6% open · ⏱️ 16.06.2022):
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 43 · 🔀 230 · 📋 64 - 23% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/yellowbrick) (📥 580K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/yellowbrick) (📥 30K · ⏱️ 24.03.2022):
	```
...
- [PyPi](https://pypi.org/project/dtreeviz) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dtreeviz) (📥 13K · ⏱️ 29.04.2022):
	```
...
- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 25 · 🔀 120 · 📦 32 · 📋 240 - 13% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 51 · 🔀 560 · 📦 160 · 📋 140 - 54% open · ⏱️ 24.06.2022):
...
- [PyPi](https://pypi.org/project/aif360) (📥 6.4K / month):
	...
	pip install aif360
	```
- [Conda](https://anaconda.org/conda-forge/aif360) (📥 2.4K · ⏱️ 29.09.2021):
	```
...
- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 31 · 🔀 230 · 📦 47 · 📋 61 - 55% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 12 · 🔀 160 · 📦 140 · 📋 83 - 2% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/checklist) (📥 16K / month):
	```
	pip install checklist
	```
- [Conda](https://anaconda.org/conda-forge/checklist) (📥 3.2K · ⏱️ 15.07.2021):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 22 · 🔀 180 · 📦 40 · 📋 110 - 16% open · ⏱️ 11.11.2021):
...
<details><summary><b><a href="https://github.com/csinva/imodels">imodels</a></b> (🥉24 ·  ⭐ 830) - Interpretable ML package for concise, transparent, and accurate predictive.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/csinva/imodels) (👨‍💻 11 · 🔀 77 · 📦 18 · 📋 34 - 29% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/csinva/imodels
	```
- [PyPi](https://pypi.org/project/imodels) (📥 2.9K / month):
	```
	pip install imodels
	```
</details>
...
- [GitHub](https://github.com/PAIR-code/lit) (👨‍💻 18 · 🔀 300 · 📦 10 · 📋 100 - 35% open · ⏱️ 15.03.2022):
...
- [PyPi](https://pypi.org/project/lit-nlp) (📥 1.3K / month):
	...
	pip install lit-nlp
	```
- [Conda](https://anaconda.org/conda-forge/lit-nlp) (📥 38K · ⏱️ 09.11.2021):
	```
...
<details><summary><b><a href="https://github.com/kundajelab/deeplift">deeplift</a></b> (🥉21 ·  ⭐ 650 · 💤) - Public facing deeplift repo. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/kundajelab/deeplift) (👨‍💻 11 · 🔀 150 · 📦 59 · 📋 84 - 42% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/deeplift) (📥 1K / month):
	```
	pip install deeplift
	```
</details>
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉20 ·  ⭐ 860) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/DiCE) (👨‍💻 13 · 🔀 120 · 📋 120 - 43% open · ⏱️ 27.06.2022):
...
<details><summary><b><a href="https://github.com/edublancas/sklearn-evaluation">sklearn-evaluation</a></b> (🥉20 ·  ⭐ 330) - Machine learning model evaluation made easy: plots,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/edublancas/sklearn-evaluation) (👨‍💻 8 · 🔀 28 · 📦 46 · 📋 39 - 23% open · ⏱️ 16.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-evaluation) (📥 960 / month):
	```
...
- [PyPi](https://pypi.org/project/ecco) (📥 280 / month):
	...
	pip install ecco
	```
- [Conda](https://anaconda.org/conda-forge/ecco) (📥 750 · ⏱️ 10.01.2022):
	```
...
- [GitHub](https://github.com/tensorflow/tcav) (👨‍💻 19 · 🔀 130 · 📦 13 · 📋 61 - 11% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/tcav) (📥 51 / month):
	```
	pip install tcav
	```
</details>
...
- [GitHub](https://github.com/EthicalML/xai) (👨‍💻 3 · 🔀 120 · 📦 17 · 📋 9 - 22% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/xai) (📥 78 / month):
	```
	pip install xai
	```
</details>
...
- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 3 · 🔀 53 · 📦 19 · 📋 18 - 11% open · ⏱️ 27.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/lofo-importance) (📥 400 / month):
	```
...
- <b><a href="https://github.com/tensorflow/model-card-toolkit">model-card-toolkit</a></b> (🥉18 ·  ⭐ 290) - a tool that leverages rich metadata and lineage.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 210 · 🔀 1.4K · 📥 34K · 📋 5.4K - 5% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 23K / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/milvusdb/milvus) (📥 990K · ⭐ 21 · ⏱️ 30.06.2022):
	```
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 23K / month):
	...
	pip install pymilvus
	```
- [Conda](https://anaconda.org/conda-forge/faiss) (📥 380K · ⏱️ 09.02.2022):
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 82 · 🔀 1K · 📦 2.1K · 📋 350 - 10% open · ⏱️ 17.06.2022):
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 48 · 🔀 390 · 📦 630 · 📋 400 - 14% open · ⏱️ 31.05.2022):
...
- [PyPi](https://pypi.org/project/nmslib) (📥 100K / month):
	...
	pip install nmslib
	```
- [Conda](https://anaconda.org/conda-forge/nmslib) (📥 56K · ⏱️ 15.04.2022):
	```
...
- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 20 · 🔀 87 · 📦 1.8K · 📋 100 - 47% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/pynndescent) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pynndescent) (📥 700K · ⏱️ 15.05.2022):
	```
...
- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 56 · 🔀 370 · 📦 250 · 📋 240 - 48% open · ⏱️ 16.04.2022):

	```
	git clone https://github.com/nmslib/hnswlib
	```
- [PyPi](https://pypi.org/project/hnswlib) (📥 320K / month):
	```
	pip install hnswlib
	```
...
<details><summary><b><a href="https://github.com/pyro-ppl/pyro">Pyro</a></b> (🥇34 ·  ⭐ 7.5K) - Deep universal probabilistic programming with Python and PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 130 · 🔀 890 · 📦 760 · 📋 960 - 19% open · ⏱️ 26.06.2022):

	```
	git clone https://github.com/pyro-ppl/pyro
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 490K / month):
	```
	pip install pyro-ppl
	```
- [Conda](https://anaconda.org/conda-forge/pyro-ppl) (📥 12K · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 450 · 🔀 950 · 📋 1.2K - 41% open · ⏱️ 29.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 830K / month):
	```
	pip install tensorflow-probability
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-probability) (📥 62K · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 94 · 🔀 410 · 📦 630 · 📋 1.1K - 24% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/gpytorch) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gpytorch) (📥 38K · ⏱️ 28.06.2022):
	```
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 77 · 🔀 410 · 📦 370 · 📋 760 - 13% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 41 · 🔀 660 · 📦 1.3K · 📋 380 - 12% open · ⏱️ 17.06.2022):
...
- [GitHub](https://github.com/rlabbe/filterpy) (👨‍💻 42 · 🔀 500 · 📦 1.5K · 📋 200 - 22% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/rlabbe/filterpy
	```
- [PyPi](https://pypi.org/project/filterpy) (📥 720K / month):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 110 · 🔀 630 · 📥 160 · 📦 370 · 📋 760 - 24% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 45 · 🔀 580 · 📦 710 · 📋 400 - 15% open · ⏱️ 23.06.2022):
...
- [PyPi](https://pypi.org/project/pandas-ta) (📥 68K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 1.3K · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 65 · 🔀 530 · 📦 700 · 📋 670 - 7% open · ⏱️ 21.02.2022):
...
- [PyPi](https://pypi.org/project/pomegranate) (📥 42K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pomegranate) (📥 90K · ⏱️ 16.11.2021):
	```
...
- [PyPi](https://pypi.org/project/salib) (📥 170K / month):
	...
	pip install salib
	```
- [Conda](https://anaconda.org/conda-forge/salib) (📥 84K · ⏱️ 04.09.2021):
	```
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 26 · 🔀 87 · 📦 30 · 📋 260 - 16% open · ⏱️ 22.06.2022):
...
- [PyPi](https://pypi.org/project/bambi) (📥 5.2K / month):
	...
	pip install bambi
	```
- [Conda](https://anaconda.org/conda-forge/bambi) (📥 9.2K · ⏱️ 07.06.2022):
	```
	conda install -c conda-forge bambi
	```
</details>
<details><summary><b><a href="https://github.com/baal-org/baal">Baal</a></b> (🥉19 ·  ⭐ 610) - Library to enable Bayesian active learning in your research or labeling.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/baal-org/baal) (👨‍💻 14 · 🔀 55 · 📋 83 - 30% open · ⏱️ 20.05.2022):
...
- [PyPi](https://pypi.org/project/baal) (📥 620 / month):
	...
	pip install baal
	```
- [Conda](https://anaconda.org/conda-forge/baal) (📥 2K · ⏱️ 04.05.2022):
	```
...
- <b><a href="https://github.com/pymc-devs/pymc">PyMC3</a></b> (🥇36 ·  ⭐ 6.7K) - Probabilistic Programming in Python: Bayesian Modeling and.. <code>❗Unlicensed</code>
...
<details><summary><b><a href="https://github.com/Trusted-AI/adversarial-robustness-toolbox">ART</a></b> (🥇32 ·  ⭐ 3.1K) - Adversarial Robustness Toolbox (ART) - Python Library for Machine Learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 100 · 🔀 820 · 📦 240 · 📋 690 - 12% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/Trusted-AI/adversarial-robustness-toolbox
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 53 · 🔀 240 · 📦 82 · 📋 210 - 8% open · ⏱️ 29.06.2022):
...
- [PyPi](https://pypi.org/project/textattack) (📥 10K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textattack) (📥 3.1K · ⏱️ 29.06.2021):
	```
...
- [PyPi](https://pypi.org/project/cleverhans) (📥 1.2K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cleverhans) (📥 3.3K · ⏱️ 29.07.2021):
	```
...
- [PyPi](https://pypi.org/project/foolbox) (📥 3.2K / month):
	...
	pip install foolbox
	```
- [Conda](https://anaconda.org/conda-forge/foolbox) (📥 6.4K · ⏱️ 30.04.2021):
	```
	conda install -c conda-forge foolbox
	```
</details>
<details><summary><b><a href="https://github.com/MadryLab/robustness">robustness</a></b> (🥉18 ·  ⭐ 710) - A library for experimenting with, training and evaluating neural.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/robustness) (📥 420 / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robustness) (📥 3.8K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/cupy/cupy) (👨‍💻 300 · 🔀 580 · 📥 36K · 📦 1.1K · 📋 1.7K - 20% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/cupy) (📥 150K / month):
	...
	pip install cupy
	```
- [Conda](https://anaconda.org/conda-forge/cupy) (📥 1.6M · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 250 · 🔀 620 · 📋 4.6K - 14% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 81 · 🔀 490 · 📥 2.5K · 📋 1.5K - 15% open · ⏱️ 22.06.2022):
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 13 · 🔀 220 · 📦 2K · 📋 84 - 25% open · ⏱️ 31.05.2022):
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 150 · 🔀 410 · 📋 2K - 32% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/rapidsai/cuml
	```
- [PyPi](https://pypi.org/project/cuml) (📥 710 / month):
	```
	pip install cuml
	```
</details>
<details><summary><b><a href="https://github.com/NVIDIA/apex">Apex</a></b> (🥈27 ·  ⭐ 6.4K) - A PyTorch Extension: Tools for easy mixed precision and distributed.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 94 · 🔀 970 · 📦 1.1K · 📋 980 - 56% open · ⏱️ 23.06.2022):

	```
	git clone https://github.com/NVIDIA/apex
	```
- [Conda](https://anaconda.org/conda-forge/nvidia-apex) (📥 92K · ⏱️ 06.04.2022):
	```
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 75 · 🔀 500 · 📋 1.2K - 15% open · ⏱️ 30.06.2022):
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 87 · 🔀 200 · 📋 840 - 10% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/cugraph) (📥 87 / month):
	...
	pip install cugraph
	```
- [Conda](https://anaconda.org/conda-forge/libcugraph) (📥 7.9K · ⏱️ 29.04.2021):
	```
...
<details><summary><b><a href="https://github.com/KomputeProject/kompute">Vulkan Kompute</a></b> (🥉20 ·  ⭐ 890) - General purpose GPU compute framework built on Vulkan to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 19 · 🔀 61 · 📥 160 · 📦 4 · 📋 170 - 31% open · ⏱️ 21.06.2022):
...
- [GitHub](https://github.com/rapidsai/cusignal) (👨‍💻 38 · 🔀 94 · 📋 140 - 11% open · ⏱️ 02.06.2022):
...
- <b><a href="https://github.com/nicolargo/nvidia-ml-py3">nvidia-ml-py3</a></b> (🥉16 ·  ⭐ 82 · 💀) - Python 3 Bindings for the NVIDIA Management Library. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 190 · 🔀 520 · 📦 6.7K · 📋 910 - 21% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 91 · 🔀 1.6K · 📦 12K · 📋 650 - 2% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/tensorflow-hub) (📥 4.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-hub) (📥 64K · ⏱️ 18.04.2021):
	```
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 260 · 🔀 1.2K · 📋 970 - 36% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/tensorflow-datasets) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-datasets) (📥 5.4K · ⏱️ 17.08.2021):
	```
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 69 · 🔀 270 · 📦 1.9K · 📋 290 - 47% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 190 · 📦 920 · 📋 180 - 16% open · ⏱️ 29.06.2022):
...
- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 15 · 🔀 170 · 📦 33 · ⏱️ 13.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/saliency) (📥 720 / month):
	```
...
- [GitHub](https://github.com/geffy/tffm) (👨‍💻 10 · 🔀 180 · 📦 11 · 📋 40 - 45% open · ⏱️ 17.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/tffm) (📥 1.7K / month):
	```
	pip install tffm
	```
</details>
...
<details><summary><b><a href="https://github.com/patrick-kidger/equinox">equinox</a></b> (🥇22 ·  ⭐ 650) - Callable PyTrees and filtered transforms = neural networks in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/patrick-kidger/equinox) (👨‍💻 7 · 🔀 34 · 📦 30 · 📋 59 - 15% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/patrick-kidger/equinox
	```
- [PyPi](https://pypi.org/project/equinox) (📥 2.1K / month):
	```
	pip install equinox
	```
</details>
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 51 · 🔀 87 · 📦 53 · 📋 240 - 8% open · ⏱️ 05.06.2022):
...
- [PyPi](https://pypi.org/project/scikit-lego) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-lego) (📥 20K · ⏱️ 06.06.2022):
	```
...
- [GitHub](https://github.com/iskandr/fancyimpute) (👨‍💻 12 · 🔀 160 · 📦 1.2K · 📋 110 - 1% open · ⏱️ 21.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/fancyimpute) (📥 17K / month):
	```
...
- [GitHub](https://github.com/guofei9987/scikit-opt) (👨‍💻 15 · 🔀 770 · 📦 79 · 📋 150 - 28% open · ⏱️ 16.06.2022):
...
<details><summary><b><a href="https://github.com/trent-b/iterative-stratification">iterative-stratification</a></b> (🥉22 ·  ⭐ 660) - scikit-learn cross validators for iterative.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 7 · 🔀 62 · 📦 220 · 📋 19 - 21% open · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 1.1M / month):
	```
...
- [GitHub](https://github.com/yzhao062/combo) (🔀 99 · 📦 470 · 📋 13 - 76% open · ⏱️ 02.10.2021):
...
- [GitHub](https://github.com/scikit-learn-contrib/DESlib) (👨‍💻 14 · 🔀 58 · 📦 28 · 📋 140 - 11% open · ⏱️ 07.06.2022):
...
- <b><a href="https://github.com/amueller/dabl">dabl</a></b> (🥉14 ·  ⭐ 110 · 💤) - Data Analysis Baseline Library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/metric-learning/pytorch-metric-learning) (📥 7.4K · ⏱️ 29.06.2022):
	```
	conda install -c metric-learning pytorch-metric-learning
	```
</details>
<details><summary><b><a href="https://github.com/huggingface/accelerate">accelerate</a></b> (🥇33 ·  ⭐ 2.6K) - A simple way to train and use PyTorch models with multi-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 46 · 🔀 180 · 📦 660 · 📋 260 - 9% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/huggingface/accelerate
	```
- [PyPi](https://pypi.org/project/accelerate) (📥 1.1M / month):
	```
	pip install accelerate
	```
- [Conda](https://anaconda.org/conda-forge/accelerate) (📥 3.2K · ⏱️ 20.06.2022):
	```
...
- [GitHub](https://github.com/Lightning-AI/lightning-flash) (👨‍💻 71 · 🔀 170 · 📦 90 · 📋 460 - 3% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/PyTorchLightning/lightning-flash
	```
- [PyPi](https://pypi.org/project/lightning-flash) (📥 4.9K / month):
	```
	pip install lightning-flash
	```
- [Conda](https://anaconda.org/conda-forge/lightning-flash) (📥 2.8K · ⏱️ 12.05.2022):
	```
...
- [PyPi](https://pypi.org/project/torch_optimizer) (📥 47K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/torch-optimizer) (📥 2.2K · ⏱️ 31.10.2021):
	```
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 20 · 🔀 720 · 📦 270 · 📋 170 - 21% open · ⏱️ 22.04.2022):
...
- [PyPi](https://pypi.org/project/torchdiffeq) (📥 6.7K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/torchdiffeq) (📥 5.7K · ⏱️ 03.06.2021):
	```
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 350 · 📋 220 - 5% open · ⏱️ 27.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 16K / month):
	```
	pip install pytorch-tabnet
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-tabnet) (📥 820 · ⏱️ 30.12.2021):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 99 · 📋 24 - 8% open · ⏱️ 27.06.2022):
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥈23 ·  ⭐ 670) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 25 · 🔀 94 · 📋 190 - 13% open · ⏱️ 30.06.2022):
...
- [PyPi](https://pypi.org/project/torch-sparse) (📥 24K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_sparse) (📥 99K · ⏱️ 08.06.2022):
	```
...
- [GitHub](https://github.com/tristandeleu/pytorch-meta) (👨‍💻 12 · 🔀 210 · 📦 93 · 📋 130 - 32% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/tristandeleu/pytorch-meta
	```
- [PyPi](https://pypi.org/project/torchmeta) (📥 3.3K / month):
	```
...
<details><summary><b><a href="https://github.com/geohot/tinygrad">tinygrad</a></b> (🥉20 ·  ⭐ 6.2K · 📈) - You like pytorch? You like micrograd? You love tinygrad!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 60 · 🔀 610 · 📦 2 · 📋 100 - 12% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/harvardnlp/pytorch-struct) (👨‍💻 16 · 🔀 81 · 📋 54 - 44% open · ⏱️ 30.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/torch-struct) (📥 91K / month):
	```
...
<details><summary><b><a href="https://github.com/rusty1s/pytorch_scatter">torch-scatter</a></b> (🥉19 ·  ⭐ 1K) - PyTorch Extension Library of Optimized Scatter Operations. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 20 · 🔀 120 · 📋 270 - 8% open · ⏱️ 29.06.2022):

	```
	git clone https://github.com/rusty1s/pytorch_scatter
	```
- [PyPi](https://pypi.org/project/torch-scatter) (📥 29K / month):
	```
	pip install torch-scatter
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_scatter) (📥 87K · ⏱️ 21.03.2022):
	```
...
- [GitHub](https://github.com/szagoruyko/pytorchviz) (👨‍💻 6 · 🔀 230 · 📦 710 · 📋 57 - 36% open · ⏱️ 15.06.2021):

	```
	git clone https://github.com/szagoruyko/pytorchviz
	```
</details>
<details><summary><b><a href="https://github.com/abhishekkrthakur/tez">Tez</a></b> (🥉16 ·  ⭐ 1K) - Tez is a super-simple and lightweight Trainer for PyTorch. It also.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/abhishekkrthakur/tez) (🔀 130 · 📦 29 · 📋 34 - 50% open · ⏱️ 05.06.2022):

	```
	git clone https://github.com/abhishekkrthakur/tez
	```
- [PyPi](https://pypi.org/project/tez) (📥 980 / month):
	```
	pip install tez
	```
</details>
...
- [PyPi](https://pypi.org/project/tensor-sensor) (📥 1.9K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensor-sensor) (📥 490 · ⏱️ 11.12.2021):
	```
...
- <b><a href="https://github.com/Cadene/pretrained-models.pytorch">pretrainedmodels</a></b> (🥇30 ·  ⭐ 8.6K · 💀) - Pretrained ConvNets for pytorch: NASNet, ResNeXt,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/TorchDrift/TorchDrift">TorchDrift</a></b> (🥉11 ·  ⭐ 220) - Drift Detection for your PyTorch Models. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.3K · 🔀 4.2K · 📥 350K · 📦 530K · 📋 8.3K - 17% open · ⏱️ 30.06.2022):
...
<details><summary><b><a href="https://github.com/yzhao062/pyod">PyOD</a></b> (🥇36 ·  ⭐ 5.8K) - A Comprehensive and Scalable Python Library for Outlier Detection (Anomaly.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 39 · 🔀 1.1K · 📦 1.4K · 📋 250 - 47% open · ⏱️ 25.06.2022):

	```
	git clone https://github.com/yzhao062/pyod
	```
- [PyPi](https://pypi.org/project/pyod) (📥 450K / month):
	```
	pip install pyod
	```
- [Conda](https://anaconda.org/conda-forge/pyod) (📥 26K · ⏱️ 23.06.2022):
	```
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 200 · 🔀 1.3K · 📦 110 · 📋 1.4K - 29% open · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleHub">PaddleHub</a></b> (🥇33 ·  ⭐ 8.1K) - Awesome pre-trained models toolkit based on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 61 · 🔀 1.6K · 📥 570 · 📦 820 · 📋 1.1K - 40% open · ⏱️ 15.04.2022):
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 65 · 🔀 410 · 📥 39 · 📦 690 · 📋 1.3K - 27% open · ⏱️ 28.06.2022):
...
- [PyPi](https://pypi.org/project/datasette) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/datasette) (📥 5.6K · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 80 · 🔀 380 · 📦 140 · 📋 370 - 1% open · ⏱️ 27.06.2022):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 10K / month):
	```
	pip install river
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/hdbscan) (👨‍💻 78 · 🔀 380 · 📦 1.4K · 📋 430 - 63% open · ⏱️ 02.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/hdbscan) (📥 650K / month):
	```
	pip install hdbscan
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 49 · 🔀 140 · 📦 990 · 📋 640 - 1% open · ⏱️ 15.07.2021):
...
- [PyPi](https://pypi.org/project/agate) (📥 2.3M / month):
	...
	pip install agate
	```
- [Conda](https://anaconda.org/conda-forge/agate) (📥 85K · ⏱️ 16.07.2021):
	```
...
<details><summary><b><a href="https://github.com/adapter-hub/adapter-transformers">adapter-transformers</a></b> (🥈30 ·  ⭐ 880) - Huggingface Transformers + Adapters =. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/adapter-hub/adapter-transformers) (👨‍💻 1.3K · 🔀 140 · 📦 78 · 📋 190 - 30% open · ⏱️ 30.06.2022):
...
<details><summary><b><a href="https://github.com/gradio-app/gradio">Gradio</a></b> (🥈29 ·  ⭐ 7.6K) - Wrap UIs around any model, share with anyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 82 · 🔀 470 · 📦 1 · 📋 830 - 22% open · ⏱️ 30.06.2022):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 160K / month):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 66 · 🔀 170 · 📦 160 · 📋 750 - 13% open · ⏱️ 21.06.2022):
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 100 · 🔀 150 · 📦 190 · 📋 480 - 20% open · ⏱️ 26.06.2022):
...
- [GitHub](https://github.com/mars-project/mars) (👨‍💻 45 · 🔀 300 · 📋 1.1K - 17% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 110 · 🔀 380 · 📥 60 · 📋 700 - 21% open · ⏱️ 25.06.2022):
...
- [PyPi](https://pypi.org/project/pennylane) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pennylane) (📥 2K · ⏱️ 01.05.2022):
	```
...
- [GitHub](https://github.com/tableau/TabPy) (👨‍💻 47 · 🔀 470 · 📦 92 · 📋 290 - 1% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/tabpy) (📥 24K / month):
	```
	pip install tabpy
	```
...
- [PyPi](https://pypi.org/project/gplearn) (📥 6.4K / month):
	...
	pip install gplearn
	```
- [Conda](https://anaconda.org/conda-forge/gplearn) (📥 2.6K · ⏱️ 04.05.2022):
	```
...
- [GitHub](https://github.com/google/trax) (👨‍💻 78 · 🔀 710 · 📦 63 · 📋 210 - 41% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 16 · 🔀 140 · 📦 100 · 📋 240 - 33% open · ⏱️ 27.06.2022):
...
- [GitHub](https://github.com/scikit-learn-contrib/metric-learn) (👨‍💻 22 · 🔀 220 · 📦 210 · 📋 160 - 26% open · ⏱️ 21.06.2022):
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 58 · 🔀 150 · 📥 1 · 📦 9 · 📋 520 - 12% open · ⏱️ 22.06.2022):

	```
	git clone https://github.com/ContinualAI/avalanche
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 620 / month):
	```
...
- [GitHub](https://github.com/sepandhaghighi/pycm) (👨‍💻 17 · 🔀 110 · 📦 150 · 📋 180 - 6% open · ⏱️ 27.04.2022):
...
- [GitHub](https://github.com/ljvmiranda921/pyswarms) (👨‍💻 43 · 🔀 300 · 📦 180 · 📋 200 - 1% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/ljvmiranda921/pyswarms
	```
- [PyPi](https://pypi.org/project/pyswarms) (📥 10K / month):
	```
	pip install pyswarms
	```
</details>
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉23 ·  ⭐ 810) - Python factor analysis library (PCA, CA, MCA, MFA, FAMD). <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/findspark) (📥 2.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/findspark) (📥 660K · ⏱️ 11.02.2022):
	```
...
<details><summary><b><a href="https://github.com/yzhao062/SUOD">SUOD</a></b> (🥉18 ·  ⭐ 330) - (MLSys 21) An Acceleration System for Large-scare Unsupervised Heterogeneous.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/yzhao062/SUOD) (🔀 42 · 📦 430 · 📋 9 - 66% open · ⏱️ 11.04.2022):
...
- [GitHub](https://github.com/SforAiDl/KD_Lib) (👨‍💻 6 · 🔀 34 · 📋 58 - 20% open · ⏱️ 18.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/KD-Lib) (📥 130 / month):
	```
	pip install KD-Lib
	```
</details>
...
- [GitHub](https://github.com/jmschrei/apricot) (👨‍💻 4 · 🔀 40 · 📥 10 · 📦 28 · 📋 26 - 30% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/jmschrei/apricot
	```
- [PyPi](https://pypi.org/project/apricot-select) (📥 250 / month):
	```
...
- <b><a href="https://github.com/inducer/pyopencl">pyopencl</a></b> (🥈30 ·  ⭐ 900) - OpenCL integration for Python, plus shiny features. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/Project-MONAI/MONAILabel">MONAILabel</a></b> (🥉23 ·  ⭐ 260) - MONAI Label is an intelligent open source image labeling and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/dstackai/dstack">dstack</a></b> (🥉13 ·  ⭐ 50 · 🐣) - dstack: Your new home for building AI apps. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
