...
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 4.1M · ⏱️ 27.03.2023):
	...
	```
- [Docker Hub](https://hub.docker.com/r/tensorflow/tensorflow) (📥 72M · ⭐ 2.1K · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 2.9K · 🔀 23K · 📥 860 · 📦 490K · 📋 10K - 15% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/scikit-learn/scikit-learn
	```
- [PyPi](https://pypi.org/project/scikit-learn) (📥 39M / month):
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">PyTorch</a></b> (🥇44 ·  ⭐ 65K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/torch) (📥 9.9M / month):
	...
	pip install torch
	```
- [Conda](https://anaconda.org/pytorch/pytorch) (📥 15M · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/google/jax) (👨‍💻 520 · 🔀 2K · 📦 9.6K · 📋 4K - 26% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/google/jax
	```
- [PyPi](https://pypi.org/project/jax) (📥 3.1M / month):
	```
	pip install jax
	```
- [Conda](https://anaconda.org/conda-forge/jaxlib) (📥 670K · ⏱️ 31.03.2023):
	```
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 280 · 🔀 3.6K · 📥 190K · 📦 20K · 📋 2.9K - 8% open · ⏱️ 02.04.2023):
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 1K · 🔀 4.9K · 📥 15K · 📦 210 · 📋 16K - 6% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/PaddlePaddle/Paddle
	```
- [PyPi](https://pypi.org/project/paddlepaddle) (📥 150K / month):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 240 · 🔀 7.2K · 📦 13K · 📋 1.7K - 7% open · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 160 · 🔀 2K · 📦 470 · 📋 1.8K - 1% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/jina) (📥 57K / month):
	...
	pip install jina
	```
- [Conda](https://anaconda.org/conda-forge/jina-core) (📥 40K · ⏱️ 16.08.2022):
	```
	conda install -c conda-forge jina-core
	```
- [Docker Hub](https://hub.docker.com/r/jinaai/jina) (📥 1.2M · ⭐ 8 · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 2.8K · 🔀 26K · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/Lightning-AI/lightning) (👨‍💻 850 · 🔀 2.8K · 📥 11K · 📋 6K - 10% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pytorch-lightning) (📥 4.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-lightning) (📥 750K · ⏱️ 30.03.2023):
	```
...
- [PyPi](https://pypi.org/project/mxnet) (📥 480K / month):
	...
	pip install mxnet
	```
- [Conda](https://anaconda.org/anaconda/mxnet) (📥 9.2K · ⏱️ 24.10.2022):
	```
	conda install -c anaconda mxnet
	```
</details>
<details><summary><b><a href="https://github.com/catboost/catboost">Catboost</a></b> (🥈37 ·  ⭐ 7.1K) - A fast, scalable, high performance Gradient Boosting on Decision.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/catboost/catboost) (👨‍💻 1.1K · 🔀 1.1K · 📥 130K · 📋 2K - 23% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/google/flax">Flax</a></b> (🥈37 ·  ⭐ 4.2K) - Flax is a neural network library for JAX that is designed for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google/flax) (👨‍💻 190 · 🔀 460 · 📥 42 · 📦 2.7K · 📋 670 - 11% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/google/flax
	```
- [PyPi](https://pypi.org/project/flax) (📥 640K / month):
	```
	pip install flax
	```
- [Conda](https://anaconda.org/conda-forge/flax) (📥 22K · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/explosion/thinc) (👨‍💻 61 · 🔀 260 · 📦 29K · 📋 130 - 12% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/VowpalWabbit/vowpal_wabbit) (👨‍💻 330 · 🔀 1.9K · 📋 1.2K - 10% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/arogozhnikov/einops">einops</a></b> (🥈34 ·  ⭐ 6.6K) - Deep learning operations reinvented (for pytorch, tensorflow, jax and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 23 · 🔀 290 · 📦 9K · 📋 130 - 22% open · ⏱️ 16.03.2023):

	```
	git clone https://github.com/arogozhnikov/einops
	```
- [PyPi](https://pypi.org/project/einops) (📥 3.5M / month):
	```
	pip install einops
	```
- [Conda](https://anaconda.org/conda-forge/einops) (📥 86K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 130 · 🔀 980 · 📦 160 · 📋 910 - 23% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 1.7K · 🔀 12K · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/tensorpack) (📥 16K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorpack) (📥 8.7K · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/deepmind/dm-haiku) (👨‍💻 74 · 🔀 200 · 📦 1.2K · 📋 210 - 27% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/dm-haiku) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dm-haiku) (📥 9.8K · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/amaiya/ktrain) (👨‍💻 16 · 🔀 260 · 📦 400 · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) (👨‍💻 4.3K · 🔀 73 · 📥 21 · 📋 340 - 18% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 56 · 🔀 330 · 📦 800 · 📋 470 - 10% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/skorch) (📥 47K / month):
	...
	pip install skorch
	```
- [Conda](https://anaconda.org/conda-forge/skorch) (📥 750K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 190 · 🔀 580 · 📋 1.2K - 9% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 72 · 🔀 320 · 📥 570 · 📋 76 - 25% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/google/neural-tangents) (👨‍💻 24 · 🔀 220 · 📥 280 · 📦 65 · 📋 130 - 38% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/towhee-io/towhee">Towhee</a></b> (🥉25 ·  ⭐ 2K) - Towhee is a framework that is dedicated to making neural data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 29 · 🔀 190 · 📥 1.1K · 📋 590 - 1% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/towhee-io/towhee
	```
- [PyPi](https://pypi.org/project/towhee) (📥 2.4K / month):
	```
	pip install towhee
	```
</details>
...
- [GitHub](https://github.com/nubank/fklearn) (👨‍💻 52 · 🔀 160 · 📦 13 · 📋 50 - 52% open · ⏱️ 28.03.2023):

	```
	git clone https://github.com/nubank/fklearn
	```
- [PyPi](https://pypi.org/project/fklearn) (📥 4.6K / month):
	```
	pip install fklearn
	```
</details>
...
<details><summary><b><a href="https://github.com/XiaoMi/mace">mace</a></b> (🥉22 ·  ⭐ 4.8K · 💤) - MACE is a deep learning inference framework optimized for mobile.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Xtra-Computing/thundersvm) (👨‍💻 34 · 🔀 200 · 📥 2.6K · 📋 210 - 29% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/thundersvm) (📥 500 / month):
	```
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 33 · 🔀 110 · 📋 64 - 21% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/neoml-lib/neoml
	```
- [PyPi](https://pypi.org/project/neoml) (📥 99 / month):
	```
	pip install neoml
	```
</details>
...
- [GitHub](https://github.com/serengil/chefboost) (👨‍💻 6 · 🔀 93 · 📦 37 · 📋 30 - 10% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/serengil/chefboost
	```
- [PyPi](https://pypi.org/project/chefboost) (📥 1.1K / month):
	```
...
- [GitHub](https://github.com/Xtra-Computing/thundergbm) (👨‍💻 10 · 🔀 82 · 📦 2 · 📋 76 - 44% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/Xtra-Computing/thundergbm
	```
- [PyPi](https://pypi.org/project/thundergbm) (📥 87 / month):
	```
...
- <b><a href="https://github.com/mlpack/mlpack">mlpack</a></b> (🥉31 ·  ⭐ 4.4K) - mlpack: a fast, header-only C++ machine learning library. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.5K · 🔀 6.6K · 📦 790K · 📋 9.4K - 15% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/matplotlib/matplotlib
	```
- [PyPi](https://pypi.org/project/matplotlib) (📥 35M / month):
	```
...
<details><summary><b><a href="https://github.com/plotly/dash">dash</a></b> (🥇41 ·  ⭐ 18K) - Data Apps & Dashboards for Python. No JavaScript Required. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/plotly/dash) (👨‍💻 130 · 🔀 1.8K · 📦 44K · 📋 1.5K - 46% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/dash) (📥 1.5M / month):
	...
	pip install dash
	```
- [Conda](https://anaconda.org/conda-forge/dash) (📥 890K · ⏱️ 30.03.2023):
	```
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 38 · 🔀 2.7K · 📦 3K · 📋 1.7K - 0% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/pyecharts/pyecharts
	```
- [PyPi](https://pypi.org/project/pyecharts) (📥 83K / month):
	```
...
- [GitHub](https://github.com/plotly/plotly.py) (👨‍💻 220 · 🔀 2.3K · 📋 2.6K - 49% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/plotly) (📥 8.4M / month):
	...
	pip install plotly
	```
- [Conda](https://anaconda.org/conda-forge/plotly) (📥 4M · ⏱️ 05.04.2023):
	```
	conda install -c conda-forge plotly
	```
- [npm](https://www.npmjs.com/package/plotlywidget) (📥 42K / month):
	```
	npm install plotlywidget
	```
</details>
<details><summary><b><a href="https://github.com/voxel51/fiftyone">FiftyOne</a></b> (🥇36 ·  ⭐ 2.8K) - Visualize, create, and debug image and video datasets.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 77 · 🔀 320 · 📦 280 · 📋 1.2K - 33% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 290K / month):
	```
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 120 · 🔀 310 · 📥 710 · 📦 1.8K · 📋 1.1K - 28% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 89K / month):
	```
	pip install pyvista
	```
- [Conda](https://anaconda.org/conda-forge/pyvista) (📥 310K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 110 · 🔀 680 · 📦 8.4K · 📋 690 - 54% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/holoviz/datashader) (👨‍💻 53 · 🔀 350 · 📦 2.1K · 📋 530 - 23% open · ⏱️ 24.03.2023):
...
- [PyPi](https://pypi.org/project/datashader) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/datashader) (📥 530K · ⏱️ 02.02.2023):
	```
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 130 · 🔀 360 · 📋 3K - 32% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/ResidentMario/missingno) (👨‍💻 18 · 🔀 430 · 📦 11K · 📋 130 - 6% open · ⏱️ 26.02.2023):
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 29 · 🔀 330 · 📦 660 · 📋 510 - 8% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/holoviz/hvplot">hvPlot</a></b> (🥈30 ·  ⭐ 740) - A high-level plotting API for pandas, dask, xarray, and networkx built on.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 39 · 🔀 83 · 📦 2.6K · 📋 600 - 40% open · ⏱️ 17.03.2023):
...
- [PyPi](https://pypi.org/project/hvplot) (📥 130K / month):
	...
	pip install hvplot
	```
- [Conda](https://anaconda.org/conda-forge/hvplot) (📥 350K · ⏱️ 17.03.2023):
	```
...
- [PyPi](https://pypi.org/project/wordcloud) (📥 790K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/wordcloud) (📥 390K · ⏱️ 25.08.2022):
	```
...
<details><summary><b><a href="https://github.com/tensorflow/data-validation">data-validation</a></b> (🥈29 ·  ⭐ 710) - Library for exploring and validating machine learning.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/data-validation) (👨‍💻 25 · 🔀 140 · 📥 400 · 📦 650 · 📋 160 - 13% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/tensorflow/data-validation
	```
- [PyPi](https://pypi.org/project/tensorflow-data-validation) (📥 650K / month):
	```
	pip install tensorflow-data-validation
	```
</details>
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥉27 ·  ⭐ 5.7K) - A data visualization and analytics component, especially.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/pavlin-policar/openTSNE) (👨‍💻 11 · 🔀 130 · 📦 530 · 📋 120 - 1% open · ⏱️ 20.02.2023):
...
<details><summary><b><a href="https://github.com/JetBrains/lets-plot">lets-plot</a></b> (🥉27 ·  ⭐ 850) - An open-source plotting library for statistical data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 19 · 🔀 41 · 📥 410 · 📦 32 · 📋 360 - 26% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/spotify/chartify) (👨‍💻 25 · 🔀 290 · 📦 71 · 📋 73 - 57% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/AutoViML/AutoViz) (👨‍💻 14 · 🔀 170 · 📦 380 · 📋 68 - 7% open · ⏱️ 30.12.2022):
...
- [PyPi](https://pypi.org/project/autoviz) (📥 170K / month):
	...
	pip install autoviz
	```
- [Conda](https://anaconda.org/conda-forge/autoviz) (📥 30K · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/PatrikHlobil/Pandas-Bokeh) (👨‍💻 15 · 🔀 110 · 📦 440 · 📋 100 - 31% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/marcharper/python-ternary) (👨‍💻 27 · 🔀 140 · 📥 19 · 📦 120 · 📋 130 - 21% open · ⏱️ 31.12.2022):

	```
	git clone https://github.com/marcharper/python-ternary
	```
- [PyPi](https://pypi.org/project/python-ternary) (📥 54K / month):
	```
...
<details><summary><b><a href="https://github.com/ing-bank/popmon">Popmon</a></b> (🥉21 ·  ⭐ 430) - Monitor the stability of a Pandas or Spark dataframe. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 16 · 🔀 32 · 📥 50 · 📦 19 · 📋 46 - 26% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 13 · 🔀 58 · 📦 2 · 📋 100 - 11% open · ⏱️ 01.04.2023):
...
- [GitHub](https://github.com/gyli/PyWaffle) (👨‍💻 6 · 🔀 99 · 📦 220 · 📋 21 - 23% open · ⏱️ 08.06.2022):

	```
	git clone https://github.com/gyli/PyWaffle
	```
- [PyPi](https://pypi.org/project/pywaffle) (📥 2.9K / month):
	```
	pip install pywaffle
	```
- [Conda](https://anaconda.org/conda-forge/pywaffle) (📥 8.9K · ⏱️ 05.06.2022):
	```
...
<details><summary><b><a href="https://github.com/huggingface/transformers">transformers</a></b> (🥇49 ·  ⭐ 91K) - Transformers: State-of-the-art Machine Learning for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 1.8K · 🔀 18K · 📥 140 · 📦 62K · 📋 11K - 4% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/transformers) (📥 13M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transformers) (📥 1M · ⏱️ 30.03.2023):
	```
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 720 · 🔀 4K · 📦 57K · 📋 5.4K - 1% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/explosion/spaCy
	```
- [PyPi](https://pypi.org/project/spacy) (📥 5M / month):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 580 · 🔀 4.1K · 📦 3.2K · 📋 6.6K - 0% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/facebookresearch/fairseq) (👨‍💻 410 · 🔀 5.2K · 📥 300 · 📦 1.3K · 📋 3.8K - 22% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/fairseq) (📥 130K / month):
	...
	pip install fairseq
	```
- [Conda](https://anaconda.org/conda-forge/fairseq) (📥 27K · ⏱️ 28.03.2023):
	```
	conda install -c conda-forge fairseq
	```
</details>
<details><summary><b><a href="https://github.com/JohnSnowLabs/spark-nlp">spark-nlp</a></b> (🥇36 ·  ⭐ 3.2K) - State of the Art Natural Language Processing. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/JohnSnowLabs/spark-nlp) (👨‍💻 140 · 🔀 630 · 📦 270 · 📋 780 - 3% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/allenai/allennlp) (👨‍💻 260 · 🔀 2.2K · 📥 54 · 📦 3.4K · 📋 2.6K - 3% open · ⏱️ 22.11.2022):

	```
	git clone https://github.com/allenai/allennlp
	```
- [PyPi](https://pypi.org/project/allennlp) (📥 68K / month):
	```
...
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥇35 ·  ⭐ 7.9K) - Haystack is an open source NLP framework to interact with your data.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 170 · 🔀 1.1K · 📥 20 · 📦 620 · 📋 2.1K - 14% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/google/sentencepiece">sentencepiece</a></b> (🥇35 ·  ⭐ 7K) - Unsupervised text tokenizer for Neural Network-based text.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 75 · 🔀 880 · 📥 26K · 📦 26K · 📋 590 - 4% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/sentencepiece) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sentencepiece) (📥 390K · ⏱️ 15.02.2023):
	```
	conda install -c conda-forge sentencepiece
	```
</details>
<details><summary><b><a href="https://github.com/UKPLab/sentence-transformers">sentence-transformers</a></b> (🥈34 ·  ⭐ 9.9K) - Multilingual Sentence & Image Embeddings with BERT. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/UKPLab/sentence-transformers) (👨‍💻 110 · 🔀 1.9K · 📦 7K · 📋 1.7K - 53% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/sentence-transformers) (📥 1.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sentence-transformers) (📥 98K · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 36 · 🔀 1.1K · 📥 100 · 📦 28K · 📋 260 - 39% open · ⏱️ 11.03.2023):
...
- [GitHub](https://github.com/tensorflow/text) (👨‍💻 100 · 🔀 270 · 📦 5K · 📋 200 - 22% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/facebookresearch/ParlAI) (👨‍💻 210 · 🔀 1.9K · 📦 180 · 📋 1.5K - 4% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/huggingface/tokenizers">Tokenizers</a></b> (🥈33 ·  ⭐ 6.7K) - Fast State-of-the-Art Tokenizers optimized for Research and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 67 · 🔀 550 · 📦 56 · 📋 740 - 31% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/tokenizers) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tokenizers) (📥 970K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/OpenNMT/OpenNMT-py) (👨‍💻 190 · 🔀 2K · 📦 180 · 📋 1.4K - 1% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/NVIDIA/NeMo">NeMo</a></b> (🥈32 ·  ⭐ 6.2K) - NeMo: a toolkit for conversational AI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/NVIDIA/NeMo) (👨‍💻 210 · 🔀 1.4K · 📥 32K · 📋 1.5K - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 31K / month):
	```
...
- [GitHub](https://github.com/jamesturk/jellyfish) (👨‍💻 29 · 🔀 150 · 📦 5.6K · 📋 120 - 3% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/jellyfish) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jellyfish) (📥 520K · ⏱️ 28.10.2022):
	```
	conda install -c conda-forge jellyfish
	```
</details>
<details><summary><b><a href="https://github.com/deeppavlov/DeepPavlov">DeepPavlov</a></b> (🥈31 ·  ⭐ 6.1K) - An open source library for deep learning end-to-end dialog.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 69 · 🔀 490 · 📦 270 · 📋 790 - 7% open · ⏱️ 17.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/dedupe) (📥 130K / month):
	```
	pip install dedupe
	```
- [Conda](https://anaconda.org/conda-forge/dedupe) (📥 27K · ⏱️ 12.12.2022):
	```
...
- [GitHub](https://github.com/pytorch/text) (👨‍💻 150 · 🔀 760 · 📋 740 - 32% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/argilla-io/argilla">rubrix</a></b> (🥈30 ·  ⭐ 1.8K · 📈) - Argilla: Open-source platform empowering teams to build better.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/argilla-io/argilla) (👨‍💻 45 · 🔀 160 · 📦 99 · 📋 990 - 19% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/rubrix) (📥 1.3K / month):
	...
	pip install rubrix
	```
- [Conda](https://anaconda.org/conda-forge/rubrix) (📥 19K · ⏱️ 06.10.2022):
	```
	conda install -c conda-forge rubrix
	```
</details>
<details><summary><b><a href="https://github.com/explosion/spacy-transformers">spacy-transformers</a></b> (🥈30 ·  ⭐ 1.2K) - Use pretrained transformers like BERT, XLNet and GPT-2.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>spacy</code></summary>

- [GitHub](https://github.com/explosion/spacy-transformers) (👨‍💻 21 · 🔀 150 · 📦 930 · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/spacy-transformers) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spacy-transformers) (📥 11K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/makcedward/nlpaug) (👨‍💻 33 · 🔀 420 · 📦 660 · 📋 210 - 27% open · ⏱️ 07.07.2022):
...
- [PyPi](https://pypi.org/project/nlpaug) (📥 160K / month):
	...
	pip install nlpaug
	```
- [Conda](https://anaconda.org/conda-forge/nlpaug) (📥 8.1K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 10K · 📋 130 - 9% open · ⏱️ 25.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/ftfy) (📥 5.2M / month):
	```
	pip install ftfy
	```
...
- [GitHub](https://github.com/dmlc/gluon-nlp) (👨‍💻 84 · 🔀 500 · 📦 1.2K · 📋 530 - 44% open · ⏱️ 25.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/gluonnlp) (📥 180K / month):
	```
...
- [GitHub](https://github.com/fastnlp/fastNLP) (👨‍💻 62 · 🔀 440 · 📥 67 · 📦 130 · 📋 210 - 26% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/fastnlp/fastNLP
	```
- [PyPi](https://pypi.org/project/fastnlp) (📥 12K / month):
	```
	pip install fastnlp
	```
</details>
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 27 · 🔀 180 · 📦 650 · 📋 280 - 9% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/Ciphey/Ciphey) (👨‍💻 46 · 🔀 760 · 📋 300 - 14% open · ⏱️ 05.12.2022):
...
<details><summary><b><a href="https://github.com/google-research/text-to-text-transfer-transformer">T5</a></b> (🥈26 ·  ⭐ 5K) - Code for the paper Exploring the Limits of Transfer Learning with a.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 54 · 🔀 660 · 📦 160 · 📋 400 - 13% open · ⏱️ 30.03.2023):
...
<details><summary><b><a href="https://github.com/life4/textdistance">TextDistance</a></b> (🥈26 ·  ⭐ 3.1K · 💤) - Compute distance between sequences. 30+ algorithms, pure.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/JasonKessler/scattertext) (👨‍💻 13 · 🔀 270 · 📦 360 · 📋 94 - 19% open · ⏱️ 30.03.2023):
...
- [PyPi](https://pypi.org/project/scattertext) (📥 9.7K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scattertext) (📥 76K · ⏱️ 08.12.2022):
	```
...
- [GitHub](https://github.com/DerwenAI/pytextrank) (👨‍💻 18 · 🔀 310 · 📦 370 · 📋 91 - 20% open · ⏱️ 27.07.2022):
...
- [GitHub](https://github.com/cjhutto/vaderSentiment) (👨‍💻 11 · 🔀 930 · 📦 6.4K · 📋 120 - 33% open · ⏱️ 01.04.2022):

	```
	git clone https://github.com/cjhutto/vaderSentiment
	```
- [PyPi](https://pypi.org/project/vadersentiment) (📥 240K / month):
	```
...
<details><summary><b><a href="https://github.com/thunlp/OpenPrompt">OpenPrompt</a></b> (🥉25 ·  ⭐ 2.9K) - An Open-Source Framework for Prompt-Learning. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/thunlp/OpenPrompt) (👨‍💻 19 · 🔀 330 · 📦 37 · 📋 210 - 22% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 18 · 🔀 230 · 📥 51K · 📦 240 · 📋 110 - 18% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/snowballstem/snowball) (👨‍💻 30 · 🔀 160 · 📦 4 · 📋 67 - 25% open · ⏱️ 16.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/snowballstemmer) (📥 9.1M / month):
	```
	pip install snowballstemmer
	```
- [Conda](https://anaconda.org/conda-forge/snowballstemmer) (📥 6.3M · ⏱️ 17.11.2021):
	```
	conda install -c conda-forge snowballstemmer
	```
</details>
<details><summary><b><a href="https://github.com/qdrant/qdrant">qdrant</a></b> (🥉24 ·  ⭐ 5.6K) - Qdrant - Vector Search Engine and Database for the next generation of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/qdrant/qdrant) (👨‍💻 36 · 🔀 250 · 📋 430 - 11% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/qdrant/qdrant
	```
</details>
<details><summary><b><a href="https://github.com/unitaryai/detoxify">detoxify</a></b> (🥉24 ·  ⭐ 590) - Trained models & code to predict toxic comments on all 3 Jigsaw.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unitaryai/detoxify) (👨‍💻 9 · 🔀 78 · 📥 180K · 📦 260 · 📋 48 - 56% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/unitaryai/detoxify
	```
- [PyPi](https://pypi.org/project/detoxify) (📥 52K / month):
	```
...
- [PyPi](https://pypi.org/project/farm) (📥 4.2K / month):
	...
	pip install farm
	```
- [Conda](https://anaconda.org/conda-forge/farm) (📥 2.3K · ⏱️ 14.06.2021):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 59 · 🔀 310 · 📥 16 · 📋 300 - 0% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/VKCOM/YouTokenToMe) (👨‍💻 8 · 🔀 69 · 📦 400 · 📋 54 - 55% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/youtokentome) (📥 27K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/youtokentome) (📥 27K · ⏱️ 30.10.2022):
	```
	conda install -c conda-forge youtokentome
	```
</details>
<details><summary><b><a href="https://github.com/EricFillion/happy-transformer">happy-transformer</a></b> (🥉22 ·  ⭐ 410) - A package built on top of Hugging Faces transformers.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/EricFillion/happy-transformer) (👨‍💻 14 · 🔀 51 · 📦 130 · 📋 120 - 20% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/EricFillion/happy-transformer
	```
- [PyPi](https://pypi.org/project/happytransformer) (📥 12K / month):
	```
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 20 · 🔀 75 · 📦 9 · 📋 140 - 16% open · ⏱️ 29.03.2023):
...
<details><summary><b><a href="https://github.com/RUCAIBox/TextBox">TextBox</a></b> (🥉19 ·  ⭐ 940) - TextBox 2.0 is a text generation library with pre-trained language models. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/RUCAIBox/TextBox) (👨‍💻 18 · 🔀 100 · 📦 5 · 📋 47 - 4% open · ⏱️ 27.03.2023):
...
<details><summary><b><a href="https://github.com/dsfsi/textaugment">textaugment</a></b> (🥉19 ·  ⭐ 310) - TextAugment: Text Augmentation Library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dsfsi/textaugment) (👨‍💻 7 · 🔀 55 · 📥 55 · 📦 46 · 📋 19 - 31% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/thunlp/OpenNRE) (👨‍💻 12 · 🔀 970 · 📋 360 - 1% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/Ki6an/fastT5) (👨‍💻 5 · 🔀 52 · 📦 29 · 📋 58 - 31% open · ⏱️ 05.04.2022):
...
- <b><a href="https://github.com/chartbeat-labs/textacy">textacy</a></b> (🥈32 ·  ⭐ 2K) - NLP, before and after spaCy. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/nipunsadvilkar/pySBD">pySBD</a></b> (🥉23 ·  ⭐ 600 · 💀) - pySBD (Python Sentence Boundary Disambiguation) is a rule-based sentence.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/mchaput/whoosh">whoosh</a></b> (🥉17 ·  ⭐ 380 · 💀) - Pure-Python full-text search library. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/MartinoMensio/spacy-dbpedia-spotlight">spacy-dbpedia-spotlight</a></b> (🥉16 ·  ⭐ 85) - A spaCy wrapper for DBpedia Spotlight. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>spacy</code>
...
- [GitHub](https://github.com/Zulko/moviepy) (👨‍💻 160 · 🔀 1.3K · 📦 23K · 📋 1.3K - 22% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/Zulko/moviepy
	```
- [PyPi](https://pypi.org/project/moviepy) (📥 7.1M / month):
	```
	pip install moviepy
	```
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 99 · 🔀 250 · 📥 560 · 📦 85K · 📋 530 - 13% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/imageio) (📥 21M / month):
	...
	pip install imageio
	```
- [Conda](https://anaconda.org/conda-forge/imageio) (📥 4.6M · ⏱️ 27.03.2023):
	```
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 520 · 🔀 6.5K · 📥 22K · 📋 2.8K - 25% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/torchvision) (📥 5.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/torchvision) (📥 600K · ⏱️ 09.03.2023):
	```
	conda install -c conda-forge torchvision
	```
</details>
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥇36 ·  ⭐ 8K) - Differentiable Computer Vision Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/kornia/kornia) (👨‍💻 220 · 🔀 800 · 📥 580 · 📦 3.6K · 📋 730 - 28% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/kornia) (📥 2.6M / month):
	...
	pip install kornia
	```
- [Conda](https://anaconda.org/conda-forge/kornia) (📥 71K · ⏱️ 29.03.2023):
	```
...
- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 130 · 🔀 1.5K · 📦 13K · 📋 750 - 44% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/albumentations-team/albumentations
	```
- [PyPi](https://pypi.org/project/albumentations) (📥 670K / month):
	```
	pip install albumentations
	```
- [Conda](https://anaconda.org/conda-forge/albumentations) (📥 100K · ⏱️ 20.09.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 240 · 🔀 6.3K · 📦 1K · 📋 3.3K - 8% open · ⏱️ 31.03.2023):
...
- [PyPi](https://pypi.org/project/detectron2):
	...
	```
- [Conda](https://anaconda.org/conda-forge/detectron2) (📥 140K · ⏱️ 22.01.2023):
	```
...
- [GitHub](https://github.com/open-mmlab/mmdetection) (👨‍💻 390 · 🔀 7.7K · 📋 6.8K - 7% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 140 · 🔀 2.5K · 📦 62 · 📋 4.6K - 18% open · ⏱️ 28.03.2023):
...
<details><summary><b><a href="https://github.com/huggingface/pytorch-image-models">PyTorch Image Models</a></b> (🥈33 ·  ⭐ 25K) - PyTorch image models, scripts, pretrained weights --.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/pytorch-image-models) (👨‍💻 96 · 🔀 4K · 📥 3.8M · 📋 700 - 9% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/timm) (📥 3.2M / month):
	...
	pip install timm
	```
- [Conda](https://anaconda.org/conda-forge/timm) (📥 58K · ⏱️ 26.03.2023):
	```
	conda install -c conda-forge timm
	```
</details>
<details><summary><b><a href="https://github.com/deepinsight/insightface">InsightFace</a></b> (🥈33 ·  ⭐ 14K) - State-of-the-art 2D and 3D Face Analysis Project. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 53 · 🔀 4.1K · 📥 300 · 📦 280 · 📋 2.1K - 56% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleSeg">PaddleSeg</a></b> (🥈32 ·  ⭐ 6.7K) - Easy-to-use image segmentation library with awesome pre-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 96 · 🔀 1.4K · 📦 850 · 📋 1.6K - 11% open · ⏱️ 27.02.2023):
...
<details><summary><b><a href="https://github.com/serengil/deepface">deepface</a></b> (🥈31 ·  ⭐ 6K) - A Lightweight Face Recognition and Facial Attribute Analysis (Age, Gender,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/serengil/deepface) (👨‍💻 37 · 🔀 1.2K · 📦 1.2K · 📋 640 - 1% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 25 · 🔀 320 · 📦 8.4K · 📋 120 - 5% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/OlafenwaMoses/ImageAI) (👨‍💻 17 · 🔀 2K · 📥 840K · 📦 1.3K · 📋 710 - 38% open · ⏱️ 03.03.2023):
...
- [PyPi](https://pypi.org/project/imageai) (📥 9K / month):
	...
	pip install imageai
	```
- [Conda](https://anaconda.org/conda-forge/imageai) (📥 5.2K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 17 · 🔀 2.2K · 📦 220 · 📋 220 - 46% open · ⏱️ 19.03.2023):
...
- [GitHub](https://github.com/obss/sahi) (👨‍💻 27 · 🔀 380 · 📥 14K · 📦 350 · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/sahi) (📥 100K / month):
	...
	pip install sahi
	```
- [Conda](https://anaconda.org/conda-forge/sahi) (📥 32K · ⏱️ 25.03.2023):
	```
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 26 · 🔀 190 · 📦 100 · 📋 360 - 10% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/lightly-ai/lightly
	```
- [PyPi](https://pypi.org/project/lightly) (📥 4.9K / month):
	```
	pip install lightly
	```
</details>
<details><summary><b><a href="https://github.com/timesler/facenet-pytorch">facenet-pytorch</a></b> (🥉28 ·  ⭐ 3.4K) - Pretrained Pytorch face detection (MTCNN) and facial.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/timesler/facenet-pytorch) (👨‍💻 15 · 🔀 740 · 📥 590K · 📦 1.1K · 📋 160 - 41% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 43 · 🔀 650 · 📋 650 - 11% open · ⏱️ 16.03.2023):

	```
	git clone https://github.com/opencv/opencv-python
	```
- [PyPi](https://pypi.org/project/opencv-python) (📥 8.4M / month):
	```
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 24 · 🔀 180 · 📥 250 · 📦 100 · 📋 120 - 1% open · ⏱️ 09.02.2023):
...
<details><summary><b><a href="https://github.com/dmlc/gluon-cv">GluonCV</a></b> (🥉26 ·  ⭐ 5.5K · 📉) - Gluon CV Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥉26 ·  ⭐ 2.7K) - A High-performance cross-platform Video Processing Python framework.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 110 · 🔀 870 · 📦 14 · 📋 640 - 15% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/mdbloice/Augmentor) (👨‍💻 23 · 🔀 840 · 📦 570 · 📋 190 - 61% open · ⏱️ 29.03.2023):
...
<details><summary><b><a href="https://github.com/Layout-Parser/layout-parser">layout-parser</a></b> (🥉25 ·  ⭐ 3.6K · 💤) - A Unified Toolkit for Deep Learning Based Document Image.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Layout-Parser/layout-parser) (👨‍💻 8 · 🔀 350 · 📦 180 · 📋 120 - 56% open · ⏱️ 06.08.2022):

	```
	git clone https://github.com/Layout-Parser/layout-parser
	```
- [PyPi](https://pypi.org/project/layoutparser) (📥 42K / month):
	```
	pip install layoutparser
	```
</details>
<details><summary><b><a href="https://github.com/idealo/imagededup">Image Deduplicator</a></b> (🥉24 ·  ⭐ 4.5K) - Finding duplicate images made easy!. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/idealo/imagededup) (👨‍💻 14 · 🔀 400 · 📦 37 · 📋 100 - 21% open · ⏱️ 31.03.2023):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉24 ·  ⭐ 500) - python binding for libvips using cffi. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookresearch/vissl) (👨‍💻 34 · 🔀 310 · 📦 15 · 📋 170 - 37% open · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/vissl) (📥 430 / month):
	```
	pip install vissl
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 50 · 🔀 330 · 📋 160 - 39% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/facebookresearch/ClassyVision) (👨‍💻 77 · 🔀 270 · 📋 77 - 16% open · ⏱️ 23.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/classy_vision) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/pycls) (👨‍💻 17 · 🔀 230 · 📦 10 · 📋 79 - 29% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/pycls) (📥 110K / month):
	```
	pip install pycls
	```
</details>
<details><summary><b><a href="https://github.com/airctic/icevision">icevision</a></b> (🥉21 ·  ⭐ 810) - An Agnostic Computer Vision Framework - Pluggable to any Training.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/google-research/scenic">scenic</a></b> (🥉19 ·  ⭐ 2K) - Scenic: A Jax Library for Computer Vision Research and Beyond. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/google-research/scenic) (👨‍💻 62 · 🔀 280 · 📋 130 - 50% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/google-research/scenic
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/SlowFast">PySlowFast</a></b> (🥉17 ·  ⭐ 5.6K) - PySlowFast: video understanding codebase from FAIR for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 29 · 🔀 1.1K · 📋 600 - 54% open · ⏱️ 12.01.2023):
...
- <b><a href="https://github.com/facebookresearch/pytorch3d">PyTorch3D</a></b> (🥈29 ·  ⭐ 7.1K) - PyTorch3D is FAIRs library of reusable components for.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/jasmcaus/caer">Caer</a></b> (🥉18 ·  ⭐ 680 · 💀) - A lightweight Computer Vision library. Scale your models, not boilerplate. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/nicolas-chaulet/torch-points3d">Torch Points 3D</a></b> (🥉15 ·  ⭐ 140 · 💀) - Pytorch framework for doing deep learning on point.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/qanastek/HugsVision">HugsVision</a></b> (🥉12 ·  ⭐ 180) - HugsVision is a easy to use huggingface wrapper for state-of-the-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>huggingface</code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/dmlc/dgl">dgl</a></b> (🥇38 ·  ⭐ 11K) - Python package built to ease deep learning on graph, on top of existing DL.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 260 · 🔀 2.7K · 📦 72 · 📋 2.1K - 13% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/dmlc/dgl
	```
- [PyPi](https://pypi.org/project/dgl) (📥 60K / month):
	```
	pip install dgl
	```
</details>
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 400 · 🔀 3.1K · 📋 3K - 22% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/pyg-team/pytorch_geometric
	```
- [PyPi](https://pypi.org/project/torch-geometric) (📥 180K / month):
	```
	pip install torch-geometric
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_geometric) (📥 20K · ⏱️ 04.01.2023):
	```
	conda install -c conda-forge pytorch_geometric
	```
</details>
<details><summary><b><a href="https://github.com/snap-stanford/ogb">ogb</a></b> (🥈29 ·  ⭐ 1.6K) - Benchmark datasets, data loaders, and evaluators for graph machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 25 · 🔀 370 · 📦 720 · 📋 250 - 3% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/ogb) (📥 37K / month):
	...
	pip install ogb
	```
- [Conda](https://anaconda.org/conda-forge/ogb) (📥 21K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/Accenture/AmpliGraph) (👨‍💻 20 · 🔀 230 · 📦 31 · 📋 210 - 14% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/PaddlePaddle/PGL) (👨‍💻 29 · 🔀 300 · 📦 39 · 📋 180 - 35% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/PaddlePaddle/PGL
	```
- [PyPi](https://pypi.org/project/pgl) (📥 4.1K / month):
	```
	pip install pgl
	```
</details>
...
- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 35 · 🔀 160 · 📥 150 · 📋 480 - 16% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 31 · 🔀 190 · 📦 85 · 📋 260 - 47% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/eliorc/node2vec) (👨‍💻 11 · 🔀 220 · 📦 380 · 📋 85 - 2% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 26 · 🔀 290 · 📋 150 - 16% open · ⏱️ 18.02.2023):
...
- [GitHub](https://github.com/graph4ai/graph4nlp) (👨‍💻 28 · 🔀 190 · 📋 170 - 2% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/graph4nlp) (📥 83 / month):
	```
...
- [GitHub](https://github.com/deepmind/jraph) (👨‍💻 17 · 🔀 71 · 📦 67 · 📋 33 - 21% open · ⏱️ 31.08.2022):

	```
	git clone https://github.com/deepmind/jraph
	```
- [PyPi](https://pypi.org/project/jraph) (📥 7.3K / month):
	```
	pip install jraph
	```
- [Conda](https://anaconda.org/conda-forge/jraph) (📥 1.7K · ⏱️ 31.03.2023):
	```
	conda install -c conda-forge jraph
	```
</details>
<details><summary><b><a href="https://github.com/rusty1s/pytorch_cluster">torch-cluster</a></b> (🥉21 ·  ⭐ 630) - PyTorch Extension Library of Optimized Graph Cluster.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/torch-cluster) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_cluster) (📥 56K · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/snap-stanford/deepsnap) (👨‍💻 17 · 🔀 49 · 📥 8 · 📦 45 · 📋 42 - 42% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/snap-stanford/deepsnap
	```
- [PyPi](https://pypi.org/project/deepsnap) (📥 710 / month):
	```
...
- [GitHub](https://github.com/shenweichen/GraphEmbedding) (👨‍💻 9 · 🔀 920 · 📦 23 · 📋 63 - 60% open · ⏱️ 21.06.2022):

	```
	git clone https://github.com/shenweichen/GraphEmbedding
	```
</details>
<details><summary><b><a href="https://github.com/THUMNLab/AutoGL">AutoGL</a></b> (🥉16 ·  ⭐ 910) - An autoML framework & toolkit for machine learning on graphs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/vaticle/typedb-ml) (👨‍💻 11 · 🔀 93 · 📥 210 · 📋 62 - 17% open · ⏱️ 09.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/grakn-kglib) (📥 77 / month):
	```
...
- <b><a href="https://github.com/divelab/DIG">DIG</a></b> (🥉22 ·  ⭐ 1.4K) - A library for graph deep learning research. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
<details><summary><b><a href="https://github.com/espnet/espnet">espnet</a></b> (🥇37 ·  ⭐ 6.3K) - End-to-End Speech Processing Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/espnet/espnet) (👨‍💻 340 · 🔀 1.8K · 📥 77 · 📦 140 · 📋 2.1K - 18% open · ⏱️ 01.04.2023):
...
<details><summary><b><a href="https://github.com/speechbrain/speechbrain">speechbrain</a></b> (🥇35 ·  ⭐ 5.6K) - A PyTorch-based Speech Toolkit. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 200 · 🔀 1K · 📦 580 · 📋 860 - 11% open · ⏱️ 29.03.2023):

	```
	git clone https://github.com/speechbrain/speechbrain
	```
- [PyPi](https://pypi.org/project/speechbrain) (📥 74K / month):
	```
	pip install speechbrain
	```
</details>
<details><summary><b><a href="https://github.com/jiaaro/pydub">Pydub</a></b> (🥇34 ·  ⭐ 7K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/deezer/spleeter) (👨‍💻 19 · 🔀 2.4K · 📥 2.2M · 📦 480 · 📋 720 - 23% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/spleeter) (📥 17K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spleeter) (📥 74K · ⏱️ 30.06.2020):
	```
...
<details><summary><b><a href="https://github.com/coqui-ai/TTS">Coqui TTS</a></b> (🥈31 ·  ⭐ 10K) - - a deep learning toolkit for Text-to-Speech, battle-.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/coqui-ai/TTS) (👨‍💻 120 · 🔀 1.1K · 📥 680K · 📋 540 - 4% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/tts) (📥 23K / month):
	...
	pip install tts
	```
- [Conda](https://anaconda.org/conda-forge/tts) (📥 7.1K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 200 · 🔀 520 · 📋 760 - 21% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 1M / month):
	```
	pip install torchaudio
	```
</details>
<details><summary><b><a href="https://github.com/bastibe/python-soundfile">python-soundfile</a></b> (🥈31 ·  ⭐ 530 · 📈) - SoundFile is an audio library based on libsndfile, CFFI,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 30 · 🔀 84 · 📥 14K · 📦 19K · 📋 200 - 38% open · ⏱️ 24.03.2023):
...
<details><summary><b><a href="https://github.com/Uberi/speech_recognition">SpeechRecognition</a></b> (🥈29 ·  ⭐ 7K) - Speech recognition module for Python, supporting several.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥈28 ·  ⭐ 5.8K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>
...
<details><summary><b><a href="https://github.com/iver56/audiomentations">audiomentations</a></b> (🥉27 ·  ⭐ 1.3K) - A Python library for audio data augmentation. Inspired by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/iver56/audiomentations) (👨‍💻 24 · 🔀 160 · 📦 230 · 📋 150 - 25% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/iver56/audiomentations
	```
- [PyPi](https://pypi.org/project/audiomentations) (📥 8K / month):
	```
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 34 · 🔀 410 · 📦 15 · 📋 430 - 0% open · ⏱️ 15.03.2023):

	```
	git clone https://github.com/Picovoice/Porcupine
	```
- [PyPi](https://pypi.org/project/pvporcupine) (📥 2.5K / month):
	```
	pip install pvporcupine
	```
</details>
<details><summary><b><a href="https://github.com/magenta/ddsp">DDSP</a></b> (🥉23 ·  ⭐ 2.5K) - DDSP: Differentiable Digital Signal Processing. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/magenta/ddsp) (👨‍💻 32 · 🔀 280 · 📦 39 · 📋 150 - 22% open · ⏱️ 22.12.2022):
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉23 ·  ⭐ 590) - Read audio and music meta data and duration of MP3, OGG, OPUS, MP4, M4A,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/KinWaiCheuk/nnAudio">nnAudio</a></b> (🥉22 ·  ⭐ 820) - Audio processing by using pytorch 1D convolution network. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/KinWaiCheuk/nnAudio) (👨‍💻 14 · 🔀 82 · 📦 87 · 📋 59 - 28% open · ⏱️ 28.03.2023):
...
<details><summary><b><a href="https://github.com/adefossez/julius">Julius</a></b> (🥉17 ·  ⭐ 330 · 💤) - Fast PyTorch based DSP for audio and 1D signals. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/adefossez/julius) (👨‍💻 2 · 🔀 20 · 📦 290 · ⏱️ 19.09.2022):

	```
	git clone https://github.com/adefossez/julius
	```
- [PyPi](https://pypi.org/project/julius) (📥 94K / month):
	```
	pip install julius
	```
</details>
...
- <b><a href="https://github.com/mozilla/TTS">TTS</a></b> (🥉22 ·  ⭐ 7K · 💀) - Deep learning for Text to Speech (Discussion forum:.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code>
...
- <b><a href="https://github.com/worldveil/dejavu">Dejavu</a></b> (🥉19 ·  ⭐ 6K · 💀) - Audio fingerprinting and recognition in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 220 · 🔀 1.9K · 📦 5.6K · 📋 2.6K - 6% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pydeck) (📥 1.2M / month):
	...
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 330K · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 150 · 🔀 2.1K · 📦 23K · 📋 990 - 4% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/geopandas/geopandas">GeoPandas</a></b> (🥇38 ·  ⭐ 3.6K) - Python tools for geographic data. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 190 · 🔀 770 · 📥 1.8K · 📦 21K · 📋 1.4K - 23% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/geopandas) (📥 3.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/geopandas) (📥 2.7M · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 140 · 🔀 510 · 📥 920 · 📦 43K · 📋 1K - 18% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/shapely) (📥 11M / month):
	...
	pip install shapely
	```
- [Conda](https://anaconda.org/conda-forge/shapely) (📥 6.4M · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 68 · 🔀 190 · 📦 12K · 📋 730 - 4% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/fiona) (📥 4M / month):
	...
	pip install fiona
	```
- [Conda](https://anaconda.org/conda-forge/fiona) (📥 4.3M · ⏱️ 20.03.2023):
	```
	conda install -c conda-forge fiona
	```
</details>
<details><summary><b><a href="https://github.com/pyproj4/pyproj">pyproj</a></b> (🥈36 ·  ⭐ 870) - Python interface to PROJ (cartographic projections and coordinate.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyproj4/pyproj) (👨‍💻 58 · 🔀 190 · 📦 20K · 📋 550 - 3% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/pyproj) (📥 5.8M / month):
	...
	pip install pyproj
	```
- [Conda](https://anaconda.org/conda-forge/pyproj) (📥 5.6M · ⏱️ 29.03.2023):
	```
	conda install -c conda-forge pyproj
	```
</details>
<details><summary><b><a href="https://github.com/jupyter-widgets/ipyleaflet">ipyleaflet</a></b> (🥈31 ·  ⭐ 1.3K) - A Jupyter - Leaflet.js bridge. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 82 · 🔀 320 · 📦 4K · 📋 550 - 39% open · ⏱️ 10.02.2023):
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 86 · 🔀 990 · 📥 7.7K · 📋 540 - 6% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/arcgis) (📥 60K / month):
	...
	pip install arcgis
	```
- [Docker Hub](https://hub.docker.com/r/esridocker/arcgis-api-python-notebook) (📥 8.8K · ⭐ 40 · ⏱️ 17.06.2022):
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 52 · 🔀 110 · 📦 12K · 📋 90 - 22% open · ⏱️ 16.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/geojson) (📥 960K / month):
	```
	pip install geojson
	```
- [Conda](https://anaconda.org/conda-forge/geojson) (📥 680K · ⏱️ 16.02.2023):
	```
...
<details><summary><b><a href="https://github.com/holoviz/geoviews">GeoViews</a></b> (🥉26 ·  ⭐ 470) - Simple, concise geographical visualization in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 28 · 🔀 66 · 📦 620 · 📋 310 - 34% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/holoviz/geoviews
	```
- [PyPi](https://pypi.org/project/geoviews) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/geospace-code/pymap3d) (👨‍💻 14 · 🔀 77 · 📦 250 · 📋 46 - 4% open · ⏱️ 05.03.2023):
...
- [PyPi](https://pypi.org/project/pymap3d) (📥 79K / month):
	...
	pip install pymap3d
	```
- [Conda](https://anaconda.org/conda-forge/pymap3d) (📥 47K · ⏱️ 05.03.2023):
	```
...
- <b><a href="https://github.com/sentinelsat/sentinelsat">Sentinelsat</a></b> (🥉29 ·  ⭐ 870) - Search and download Copernicus Sentinel satellite images. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
- <b><a href="https://github.com/earthlab/earthpy">EarthPy</a></b> (🥉26 ·  ⭐ 430 · 💀) - A package built to support working with spatial data using open.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/marceloprates/prettymaps">prettymaps</a></b> (🥉24 ·  ⭐ 9.4K · 📈) - A small set of Python functions to draw pretty maps from.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
<details><summary><b><a href="https://github.com/ranaroussi/yfinance">yfinance</a></b> (🥇39 ·  ⭐ 9.3K) - Download market data from Yahoo! Finances API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ranaroussi/yfinance) (👨‍💻 78 · 🔀 1.8K · 📦 21K · 📋 1K - 20% open · ⏱️ 25.03.2023):

	```
	git clone https://github.com/ranaroussi/yfinance
	```
- [PyPi](https://pypi.org/project/yfinance) (📥 780K / month):
	```
	pip install yfinance
	```
- [Conda](https://anaconda.org/ranaroussi/yfinance) (📥 74K · ⏱️ 10.07.2021):
	```
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 110 · 🔀 1.9K · 📥 340 · 📋 700 - 25% open · ⏱️ 03.04.2023):
...
<details><summary><b><a href="https://github.com/bukosabino/ta">ta</a></b> (🥈29 ·  ⭐ 3.5K · 💤) - Technical Analysis Library using Pandas and Numpy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bukosabino/ta) (👨‍💻 29 · 🔀 760 · 📦 1.9K · 📋 200 - 51% open · ⏱️ 23.08.2022):
...
- [PyPi](https://pypi.org/project/ta) (📥 82K / month):
	...
	pip install ta
	```
- [Conda](https://anaconda.org/conda-forge/ta) (📥 13K · ⏱️ 23.08.2022):
	```
	conda install -c conda-forge ta
	```
</details>
<details><summary><b><a href="https://github.com/pmorissette/bt">bt</a></b> (🥈28 ·  ⭐ 1.6K) - bt - flexible backtesting for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/bt) (📥 7.4K / month):
	...
	pip install bt
	```
- [Conda](https://anaconda.org/conda-forge/bt) (📥 13K · ⏱️ 12.11.2022):
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 29 · 🔀 240 · 📦 300 · 📋 110 - 18% open · ⏱️ 21.12.2022):
...
- [PyPi](https://pypi.org/project/ffn) (📥 170K / month):
	...
	pip install ffn
	```
- [Conda](https://anaconda.org/conda-forge/ffn) (📥 3K · ⏱️ 22.04.2021):
	```
	conda install -c conda-forge ffn
	```
</details>
<details><summary><b><a href="https://github.com/tensortrade-org/tensortrade">TensorTrade</a></b> (🥉24 ·  ⭐ 4.1K · 💤) - An open source reinforcement learning framework for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/tensortrade) (📥 500 / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensortrade) (📥 2.4K · ⏱️ 10.05.2021):
	```
...
- [GitHub](https://github.com/RomelTorres/alpha_vantage) (👨‍💻 42 · 🔀 660 · 📋 260 - 1% open · ⏱️ 25.12.2022):
...
- [PyPi](https://pypi.org/project/alpha_vantage) (📥 23K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alpha_vantage) (📥 3.1K · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/erdewit/ib_insync) (👨‍💻 35 · 🔀 540 · 📋 470 - 0% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/ib_insync) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ib-insync) (📥 28K · ⏱️ 03.01.2023):
	```
	conda install -c conda-forge ib-insync
	```
</details>
<details><summary><b><a href="https://github.com/gbeced/pyalgotrade">PyAlgoTrade</a></b> (🥉23 ·  ⭐ 4K) - Python Algorithmic Trading Library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gbeced/pyalgotrade) (👨‍💻 11 · 🔀 1.3K · 📦 130 · 📋 120 - 32% open · ⏱️ 05.03.2023):

	```
	git clone https://github.com/gbeced/pyalgotrade
	```
- [PyPi](https://pypi.org/project/pyalgotrade) (📥 1.1K / month):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 45 · 🔀 480 · 📋 50 - 44% open · ⏱️ 20.03.2023):
...
<details><summary><b><a href="https://github.com/cuemacro/finmarketpy">finmarketpy</a></b> (🥉19 ·  ⭐ 3.1K) - Python library for backtesting trading strategies & analyzing.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/cuemacro/finmarketpy) (👨‍💻 14 · 🔀 450 · 📥 44 · 📦 8 · 📋 27 - 88% open · ⏱️ 20.12.2022):
...
- <b><a href="https://github.com/bashtage/arch">arch</a></b> (🥈27 ·  ⭐ 1.1K) - ARCH models in Python. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/kernc/backtesting.py">Backtesting.py</a></b> (🥉19 ·  ⭐ 3.5K) - Backtest trading strategies in Python. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
- <b><a href="https://github.com/fmilthaler/FinQuant">FinQuant</a></b> (🥉18 ·  ⭐ 930 · 💀) - A program for financial portfolio management, analysis and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/sktime/sktime) (👨‍💻 240 · 🔀 1K · 📥 78 · 📦 1K · 📋 1.6K - 34% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/sktime) (📥 810K / month):
	...
	pip install sktime
	```
- [Conda](https://anaconda.org/conda-forge/sktime-all-extras) (📥 340K · ⏱️ 24.02.2023):
	```
...
- [PyPi](https://pypi.org/project/fbprophet) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prophet) (📥 490K · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/ourownstory/neural_prophet) (👨‍💻 37 · 🔀 390 · 📦 200 · 📋 430 - 17% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 22 · 🔀 220 · 📦 4.9K · 📋 300 - 12% open · ⏱️ 15.03.2023):

	```
	git clone https://github.com/alkaline-ml/pmdarima
	```
- [PyPi](https://pypi.org/project/pmdarima) (📥 1.9M / month):
	```
	pip install pmdarima
	```
- [Conda](https://anaconda.org/conda-forge/pmdarima) (📥 420K · ⏱️ 19.03.2023):
	```
	conda install -c conda-forge pmdarima
	```
</details>
<details><summary><b><a href="https://github.com/unit8co/darts">Darts</a></b> (🥈31 ·  ⭐ 5.7K) - A python library for user-friendly forecasting and anomaly detection.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/unit8co/darts) (👨‍💻 82 · 🔀 630 · 📦 220 · 📋 960 - 20% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/u8darts) (📥 14K / month):
	...
	pip install u8darts
	```
- [Conda](https://anaconda.org/conda-forge/u8darts-all) (📥 24K · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/TDAmeritrade/stumpy) (👨‍💻 32 · 🔀 250 · 📦 380 · 📋 400 - 12% open · ⏱️ 28.03.2023):
...
- [PyPi](https://pypi.org/project/stumpy) (📥 180K / month):
	...
	pip install stumpy
	```
- [Conda](https://anaconda.org/conda-forge/stumpy) (📥 380K · ⏱️ 31.03.2022):
	```
	conda install -c conda-forge stumpy
	```
</details>
<details><summary><b><a href="https://github.com/tslearn-team/tslearn">tslearn</a></b> (🥈31 ·  ⭐ 2.4K) - A machine learning toolkit dedicated to time-series data. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 41 · 🔀 310 · 📦 740 · 📋 280 - 34% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/tslearn-team/tslearn
	```
- [PyPi](https://pypi.org/project/tslearn) (📥 210K / month):
	```
	pip install tslearn
	```
- [Conda](https://anaconda.org/conda-forge/tslearn) (📥 670K · ⏱️ 20.01.2023):
	```
	conda install -c conda-forge tslearn
	```
</details>
<details><summary><b><a href="https://github.com/Nixtla/statsforecast">StatsForecast</a></b> (🥈30 ·  ⭐ 2.4K) - Lightning fast forecasting with statistical and econometric.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 20 · 🔀 160 · 📦 200 · 📋 150 - 39% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/Nixtla/statsforecast
	```
- [PyPi](https://pypi.org/project/statsforecast) (📥 350K / month):
	```
	pip install statsforecast
	```
- [Conda](https://anaconda.org/conda-forge/statsforecast) (📥 31K · ⏱️ 09.03.2023):
	```
	conda install -c conda-forge statsforecast
	```
</details>
<details><summary><b><a href="https://github.com/blue-yonder/tsfresh">tsfresh</a></b> (🥈29 ·  ⭐ 7.2K) - Automatic extraction of relevant features from time series:. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/tsfresh) (📥 250K / month):
	...
	pip install tsfresh
	```
- [Conda](https://anaconda.org/conda-forge/tsfresh) (📥 690K · ⏱️ 31.12.2022):
	```
...
- [GitHub](https://github.com/awslabs/gluonts) (👨‍💻 100 · 🔀 660 · 📋 840 - 30% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/gluonts) (📥 150K / month):
	...
	pip install gluonts
	```
- [Conda](https://anaconda.org/anaconda/gluonts) (📥 280 · ⏱️ 14.10.2021):
	```
...
- [GitHub](https://github.com/jdb78/pytorch-forecasting) (👨‍💻 33 · 🔀 460 · 📋 600 - 55% open · ⏱️ 17.11.2022):
...
- [PyPi](https://pypi.org/project/pytorch-forecasting) (📥 90K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-forecasting) (📥 40K · ⏱️ 23.05.2022):
	```
...
- [GitHub](https://github.com/johannfaouzi/pyts) (👨‍💻 13 · 🔀 150 · 📦 350 · 📋 71 - 54% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/streamz) (📥 16K / month):
	...
	pip install streamz
	```
- [Conda](https://anaconda.org/conda-forge/streamz) (📥 600K · ⏱️ 28.07.2022):
	```
	conda install -c conda-forge streamz
	```
</details>
<details><summary><b><a href="https://github.com/fraunhoferportugal/tsfel">TSFEL</a></b> (🥉23 ·  ⭐ 640) - An intuitive library to extract features from time series. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/fraunhoferportugal/tsfel) (👨‍💻 17 · 🔀 100 · 📦 77 · 📋 60 - 21% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 8 · 🔀 90 · 📦 17 · 📋 81 - 16% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/X-DataInitiative/tick) (👨‍💻 18 · 🔀 91 · 📥 250 · 📦 69 · 📋 230 - 27% open · ⏱️ 05.03.2023):
...
<details><summary><b><a href="https://github.com/AutoViML/Auto_TS">Auto TS</a></b> (🥉18 ·  ⭐ 560) - Automatically build ARIMA, SARIMAX, VAR, FB Prophet and XGBoost.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/Auto_TS) (👨‍💻 9 · 🔀 98 · 📋 80 - 7% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/AutoViML/Auto_TS
	```
- [PyPi](https://pypi.org/project/auto-ts) (📥 3.9K / month):
	```
	pip install auto-ts
	```
</details>
...
- [GitHub](https://github.com/dmbee/seglearn) (👨‍💻 14 · 🔀 64 · 📦 36 · 📋 29 - 17% open · ⏱️ 27.08.2022):
...
- <b><a href="https://github.com/Nixtla/neuralforecast">NeuralForecast</a></b> (🥉23 ·  ⭐ 1.3K) - Scalable and user friendly neural forecasting algorithms. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/arundo/adtk">ADTK</a></b> (🥉19 ·  ⭐ 930 · 💀) - A Python toolkit for rule-based/unsupervised anomaly detection in time.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code>
...
- <b><a href="https://github.com/arundo/tsaug">tsaug</a></b> (🥉13 ·  ⭐ 290 · 💀) - A Python package for time series augmentation. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
<details><summary><b><a href="https://github.com/mne-tools/mne-python">MNE</a></b> (🥇37 ·  ⭐ 2.2K) - MNE: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 340 · 🔀 1.1K · 📦 2.5K · 📋 4.4K - 10% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/mne) (📥 54K / month):
	...
	pip install mne
	```
- [Conda](https://anaconda.org/conda-forge/mne) (📥 280K · ⏱️ 24.02.2023):
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 150 · 🔀 760 · 📦 820 · 📋 2.4K - 11% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/Project-MONAI/MONAI
	```
- [PyPi](https://pypi.org/project/monai) (📥 90K / month):
	```
	pip install monai
	```
- [Conda](https://anaconda.org/conda-forge/monai) (📥 11K · ⏱️ 19.12.2022):
	```
	conda install -c conda-forge monai
	```
</details>
<details><summary><b><a href="https://github.com/hail-is/hail">Hail</a></b> (🥈33 ·  ⭐ 870) - Scalable genomic data analysis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/hail-is/hail) (👨‍💻 84 · 🔀 220 · 📦 94 · 📋 2K - 0% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 240 · 🔀 480 · 📦 1.4K · 📋 1.3K - 28% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/nipype) (📥 77K / month):
	...
	pip install nipype
	```
- [Conda](https://anaconda.org/conda-forge/nipype) (📥 550K · ⏱️ 06.11.2022):
	```
...
- [GitHub](https://github.com/google/deepvariant) (👨‍💻 26 · 🔀 660 · 📥 4.6K · 📋 570 - 0% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/google/deepvariant
	```
- [Conda](https://anaconda.org/bioconda/deepvariant) (📥 51K · ⏱️ 05.06.2022):
	```
	conda install -c bioconda deepvariant
	```
</details>
<details><summary><b><a href="https://github.com/nipy/nipy">NIPY</a></b> (🥉20 ·  ⭐ 330) - Neuroimaging in Python FMRI analysis package. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- <b><a href="https://github.com/nilearn/nilearn">Nilearn</a></b> (🥈33 ·  ⭐ 960) - Machine learning for NeuroImaging in Python. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/nipy/nibabel">NiBabel</a></b> (🥈32 ·  ⭐ 530) - Python package to access a cacophony of neuro-imaging file formats. <code>❗Unlicensed</code>
- <b><a href="https://github.com/dipy/dipy">DIPY</a></b> (🥈28 ·  ⭐ 590) - DIPY is the paragon 3D/4D+ imaging library in Python. Contains.. <code>❗Unlicensed</code>
...
<details><summary><b><a href="https://github.com/carefree0910/carefree-learn">carefree-learn</a></b> (🥇23 ·  ⭐ 390) - Deep Learning PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/carefree0910/carefree-learn) (🔀 31 · 📦 3 · ⏱️ 05.04.2023):

	```
	git clone https://github.com/carefree0910/carefree-learn
	```
- [PyPi](https://pypi.org/project/carefree-learn) (📥 1.4K / month):
	```
	pip install carefree-learn
	```
</details>
<details><summary><b><a href="https://github.com/manujosephv/pytorch_tabular">pytorch_tabular</a></b> (🥈21 ·  ⭐ 870) - A standard framework for modelling Deep Learning Models.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 15 · 🔀 99 · 📥 3 · 📋 99 - 11% open · ⏱️ 15.03.2023):
...
- <b><a href="https://github.com/upgini/upgini">upgini</a></b> (🥉18 ·  ⭐ 190) - Free automated data enrichment library for machine learning searches.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 120 · 🔀 6K · 📦 1.3K · 📋 6.9K - 20% open · ⏱️ 15.03.2023):
...
<details><summary><b><a href="https://github.com/open-mmlab/mmocr">MMOCR</a></b> (🥈31 ·  ⭐ 3.3K) - OpenMMLab Text Detection, Recognition and Understanding Toolbox. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/open-mmlab/mmocr) (👨‍💻 78 · 🔀 620 · 📦 45 · 📋 780 - 10% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/ocrmypdf/OCRmyPDF">OCRmyPDF</a></b> (🥈29 ·  ⭐ 8.6K) - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 81 · 🔀 670 · 📦 500 · 📋 950 - 11% open · ⏱️ 30.03.2023):
...
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 29K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ocrmypdf) (📥 41K · ⏱️ 20.03.2023):
	```
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">Tesseract</a></b> (🥉26 ·  ⭐ 4.8K · 📉) - Python-tesseract is an optical character recognition (OCR).. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/faustomorales/keras-ocr) (👨‍💻 17 · 🔀 290 · 📥 500K · 📦 220 · 📋 190 - 41% open · ⏱️ 24.12.2022):

	```
	git clone https://github.com/faustomorales/keras-ocr
	```
- [PyPi](https://pypi.org/project/keras-ocr) (📥 9.8K / month):
	```
	pip install keras-ocr
	```
- [Conda](https://anaconda.org/anaconda/keras-ocr) (📥 190 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/apache/airflow) (👨‍💻 2.8K · 🔀 12K · 📥 450K · 📦 6.3K · 📋 7.1K - 10% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/apache-airflow) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/airflow) (📥 860K · ⏱️ 01.04.2023):
	```
	conda install -c conda-forge airflow
	```
- [Docker Hub](https://hub.docker.com/r/apache/airflow) (📥 110M · ⭐ 440 · ⏱️ 31.03.2023):
	```
...
<details><summary><b><a href="https://github.com/dagster-io/dagster">Dagster</a></b> (🥇40 ·  ⭐ 7.1K) - An orchestration platform for the development, production, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dagster-io/dagster) (👨‍💻 300 · 🔀 880 · 📦 1.1K · 📋 5.1K - 26% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/dagster) (📥 620K / month):
	...
	pip install dagster
	```
- [Conda](https://anaconda.org/conda-forge/dagster) (📥 830K · ⏱️ 04.03.2023):
	```
	conda install -c conda-forge dagster
	```
</details>
<details><summary><b><a href="https://github.com/dbt-labs/dbt-core">dbt</a></b> (🥇38 ·  ⭐ 6.8K) - dbt enables data analysts and engineers to transform their data using the.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dbt-labs/dbt-core) (👨‍💻 270 · 🔀 1.2K · 📥 1.3K · 📦 2.4K · 📋 3.8K - 9% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/dbt-labs/dbt-core
	```
- [PyPi](https://pypi.org/project/dbt) (📥 91K / month):
	```
	pip install dbt
	```
...
<details><summary><b><a href="https://github.com/apache/beam">Beam</a></b> (🥇38 ·  ⭐ 6.7K) - Unified programming model to define and execute data processing.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/apache/beam) (👨‍💻 1.5K · 🔀 3.7K · 📦 2 · 📋 5.4K - 74% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/apache-beam) (📥 7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/apache-beam-with-aws) (📥 38K · ⏱️ 12.03.2023):
	```
...
- [PyPi](https://pypi.org/project/luigi) (📥 720K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/anaconda/luigi) (📥 12K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/kedro-org/kedro) (👨‍💻 180 · 🔀 760 · 📦 1.5K · 📋 1.2K - 22% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/great-expectations/great_expectations">Great Expectations</a></b> (🥈37 ·  ⭐ 8.2K) - Always know what to expect from your data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/great-expectations/great_expectations) (👨‍💻 380 · 🔀 1.3K · 📋 1.6K - 7% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/great-expectations/great_expectations
	```
- [PyPi](https://pypi.org/project/great_expectations) (📥 9.4M / month):
	```
	pip install great_expectations
	```
- [Conda](https://anaconda.org/conda-forge/great-expectations) (📥 620K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/joblib/joblib) (👨‍💻 120 · 🔀 350 · 📦 270K · 📋 760 - 42% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/joblib) (📥 29M / month):
	...
	pip install joblib
	```
- [Conda](https://anaconda.org/conda-forge/joblib) (📥 17M · ⏱️ 10.10.2022):
	```
...
- [GitHub](https://github.com/petl-developers/petl) (👨‍💻 58 · 🔀 180 · 📦 3.3K · 📋 450 - 17% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/petl) (📥 650K / month):
	```
	pip install petl
	```
...
<details><summary><b><a href="https://github.com/activeloopai/deeplake">Activeloop</a></b> (🥈32 ·  ⭐ 5.4K) - Data Lake for Deep Learning. Build, manage, query, version, &.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/activeloopai/deeplake) (👨‍💻 110 · 🔀 420 · 📦 110 · 📋 410 - 10% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 66 · 🔀 280 · 📥 1 · 📦 92 · 📋 160 - 6% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/zenml-io/zenml
	```
- [PyPi](https://pypi.org/project/zenml) (📥 5.4K / month):
	```
	pip install zenml
	```
</details>
...
- [GitHub](https://github.com/tensorflow/tfx) (👨‍💻 170 · 🔀 630 · 📋 830 - 13% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/tensorflow/tfx
	```
- [PyPi](https://pypi.org/project/tfx) (📥 280K / month):
	```
	pip install tfx
	```
</details>
...
- [GitHub](https://github.com/combust/mleap) (👨‍💻 81 · 🔀 300 · 📦 210 · 📋 460 - 20% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/combust/mleap
	```
- [PyPi](https://pypi.org/project/mleap) (📥 170K / month):
	```
	pip install mleap
	```
- [Conda](https://anaconda.org/conda-forge/mleap) (📥 65K · ⏱️ 24.02.2023):
	```
	conda install -c conda-forge mleap
	```
</details>
<details><summary><b><a href="https://github.com/ploomber/ploomber">ploomber</a></b> (🥉28 ·  ⭐ 3K) - The fastest way to build data pipelines. Develop iteratively, deploy.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ploomber/ploomber) (👨‍💻 72 · 🔀 210 · 📦 73 · 📋 830 - 15% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/ploomber/ploomber
	```
- [PyPi](https://pypi.org/project/ploomber) (📥 6.7K / month):
	```
	pip install ploomber
	```
- [Conda](https://anaconda.org/conda-forge/ploomber) (📥 53K · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/whylabs/whylogs) (👨‍💻 19 · 🔀 92 · 📥 68 · 📦 82 · 📋 340 - 5% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/whylabs/whylogs
	```
- [PyPi](https://pypi.org/project/whylogs) (📥 49K / month):
	```
	pip install whylogs
	```
</details>
...
- [GitHub](https://github.com/samuelcolvin/arq) (👨‍💻 53 · 🔀 120 · 📦 380 · 📋 180 - 22% open · ⏱️ 19.03.2023):
...
- [PyPi](https://pypi.org/project/arq) (📥 42K / month):
	...
	pip install arq
	```
- [Conda](https://anaconda.org/conda-forge/arq) (📥 6.3K · ⏱️ 02.12.2022):
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 220 · 📋 220 - 4% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/optimuspyspark) (📥 16K / month):
	```
...
- [GitHub](https://github.com/cgarciae/pypeln) (👨‍💻 13 · 🔀 88 · 📦 92 · 📋 63 - 26% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/cgarciae/pypeln
	```
- [PyPi](https://pypi.org/project/pypeln) (📥 20K / month):
	```
	pip install pypeln
	```
...
- [GitHub](https://github.com/closeio/tasktiger) (👨‍💻 25 · 🔀 69 · 📦 26 · 📋 66 - 42% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/closeio/tasktiger
	```
- [PyPi](https://pypi.org/project/tasktiger) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/pdpipe) (📥 2K / month):
	...
	pip install pdpipe
	```
- [Conda](https://anaconda.org/conda-forge/pdpipe) (📥 20K · ⏱️ 24.09.2022):
	```
...
- [GitHub](https://github.com/mara/mara-pipelines) (👨‍💻 17 · 🔀 98 · 📋 33 - 51% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/mara/mara-pipelines
	```
- [PyPi](https://pypi.org/project/mara-pipelines) (📥 130 / month):
	```
...
- [GitHub](https://github.com/d6t/d6tflow) (👨‍💻 13 · 🔀 72 · 📦 21 · 📋 23 - 43% open · ⏱️ 26.10.2022):
...
- <b><a href="https://github.com/kubeflow-kale/kale">kale</a></b> (🥉16 ·  ⭐ 590 · 💀) - Kubeflows superfood for Data Scientists. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 840 · 🔀 4.2K · 📥 53 · 📦 8.8K · 📋 13K - 19% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/ray) (📥 2.4M / month):
	...
	pip install ray
	```
- [Conda](https://anaconda.org/conda-forge/ray-tune) (📥 110K · ⏱️ 26.02.2023):
	```
...
<details><summary><b><a href="https://github.com/microsoft/DeepSpeed">DeepSpeed</a></b> (🥇38 ·  ⭐ 10K · 📈) - DeepSpeed is a deep learning optimization library that.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/DeepSpeed) (👨‍💻 170 · 🔀 1.1K · 📦 1.1K · 📋 1.4K - 43% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 310 · 🔀 660 · 📦 28K · 📋 3.2K - 34% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/distributed) (📥 4.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/distributed) (📥 10M · ⏱️ 05.04.2023):
	```
	conda install -c conda-forge distributed
	```
</details>
<details><summary><b><a href="https://github.com/Lightning-AI/torchmetrics">metrics</a></b> (🥈36 ·  ⭐ 1.3K) - Torchmetrics - Machine learning metrics for distributed,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Lightning-AI/torchmetrics) (👨‍💻 190 · 🔀 290 · 📥 1.6K · 📦 9.5K · 📋 580 - 8% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/metrics) (📥 15K / month):
	...
	pip install metrics
	```
- [Conda](https://anaconda.org/conda-forge/torchmetrics) (📥 780K · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/intel-analytics/BigDL) (👨‍💻 180 · 🔀 1K · 📦 42 · 📋 1.7K - 31% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/intel-analytics/BigDL
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 3K / month):
	```
	pip install bigdl
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/fairscale">FairScale</a></b> (🥈32 ·  ⭐ 2.2K) - PyTorch extensions for high performance and large scale training. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 69 · 🔀 210 · 📦 1.7K · 📋 340 - 18% open · ⏱️ 10.03.2023):
...
- [PyPi](https://pypi.org/project/fairscale) (📥 470K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fairscale) (📥 100K · ⏱️ 12.12.2022):
	```
	conda install -c conda-forge fairscale
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/SynapseML">SynapseML</a></b> (🥈29 ·  ⭐ 4K) - Simple and Distributed Machine Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 110 · 🔀 700 · 📋 640 - 40% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 89K / month):
	```
	pip install synapseml
	```
</details>
<details><summary><b><a href="https://github.com/dask/dask-ml">dask-ml</a></b> (🥈29 ·  ⭐ 840) - Scalable Machine Learning with Dask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/dask-ml) (📥 200K / month):
	...
	pip install dask-ml
	```
- [Conda](https://anaconda.org/conda-forge/dask-ml) (📥 690K · ⏱️ 25.03.2023):
	```
...
- [GitHub](https://github.com/maxpumperla/elephas) (👨‍💻 27 · 🔀 300 · 📦 66 · 📋 160 - 4% open · ⏱️ 31.08.2022):

	```
	git clone https://github.com/maxpumperla/elephas
	```
- [PyPi](https://pypi.org/project/elephas) (📥 75K / month):
	```
	pip install elephas
	```
...
- [GitHub](https://github.com/yahoo/TensorFlowOnSpark) (👨‍💻 34 · 🔀 920 · 📋 360 - 2% open · ⏱️ 21.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/tensorflowonspark) (📥 210K / month):
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 28 · 🔀 95 · 📦 56 · 📋 140 - 31% open · ⏱️ 30.03.2023):
...
<details><summary><b><a href="https://github.com/facebookincubator/submitit">Submit it</a></b> (🥉26 ·  ⭐ 810 · 💤) - Python 3.6+ toolbox for submitting jobs to Slurm. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookincubator/submitit) (👨‍💻 23 · 🔀 98 · 📦 1.1K · 📋 92 - 26% open · ⏱️ 28.09.2022):

	```
	git clone https://github.com/facebookincubator/submitit
	```
- [PyPi](https://pypi.org/project/submitit) (📥 65K / month):
	```
	pip install submitit
	```
- [Conda](https://anaconda.org/conda-forge/submitit) (📥 17K · ⏱️ 10.02.2021):
	```
...
- [GitHub](https://github.com/tensorflow/mesh) (👨‍💻 49 · 🔀 230 · 📦 790 · 📋 79 - 82% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/tensorflow/mesh
	```
- [PyPi](https://pypi.org/project/mesh-tensorflow) (📥 39K / month):
	```
	pip install mesh-tensorflow
	```
</details>
<details><summary><b><a href="https://github.com/mpi4py/mpi4py">mpi4py</a></b> (🥉25 ·  ⭐ 630) - Python bindings for MPI. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 23 · 🔀 96 · 📥 11K · 📋 110 - 8% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/microsoft/SynapseML">MMLSpark</a></b> (🥉23 ·  ⭐ 4K) - Simple and Distributed Machine Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/intel-analytics/analytics-zoo) (👨‍💻 110 · 🔀 710 · 📦 3 · 📋 1.3K - 32% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/apache/singa) (👨‍💻 81 · 🔀 930 · 📦 2 · 📋 89 - 26% open · ⏱️ 02.04.2023):
...
<details><summary><b><a href="https://github.com/tunib-ai/parallelformers">parallelformers</a></b> (🥉16 ·  ⭐ 640 · 💤) - Parallelformers: An Efficient Model Parallelization.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tunib-ai/parallelformers) (👨‍💻 5 · 🔀 46 · 📦 18 · 📋 38 - 55% open · ⏱️ 27.07.2022):

	```
	git clone https://github.com/tunib-ai/parallelformers
	```
- [PyPi](https://pypi.org/project/parallelformers) (📥 930 / month):
	```
	pip install parallelformers
	```
</details>
<details><summary><b><a href="https://github.com/kingoflolz/mesh-transformer-jax">mesh-transformer-jax</a></b> (🥉15 ·  ⭐ 5.7K) - Model parallel transformers in JAX and Haiku. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/kingoflolz/mesh-transformer-jax) (👨‍💻 23 · 🔀 800 · 📋 200 - 21% open · ⏱️ 12.01.2023):
...
- <b><a href="https://github.com/ml-tooling/lazycluster">LazyCluster</a></b> (🥉11 ·  ⭐ 43 · 💀) - Distributed machine learning made simple. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/microsoft/nni) (👨‍💻 190 · 🔀 1.7K · 📦 360 · 📋 1.9K - 14% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/keras-team/autokeras) (👨‍💻 140 · 🔀 1.4K · 📥 15K · 📦 460 · 📋 880 - 13% open · ⏱️ 02.04.2023):
...
<details><summary><b><a href="https://github.com/alteryx/featuretools">featuretools</a></b> (🥇34 ·  ⭐ 6.6K) - An open source python library for automated feature engineering. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 69 · 🔀 820 · 📦 1.3K · 📋 930 - 17% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/featuretools) (📥 57K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/featuretools) (📥 140K · ⏱️ 29.03.2023):
	```
...
- [GitHub](https://github.com/keras-team/keras-tuner) (👨‍💻 55 · 🔀 360 · 📦 2.1K · 📋 440 - 42% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/keras-team/keras-tuner
	```
- [PyPi](https://pypi.org/project/keras-tuner) (📥 500K / month):
	```
	pip install keras-tuner
	```
- [Conda](https://anaconda.org/conda-forge/keras-tuner) (📥 16K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/pytorch/botorch) (👨‍💻 90 · 🔀 300 · 📦 490 · 📋 380 - 16% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/botorch) (📥 210K / month):
	...
	pip install botorch
	```
- [Conda](https://anaconda.org/conda-forge/botorch) (📥 62K · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 140 · 🔀 240 · 📦 440 · 📋 520 - 5% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/ax-platform) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ax-platform) (📥 7.7K · ⏱️ 18.03.2023):
	```
...
- [GitHub](https://github.com/automl/auto-sklearn) (👨‍💻 88 · 🔀 1.2K · 📥 42 · 📦 420 · 📋 960 - 15% open · ⏱️ 07.12.2022):
...
- [PyPi](https://pypi.org/project/auto-sklearn) (📥 36K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/auto-sklearn) (📥 15K · ⏱️ 21.09.2022):
	```
	conda install -c conda-forge auto-sklearn
	```
</details>
<details><summary><b><a href="https://github.com/fmfn/BayesianOptimization">Bayesian Optimization</a></b> (🥈32 ·  ⭐ 6.7K) - A Python implementation of global optimization with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/fmfn/BayesianOptimization) (👨‍💻 38 · 🔀 1.4K · 📥 120 · 📦 1.7K · 📋 300 - 5% open · ⏱️ 06.03.2023):
...
<details><summary><b><a href="https://github.com/autogluon/autogluon">AutoGluon</a></b> (🥈29 ·  ⭐ 5.6K) - AutoGluon: AutoML for Image, Text, Time Series, and Tabular.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1X" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 100 · 🔀 700 · 📋 960 - 21% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 49 · 🔀 320 · 📦 470 · 📋 240 - 34% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/mljar/mljar-supervised">mljar-supervised</a></b> (🥈26 ·  ⭐ 2.5K) - Python package for AutoML on Tabular Data with Feature.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 20 · 🔀 330 · 📦 67 · 📋 530 - 22% open · ⏱️ 30.12.2022):
...
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 13K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mljar-supervised) (📥 7.4K · ⏱️ 30.12.2022):
	```
...
- [GitHub](https://github.com/shankarpandala/lazypredict) (👨‍💻 18 · 🔀 220 · 📦 470 · 📋 100 - 63% open · ⏱️ 28.09.2022):
...
- [PyPi](https://pypi.org/project/lazypredict) (📥 24K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lazypredict) (📥 1.7K · ⏱️ 29.09.2022):
	```
...
<details><summary><b><a href="https://github.com/SheffieldML/GPyOpt">GPyOpt</a></b> (🥈24 ·  ⭐ 860) - Gaussian Process Optimization using GPy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 7 · 🔀 39 · 📥 110 · 📦 17 · 📋 58 - 17% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/SimonBlanke/Hyperactive
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/hpbandster) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hpbandster) (📥 8.5K · ⏱️ 11.12.2020):
	```
...
- [GitHub](https://github.com/Neuraxio/Neuraxle) (👨‍💻 9 · 🔀 55 · 📦 44 · 📋 320 - 13% open · ⏱️ 16.08.2022):

	```
	git clone https://github.com/Neuraxio/Neuraxle
	```
- [PyPi](https://pypi.org/project/neuraxle) (📥 340 / month):
	```
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 8 · 🔀 85 · 📦 21 · 📋 26 - 11% open · ⏱️ 08.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/autoviml) (📥 2.8K / month):
	```
	pip install autoviml
	```
</details>
<details><summary><b><a href="https://github.com/ScottfreeLLC/AlphaPy">AlphaPy</a></b> (🥉19 ·  ⭐ 890 · 💤) - Automated Machine Learning [AutoML] with Python, scikit-learn,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/AutoViML/featurewiz">featurewiz</a></b> (🥉19 ·  ⭐ 380) - Use advanced feature engineering strategies and select best.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/AutoViML/featurewiz) (👨‍💻 7 · 🔀 71 · 📦 40 · 📋 62 - 1% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/AutoViML/featurewiz
	```
- [PyPi](https://pypi.org/project/featurewiz) (📥 30K / month):
	```
...
- <b><a href="https://github.com/optuna/optuna">Optuna</a></b> (🥇38 ·  ⭐ 7.9K) - A hyperparameter optimization framework. <code>❗Unlicensed</code>
- <b><a href="https://github.com/EpistasisLab/tpot">TPOT</a></b> (🥈33 ·  ⭐ 9K) - A Python Automated Machine Learning tool that optimizes machine.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/automl/SMAC3">SMAC3</a></b> (🥉22 ·  ⭐ 820) - SMAC3: A Versatile Bayesian Optimization Package for Hyperparameter.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/electricbrainio/hypermax">Hypermax</a></b> (🥉9 ·  ⭐ 110 · 💀) - Better, faster hyper-parameter optimization. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 140 · 🔀 650 · 📦 1.1K · 📋 620 - 26% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/AI4Finance-Foundation/FinRL">FinRL</a></b> (🥇29 ·  ⭐ 7.1K) - FinRL: Financial Reinforcement Learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 91 · 🔀 1.7K · 📦 20 · 📋 560 - 17% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/deepmind/acme) (👨‍💻 83 · 🔀 380 · 📦 140 · 📋 240 - 18% open · ⏱️ 28.03.2023):

	```
	git clone https://github.com/deepmind/acme
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 3.6K / month):
	```
	pip install dm-acme
	```
- [Conda](https://anaconda.org/conda-forge/dm-acme) (📥 5.8K · ⏱️ 09.12.2021):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 38 · 🔀 790 · 📦 110 · 📋 470 - 17% open · ⏱️ 16.03.2023):
...
- [GitHub](https://github.com/tensorforce/tensorforce) (👨‍💻 82 · 🔀 520 · 📋 660 - 4% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorforce) (📥 920 / month):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 150 · 🔀 480 · 📋 110 - 29% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/pfnet/pfrl) (👨‍💻 18 · 🔀 130 · 📦 77 · 📋 68 - 41% open · ⏱️ 21.09.2022):
...
- [GitHub](https://github.com/google-research/rliable) (👨‍💻 6 · 🔀 35 · 📦 53 · 📋 12 - 8% open · ⏱️ 20.02.2023):
...
- <b><a href="https://github.com/deepmind/rlax">RLax</a></b> (🥉22 ·  ⭐ 1K) -  <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/microsoft/recommenders) (👨‍💻 120 · 🔀 2.6K · 📥 310 · 📦 66 · 📋 750 - 20% open · ⏱️ 31.03.2023):
...
<details><summary><b><a href="https://github.com/tensorflow/recommenders">TF Recommenders</a></b> (🥇31 ·  ⭐ 1.6K) - TensorFlow Recommenders is a library for building.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 61 · 🔀 480 · 📋 670 - 10% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/recbole) (📥 3.4K / month):
	...
	pip install recbole
	```
- [Conda](https://anaconda.org/aibox/recbole) (📥 3.1K · ⏱️ 05.10.2022):
	```
	conda install -c aibox recbole
	```
</details>
<details><summary><b><a href="https://github.com/PreferredAI/cornac">Cornac</a></b> (🥈25 ·  ⭐ 700) - A Comparative Framework for Multimodal Recommender Systems. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 15 · 🔀 120 · 📦 150 · 📋 120 - 8% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/cornac) (📥 33K / month):
	...
	pip install cornac
	```
- [Conda](https://anaconda.org/conda-forge/cornac) (📥 280K · ⏱️ 02.04.2023):
	```
	conda install -c conda-forge cornac
	```
</details>
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">scikit-surprise</a></b> (🥉23 ·  ⭐ 5.8K) - A Python scikit for building and analyzing recommender.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/statisticianinstilettos/recmetrics) (👨‍💻 19 · 🔀 92 · 📥 1 · 📦 37 · 📋 22 - 36% open · ⏱️ 17.03.2023):

	```
	git clone https://github.com/statisticianinstilettos/recmetrics
	```
- [PyPi](https://pypi.org/project/recmetrics) (📥 2.9K / month):
	```
...
- <b><a href="https://github.com/ShopRunner/collie">Collie</a></b> (🥉15 ·  ⭐ 98) - A library for preparing, training, and evaluating scalable deep.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 490 · 🔀 1.9K · 📋 3.4K - 3% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/pytorch/opacus) (👨‍💻 68 · 🔀 280 · 📥 63 · 📦 550 · 📋 240 - 23% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/opacus) (📥 32K / month):
	...
	pip install opacus
	```
- [Conda](https://anaconda.org/conda-forge/opacus) (📥 8.3K · ⏱️ 24.03.2023):
	```
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 53 · 🔀 400 · 📥 96 · 📋 160 - 45% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/FederatedAI/FATE">FATE</a></b> (🥉24 ·  ⭐ 4.9K) - An Industrial Grade Federated Learning Framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/FederatedAI/FATE) (👨‍💻 88 · 🔀 1.5K · 📋 1.6K - 41% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 31 · 🔀 210 · 📦 27 · 📋 210 - 17% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/tf-encrypted/tf-encrypted) (👨‍💻 29 · 🔀 200 · 📦 64 · 📋 430 - 32% open · ⏱️ 08.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/tf-encrypted) (📥 670 / month):
	```
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 300 · 🔀 1.5K · 📦 160K · 📋 1.8K - 32% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/iterative/dvc) (👨‍💻 280 · 🔀 1K · 📥 110K · 📦 7K · 📋 4.2K - 13% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/wandb/wandb">wandb client</a></b> (🥇39 ·  ⭐ 5.8K) - A tool for visualizing and tracking your machine learning.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wandb/wandb) (👨‍💻 140 · 🔀 450 · 📦 20K · 📋 2.4K - 23% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/wandb) (📥 2M / month):
	...
	pip install wandb
	```
- [Conda](https://anaconda.org/conda-forge/wandb) (📥 190K · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 340 · 🔀 920 · 📦 2.4K · 📋 1.2K - 35% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/sagemaker) (📥 24M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sagemaker-python-sdk) (📥 540K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 570 · 🔀 3.2K · 📋 2.8K - 32% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/pycaret/pycaret">PyCaret</a></b> (🥈37 ·  ⭐ 7.1K) - An open-source, low-code machine learning library in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 120 · 🔀 1.6K · 📥 640 · 📦 3.4K · 📋 2K - 13% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/pycaret) (📥 310K / month):
	...
	pip install pycaret
	```
- [Conda](https://anaconda.org/conda-forge/pycaret) (📥 30K · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 67 · 🔀 590 · 📦 450 · 📋 500 - 42% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/metaflow) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/metaflow) (📥 110K · ⏱️ 30.03.2023):
	```
...
- [GitHub](https://github.com/allegroai/clearml) (👨‍💻 76 · 🔀 560 · 📥 880 · 📦 480 · 📋 760 - 40% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/snakemake/snakemake">snakemake</a></b> (🥈33 ·  ⭐ 1.7K) - This is the development home of the workflow management system.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 280 · 🔀 410 · 📦 1.5K · 📋 1.2K - 57% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/snakemake) (📥 35K / month):
	...
	```
- [Conda](https://anaconda.org/bioconda/snakemake) (📥 700K · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 76 · 🔀 860 · 📥 370 · 📦 28K · 📋 440 - 15% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 32 · 🔀 610 · 📥 280 · 📦 1.8K · 📋 460 - 24% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/sacred) (📥 26K / month):
	...
	pip install sacred
	```
- [Conda](https://anaconda.org/conda-forge/sacred) (📥 2.7K · ⏱️ 14.11.2021):
	```
	conda install -c conda-forge sacred
	```
</details>
<details><summary><b><a href="https://github.com/aimhubio/aim">aim</a></b> (🥈31 ·  ⭐ 3.3K) - Aim An easy-to-use & supercharged open-source AI metadata tracker.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aimhubio/aim) (👨‍💻 57 · 🔀 210 · 📦 180 · 📋 840 - 26% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/aim) (📥 53K / month):
	...
	pip install aim
	```
- [Conda](https://anaconda.org/conda-forge/aim) (📥 25K · ⏱️ 03.03.2023):
	```
...
- [GitHub](https://github.com/Azure/MachineLearningNotebooks) (👨‍💻 61 · 🔀 2.3K · 📥 480 · 📋 1.4K - 23% open · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/catalyst-team/catalyst) (👨‍💻 100 · 🔀 360 · 📦 830 · 📋 350 - 1% open · ⏱️ 29.04.2022):

	```
	git clone https://github.com/catalyst-team/catalyst
	```
- [PyPi](https://pypi.org/project/catalyst) (📥 60K / month):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 15 · 🔀 110 · 📥 1.8K · 📦 310 · 📋 96 - 27% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/google/ml-metadata
	```
- [PyPi](https://pypi.org/project/ml-metadata) (📥 580K / month):
	```
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 25 · 🔀 70 · 📥 8 · 📦 74 · 📋 410 - 47% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/neptune-ai/neptune-client) (👨‍💻 39 · 🔀 38 · 📋 180 - 7% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/neptune-client) (📥 600K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/neptune-client) (📥 170K · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 7 · 🔀 88 · 📦 79 · 📋 33 - 48% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/stared/livelossplot) (👨‍💻 17 · 🔀 140 · 📦 990 · 📋 76 - 7% open · ⏱️ 04.04.2022):
...
- [GitHub](https://github.com/instacart/lore) (👨‍💻 29 · 🔀 130 · 📦 20 · 📋 35 - 45% open · ⏱️ 27.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/lore) (📥 560 / month):
	```
	pip install lore
	```
</details>
<details><summary><b><a href="https://github.com/studioml/studio">Studio.ml</a></b> (🥉19 ·  ⭐ 380) - Studio: Simplify and expedite model building process. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- <b><a href="https://github.com/MrPowers/quinn">quinn</a></b> (🥉24 ·  ⭐ 440) - pyspark methods to enhance developer productivity. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/google/caliban">caliban</a></b> (🥉16 ·  ⭐ 460 · 💀) - Research workflows made easy, locally and in the Cloud. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 270 · 🔀 3.4K · 📥 19K · 📦 14K · 📋 2.3K - 13% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/onnx) (📥 2.9M / month):
	...
	pip install onnx
	```
- [Conda](https://anaconda.org/conda-forge/onnx) (📥 690K · ⏱️ 21.03.2023):
	```
	conda install -c conda-forge onnx
	```
</details>
<details><summary><b><a href="https://github.com/bentoml/BentoML">BentoML</a></b> (🥇35 ·  ⭐ 4.7K · 📈) - Unified Model Serving Framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 150 · 🔀 540 · 📥 1.8K · 📦 910 · 📋 840 - 15% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/bentoml/BentoML
	```
- [PyPi](https://pypi.org/project/bentoml) (📥 38K / month):
	```
	pip install bentoml
	```
</details>
<details><summary><b><a href="https://github.com/openai/triton">triton</a></b> (🥈32 ·  ⭐ 6.2K) - Development repository for the Triton language and compiler. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/openai/triton) (👨‍💻 100 · 🔀 560 · 📦 930 · 📋 510 - 31% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 2.8M / month):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 150 · 🔀 470 · 📥 6.1K · 📦 3K · 📋 1.1K - 18% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/coremltools) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/coremltools) (📥 45K · ⏱️ 15.10.2021):
	```
	conda install -c conda-forge coremltools
	```
</details>
<details><summary><b><a href="https://github.com/pytorch/serve">TorchServe</a></b> (🥈30 ·  ⭐ 3.3K) - Serve, optimize and scale PyTorch models in production. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pytorch/serve) (👨‍💻 150 · 🔀 690 · 📥 3.1K · 📋 1.2K - 18% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/torchserve) (📥 34K / month):
	...
	```
- [Conda](https://anaconda.org/pytorch/torchserve) (📥 74K · ⏱️ 08.02.2023):
	```
...
<details><summary><b><a href="https://github.com/huggingface/huggingface_hub">huggingface_hub</a></b> (🥈29 ·  ⭐ 790) - All the open source things related to the Hugging Face Hub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 90 · 🔀 190 · 📋 440 - 18% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/huggingface_hub) (📥 990K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/microsoft/hummingbird) (👨‍💻 37 · 🔀 260 · 📥 230 · 📦 72 · 📋 280 - 18% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/hummingbird-ml) (📥 6.8K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hummingbird-ml) (📥 25K · ⏱️ 28.02.2023):
	```
	conda install -c conda-forge hummingbird-ml
	```
</details>
<details><summary><b><a href="https://github.com/nebuly-ai/nebullvm">nebullvm</a></b> (🥉25 ·  ⭐ 7.5K · 📈) - Plug and play modules to optimize the performances of your AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/nebuly-ai/nebullvm) (👨‍💻 39 · 🔀 580 · 📦 8 · 📋 190 - 44% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/microsoft/MMdnn) (👨‍💻 86 · 🔀 960 · 📥 3.6K · 📦 100 · 📋 610 - 52% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/mmdnn) (📥 630 / month):
	```
	pip install mmdnn
	```
</details>
...
- [GitHub](https://github.com/BayesWitnesses/m2cgen) (👨‍💻 14 · 🔀 200 · 📥 44 · 📦 94 · 📋 97 - 27% open · ⏱️ 05.10.2022):
...
- [GitHub](https://github.com/nok/sklearn-porter) (👨‍💻 12 · 🔀 160 · 📦 50 · 📋 68 - 50% open · ⏱️ 22.05.2022):
...
- [GitHub](https://github.com/slundberg/shap) (👨‍💻 200 · 🔀 2.8K · 📦 10K · 📋 2.2K - 71% open · ⏱️ 16.06.2022):
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 140 · 🔀 320 · 📥 120 · 📦 3.8K · 📋 800 - 19% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/interpretml/interpret">InterpretML</a></b> (🥇33 ·  ⭐ 5.4K) - Fit interpretable models. Explain blackbox machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 36 · 🔀 640 · 📦 380 · 📋 350 - 17% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/bmabey/pyLDAvis) (👨‍💻 39 · 🔀 340 · 📦 4.7K · 📋 170 - 45% open · ⏱️ 15.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyldavis) (📥 700K / month):
	```
	pip install pyldavis
	```
- [Conda](https://anaconda.org/conda-forge/pyldavis) (📥 63K · ⏱️ 18.02.2023):
	```
	conda install -c conda-forge pyldavis
	```
</details>
<details><summary><b><a href="https://github.com/lutzroeder/netron">Netron</a></b> (🥇32 ·  ⭐ 22K) - Visualizer for neural network, deep learning, and machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/lutzroeder/netron) (🔀 2.4K · 📥 41K · 📦 10 · 📋 920 - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/lutzroeder/netron
	```
- [PyPi](https://pypi.org/project/netron) (📥 14K / month):
	```
	pip install netron
	```
</details>
...
- [GitHub](https://github.com/pytorch/captum) (👨‍💻 100 · 🔀 400 · 📦 1.1K · 📋 440 - 29% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/captum) (📥 150K / month):
	...
	pip install captum
	```
- [Conda](https://anaconda.org/conda-forge/captum) (📥 7.8K · ⏱️ 15.02.2023):
	```
...
- [GitHub](https://github.com/py-why/dowhy) (👨‍💻 73 · 🔀 810 · 📥 32 · 📦 220 · 📋 360 - 30% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/parrt/dtreeviz) (👨‍💻 22 · 🔀 300 · 📦 670 · 📋 180 - 27% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/dtreeviz) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dtreeviz) (📥 39K · ⏱️ 21.02.2023):
	```
...
- [GitHub](https://github.com/MAIF/shapash) (👨‍💻 35 · 🔀 260 · 📦 100 · 📋 150 - 13% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/SeldonIO/alibi) (👨‍💻 18 · 🔀 210 · 📦 440 · 📋 330 - 36% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/microsoft/responsible-ai-toolbox">responsible-ai-widgets</a></b> (🥈29 ·  ⭐ 750) - Responsible AI Toolbox is a suite of tools providing.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 34 · 🔀 190 · 📦 48 · 📋 260 - 15% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/oegedijk/explainerdashboard">explainerdashboard</a></b> (🥈28 ·  ⭐ 1.7K) - Quickly build Explainable AI dashboards that show the inner.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 19 · 🔀 210 · 📦 240 · 📋 200 - 6% open · ⏱️ 18.02.2023):
...
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 39K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/explainerdashboard) (📥 31K · ⏱️ 20.02.2023):
	```
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 63 · 🔀 650 · 📦 230 · 📋 230 - 61% open · ⏱️ 04.11.2022):
...
- [PyPi](https://pypi.org/project/aif360) (📥 9.6K / month):
	...
	pip install aif360
	```
- [Conda](https://anaconda.org/conda-forge/aif360) (📥 5.4K · ⏱️ 04.09.2022):
	```
...
- [GitHub](https://github.com/quantumblacklabs/causalnex) (👨‍💻 33 · 🔀 210 · 📦 85 · 📋 120 - 12% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/quantumblacklabs/causalnex
	```
- [PyPi](https://pypi.org/project/causalnex) (📥 7K / month):
	```
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 53 · 🔀 250 · 📋 71 - 28% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/tensorflow/model-analysis
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 390K / month):
	```
	pip install tensorflow-model-analysis
	```
</details>
<details><summary><b><a href="https://github.com/fairlearn/fairlearn">fairlearn</a></b> (🥈26 ·  ⭐ 1.5K) - A Python package to assess and improve fairness of machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 74 · 🔀 340 · 📋 410 - 36% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/fairlearn) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fairlearn) (📥 25K · ⏱️ 02.12.2022):
	```
...
- [GitHub](https://github.com/DistrictDataLabs/yellowbrick) (👨‍💻 110 · 🔀 530 · 📋 680 - 11% open · ⏱️ 19.03.2023):

	```
	git clone https://github.com/DistrictDataLabs/yellowbrick
	```
- [PyPi](https://pypi.org/project/yellowbrick) (📥 680K / month):
	```
	pip install yellowbrick
	```
- [Conda](https://anaconda.org/conda-forge/yellowbrick) (📥 58K · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/albermax/innvestigate) (👨‍💻 19 · 🔀 230 · 📥 53 · 📦 94 · 📋 250 - 19% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/PAIR-code/lit) (👨‍💻 27 · 🔀 320 · 📦 19 · 📋 120 - 37% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/lit-nlp) (📥 740 / month):
	```
	pip install lit-nlp
	```
- [Conda](https://anaconda.org/conda-forge/lit-nlp) (📥 55K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/marcotcr/checklist) (👨‍💻 13 · 🔀 180 · 📦 220 · 📋 84 - 2% open · ⏱️ 12.08.2022):
...
- [PyPi](https://pypi.org/project/checklist) (📥 6K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/checklist) (📥 5.2K · ⏱️ 15.07.2021):
	```
...
- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 39 · 🔀 270 · 📦 71 · 📋 72 - 59% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/csinva/imodels) (👨‍💻 16 · 🔀 95 · 📦 40 · 📋 63 - 33% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/philipperemy/keract) (👨‍💻 16 · 🔀 180 · 📦 170 · 📋 88 - 2% open · ⏱️ 03.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/keract) (📥 6.4K / month):
	```
	pip install keract
	```
</details>
...
<details><summary><b><a href="https://github.com/tensorflow/model-card-toolkit">model-card-toolkit</a></b> (🥉21 ·  ⭐ 360) - A toolkit that streamlines and automates the generation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tensorflow/model-card-toolkit) (👨‍💻 21 · 🔀 77 · 📥 1 · 📦 13 · 📋 20 - 20% open · ⏱️ 03.04.2023):
...
<details><summary><b><a href="https://github.com/interpretml/DiCE">DiCE</a></b> (🥉18 ·  ⭐ 1.1K) - Generate Diverse Counterfactual Explanations for any machine.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tensorflow/fairness-indicators) (👨‍💻 33 · 🔀 74 · 📋 14 - 35% open · ⏱️ 23.03.2023):
...
<details><summary><b><a href="https://github.com/aerdem4/lofo-importance">LOFO</a></b> (🥉16 ·  ⭐ 710) - Leave One Feature Out Importance. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/aerdem4/lofo-importance) (👨‍💻 4 · 🔀 73 · 📦 25 · 📋 23 - 21% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/explainX/explainx) (👨‍💻 4 · 🔀 45 · 📥 9 · 📋 27 - 37% open · ⏱️ 15.09.2022):
...
- [GitHub](https://github.com/edublancas/sklearn-evaluation) (👨‍💻 19 · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/sklearn-evaluation) (📥 60K / month):
	```
...
- <b><a href="https://github.com/deepchecks/deepchecks">Deep Checks</a></b> (🥈28 ·  ⭐ 2.5K) - Deepchecks - Tests for Continuous Validation of ML Models &.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/SAP/contextual-ai">contextual-ai</a></b> (🥉11 ·  ⭐ 83 · 💀) - Contextual AI adds explainability to different stages of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 130 · 🔀 2.8K · 📦 960 · 📋 2K - 14% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/facebookresearch/faiss
	```
- [PyPi](https://pypi.org/project/pymilvus) (📥 390K / month):
	```
	pip install pymilvus
	```
- [Conda](https://anaconda.org/conda-forge/faiss) (📥 690K · ⏱️ 10.01.2023):
	```
	conda install -c conda-forge faiss
	```
</details>
<details><summary><b><a href="https://github.com/milvus-io/milvus">Milvus</a></b> (🥇37 ·  ⭐ 16K) - A cloud-native vector database, storage for next generation AI.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 240 · 🔀 1.8K · 📥 24K · 📋 7.4K - 4% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/pymilvus) (📥 390K / month):
	...
	pip install pymilvus
	```
- [Docker Hub](https://hub.docker.com/r/milvusdb/milvus) (📥 3.1M · ⭐ 25 · ⏱️ 06.04.2023):
	```
...
<details><summary><b><a href="https://github.com/nmslib/hnswlib">hnswlib</a></b> (🥈31 ·  ⭐ 2.6K) - Header-only C++/python library for fast approximate nearest neighbors. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/nmslib/hnswlib) (👨‍💻 65 · 🔀 430 · 📦 460 · 📋 270 - 50% open · ⏱️ 05.02.2023):

	```
	git clone https://github.com/nmslib/hnswlib
	```
- [PyPi](https://pypi.org/project/hnswlib) (📥 450K / month):
	```
	pip install hnswlib
	```
- [Conda](https://anaconda.org/conda-forge/hnswlib) (📥 76K · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 48 · 🔀 410 · 📦 820 · 📋 410 - 15% open · ⏱️ 31.05.2022):

	```
	git clone https://github.com/nmslib/nmslib
	```
- [PyPi](https://pypi.org/project/nmslib) (📥 260K / month):
	```
	pip install nmslib
	```
- [Conda](https://anaconda.org/conda-forge/nmslib) (📥 82K · ⏱️ 30.10.2022):
	```
	conda install -c conda-forge nmslib
	```
</details>
<details><summary><b><a href="https://github.com/lmcinnes/pynndescent">PyNNDescent</a></b> (🥉27 ·  ⭐ 740) - A Python nearest neighbor descent for approximate nearest neighbors. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 24 · 🔀 90 · 📦 3.1K · 📋 120 - 49% open · ⏱️ 24.02.2023):
...
- [PyPi](https://pypi.org/project/pynndescent) (📥 820K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pynndescent) (📥 1.3M · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge pynndescent
	```
</details>
<details><summary><b><a href="https://github.com/yahoojapan/NGT">NGT</a></b> (🥉21 ·  ⭐ 990) - Nearest Neighbor Search with Neighborhood Graph and Tree for High-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/yahoojapan/NGT) (👨‍💻 14 · 🔀 100 · 📋 110 - 13% open · ⏱️ 05.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ngt) (📥 14K / month):
	```
	pip install ngt
	```
</details>
...
<details><summary><b><a href="https://github.com/pyro-ppl/pyro">Pyro</a></b> (🥇34 ·  ⭐ 7.9K) - Deep universal probabilistic programming with Python and PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 140 · 🔀 930 · 📦 1.3K · 📋 1K - 21% open · ⏱️ 24.03.2023):
...
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 410K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyro-ppl) (📥 58K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 470 · 🔀 1K · 📋 1.3K - 43% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 780K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-probability) (📥 97K · ⏱️ 16.02.2023):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 120 · 🔀 470 · 📦 1.2K · 📋 1.2K - 24% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/gpytorch) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gpytorch) (📥 85K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 120 · 🔀 650 · 📥 210 · 📦 580 · 📋 800 - 25% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 82 · 🔀 420 · 📦 490 · 📋 790 - 14% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/gpflow) (📥 59K / month):
	...
	pip install gpflow
	```
- [Conda](https://anaconda.org/conda-forge/gpflow) (📥 20K · ⏱️ 24.05.2022):
	```
	conda install -c conda-forge gpflow
	```
</details>
<details><summary><b><a href="https://github.com/SALib/SALib">SALib</a></b> (🥈31 ·  ⭐ 700) - Sensitivity Analysis Library in Python. Contains Sobol, Morris, FAST, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SALib/SALib) (👨‍💻 41 · 🔀 210 · 📦 700 · 📋 300 - 12% open · ⏱️ 03.04.2023):
...
<details><summary><b><a href="https://github.com/twopirllc/pandas-ta">pandas-ta</a></b> (🥈30 ·  ⭐ 3.5K · 💤) - Technical Analysis Indicators - Pandas TA is an easy to use.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/twopirllc/pandas-ta) (👨‍💻 45 · 🔀 740 · 📦 2.8K · 📋 480 - 19% open · ⏱️ 24.09.2022):

	```
	git clone https://github.com/twopirllc/pandas-ta
	```
- [PyPi](https://pypi.org/project/pandas-ta) (📥 80K / month):
	```
	pip install pandas-ta
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 12K · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/hmmlearn/hmmlearn) (👨‍💻 44 · 🔀 690 · 📦 1.7K · 📋 410 - 13% open · ⏱️ 30.03.2023):
...
- [PyPi](https://pypi.org/project/hmmlearn) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hmmlearn) (📥 170K · ⏱️ 05.11.2022):
	```
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 66 · 🔀 550 · 📦 890 · 📋 690 - 11% open · ⏱️ 29.11.2022):
...
- [GitHub](https://github.com/rlabbe/filterpy) (👨‍💻 43 · 🔀 540 · 📦 2.7K · 📋 210 - 25% open · ⏱️ 22.08.2022):

	```
	git clone https://github.com/rlabbe/filterpy
	```
- [PyPi](https://pypi.org/project/filterpy) (📥 2.7M / month):
	```
...
<details><summary><b><a href="https://github.com/bambinos/bambi">bambi</a></b> (🥉26 ·  ⭐ 890) - BAyesian Model-Building Interface (Bambi) in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 30 · 🔀 99 · 📦 60 · 📋 330 - 20% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/bambinos/bambi
	```
- [PyPi](https://pypi.org/project/bambi) (📥 3.6K / month):
	```
	pip install bambi
	```
...
<details><summary><b><a href="https://github.com/baal-org/baal">Baal</a></b> (🥉21 ·  ⭐ 730) - Library to enable Bayesian active learning in your research or labeling.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/baal-org/baal) (👨‍💻 19 · 🔀 70 · 📦 48 · 📋 94 - 22% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/baal) (📥 1.5K / month):
	...
	pip install baal
	```
- [Conda](https://anaconda.org/conda-forge/baal) (📥 5K · ⏱️ 31.10.2022):
	```
...
- <b><a href="https://github.com/raphaelvallat/pingouin">pingouin</a></b> (🥈30 ·  ⭐ 1.3K) - Statistical package in Python based on Pandas. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
- <b><a href="https://github.com/pydata/patsy">patsy</a></b> (🥉27 ·  ⭐ 870) - Describing statistical models in Python using symbolic formulas. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 120 · 🔀 940 · 📦 330 · 📋 780 - 11% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 33K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/adversarial-robustness-toolbox) (📥 23K · ⏱️ 17.03.2023):
	```
...
- [PyPi](https://pypi.org/project/cleverhans) (📥 1.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cleverhans) (📥 5.6K · ⏱️ 29.07.2021):
	```
	conda install -c conda-forge cleverhans
	```
</details>
<details><summary><b><a href="https://github.com/QData/TextAttack">TextAttack</a></b> (🥈29 ·  ⭐ 2.3K) - TextAttack is a Python framework for adversarial attacks, data.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 58 · 🔀 290 · 📦 150 · 📋 240 - 12% open · ⏱️ 21.12.2022):
...
- [PyPi](https://pypi.org/project/textattack) (📥 8.8K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textattack) (📥 5.3K · ⏱️ 29.06.2021):
	```
...
- [PyPi](https://pypi.org/project/foolbox) (📥 2.5K / month):
	...
	pip install foolbox
	```
- [Conda](https://anaconda.org/conda-forge/foolbox) (📥 9.9K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/advboxes/AdvBox) (👨‍💻 19 · 🔀 250 · 📋 38 - 18% open · ⏱️ 08.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/advbox) (📥 34 / month):
	```
	pip install advbox
	```
</details>
...
<details><summary><b><a href="https://github.com/NVIDIA/apex">Apex</a></b> (🥇30 ·  ⭐ 7.1K) - A PyTorch Extension: Tools for easy mixed precision and distributed.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 110 · 🔀 1.1K · 📦 1.6K · 📋 1.1K - 53% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 260 · 🔀 670 · 📋 5.3K - 14% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/wookayin/gpustat">gpustat</a></b> (🥇30 ·  ⭐ 3.3K) - A simple command-line utility for querying and monitoring GPU status. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 17 · 🔀 230 · 📦 3.2K · 📋 100 - 17% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/gpustat) (📥 1.1M / month):
	...
	pip install gpustat
	```
- [Conda](https://anaconda.org/conda-forge/gpustat) (📥 210K · ⏱️ 11.10.2022):
	```
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 88 · 🔀 500 · 📥 3.7K · 📋 1.6K - 16% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 160 · 🔀 450 · 📦 1 · 📋 2.2K - 32% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 98 · 🔀 240 · 📦 2 · 📋 1.4K - 19% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 82 · 🔀 550 · 📋 1.4K - 16% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 21 · 🔀 75 · 📥 280 · 📦 6 · 📋 190 - 33% open · ⏱️ 03.12.2022):
...
- <b><a href="https://github.com/inducer/pycuda">PyCUDA</a></b> (🥈26 ·  ⭐ 1.5K) - CUDA integration for Python, plus shiny features. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/tensorflow/addons) (👨‍💻 200 · 🔀 550 · 📦 11K · 📋 960 - 7% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/tensorflow/tensor2tensor) (👨‍💻 240 · 🔀 3.1K · 📦 1.3K · 📋 1.2K - 46% open · ⏱️ 01.04.2023):
...
- [GitHub](https://github.com/tensorflow/datasets) (👨‍💻 280 · 🔀 1.4K · 📋 1K - 36% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/tensorflow-datasets) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-datasets) (📥 16K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 27 · 🔀 190 · 📦 1.3K · 📋 200 - 16% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 78 · 🔀 300 · 📦 2.6K · 📋 310 - 49% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/tensorflow/model-optimization
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 290K / month):
	```
...
- [GitHub](https://github.com/tensorflow/hub) (👨‍💻 100 · 🔀 1.7K · 📋 670 - 0% open · ⏱️ 04.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-hub) (📥 5M / month):
	```
	pip install tensorflow-hub
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow-hub) (📥 78K · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/tensorflow/neural-structured-learning) (👨‍💻 37 · 🔀 180 · 📦 320 · 📋 68 - 1% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 98 · 🔀 240 · 📋 590 - 40% open · ⏱️ 24.03.2023):
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 27 · 🔀 76 · 📦 230 · 📋 87 - 68% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/tensorflow/cloud
	```
- [PyPi](https://pypi.org/project/tensorflow-cloud) (📥 90K / month):
	```
	pip install tensorflow-cloud
	```
</details>
<details><summary><b><a href="https://github.com/tensorflow/compression">TF Compression</a></b> (🥉22 ·  ⭐ 730) - Data compression in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 21 · 🔀 230 · 📋 96 - 5% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/PAIR-code/saliency) (👨‍💻 16 · 🔀 170 · 📦 55 · 📋 33 - 18% open · ⏱️ 13.05.2022):
...
<details><summary><b><a href="https://github.com/patrick-kidger/equinox">equinox</a></b> (🥇25 ·  ⭐ 1.1K) - Elegant easy-to-use neural networks in JAX... <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/patrick-kidger/equinox) (👨‍💻 23 · 🔀 63 · 📦 120 · 📋 160 - 25% open · ⏱️ 29.03.2023):

	```
	git clone https://github.com/patrick-kidger/equinox
	```
- [PyPi](https://pypi.org/project/equinox) (📥 7.3K / month):
	```
	pip install equinox
	```
</details>
...
- <b><a href="https://github.com/ucl-bug/jaxdf">jaxdf</a></b> (🥉11 ·  ⭐ 69) - A JAX-based research framework for writing differentiable.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code> <code><img src="https://jax.readthedocs.io/en/latest/_static/favicon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [PyPi](https://pypi.org/project/imbalanced-learn) (📥 2.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/imbalanced-learn) (📥 370K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/scikit-learn-contrib/category_encoders) (👨‍💻 61 · 🔀 370 · 📦 4.9K · 📋 260 - 16% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/scikit-multilearn/scikit-multilearn) (👨‍💻 28 · 🔀 160 · 📦 1K · 📋 190 - 36% open · ⏱️ 22.03.2023):
...
<details><summary><b><a href="https://github.com/koaning/scikit-lego">scikit-lego</a></b> (🥈25 ·  ⭐ 990) - Extra blocks for scikit-learn pipelines. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/scikit-lego) (📥 33K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-lego) (📥 35K · ⏱️ 03.11.2022):
	```
...
<details><summary><b><a href="https://github.com/yzhao062/combo">combo</a></b> (🥉18 ·  ⭐ 610) - (AAAI 20) A Python Toolbox for Machine Learning Model Combination. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code> <code>xgboost</code></summary>

- [GitHub](https://github.com/yzhao062/combo) (👨‍💻 2 · 🔀 99 · 📦 540 · 📋 14 - 78% open · ⏱️ 14.01.2023):
...
<details><summary><b><a href="https://github.com/scikit-learn-contrib/DESlib">DESlib</a></b> (🥉16 ·  ⭐ 440) - A Python library for dynamic classifier and ensemble selection. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/scikit-learn-contrib/DESlib) (👨‍💻 15 · 🔀 67 · 📦 36 · 📋 150 - 8% open · ⏱️ 27.02.2023):
...
- <b><a href="https://github.com/rasbt/mlxtend">MLxtend</a></b> (🥈33 ·  ⭐ 4.3K) - A library of extension and helper modules for Pythons data.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/scikit-tda/scikit-tda">scikit-tda</a></b> (🥉16 ·  ⭐ 390 · 💀) - Topological Data Analysis for Python. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/huggingface/accelerate">accelerate</a></b> (🥇36 ·  ⭐ 4.1K) - A simple way to train and use PyTorch models with multi-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/huggingface/accelerate) (👨‍💻 110 · 🔀 380 · 📦 4.3K · 📋 620 - 11% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/accelerate) (📥 3.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/accelerate) (📥 25K · ⏱️ 26.03.2023):
	```
...
- [GitHub](https://github.com/KevinMusgrave/pytorch-metric-learning) (👨‍💻 33 · 🔀 600 · 📦 570 · 📋 430 - 9% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pytorch-metric-learning) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/metric-learning/pytorch-metric-learning) (📥 9.9K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/geohot/tinygrad) (👨‍💻 100 · 🔀 1K · 📦 11 · 📋 200 - 17% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/rtqichen/torchdiffeq) (👨‍💻 21 · 🔀 800 · 📦 1.1K · 📋 190 - 25% open · ⏱️ 19.02.2023):
...
- [PyPi](https://pypi.org/project/lightning-flash) (📥 2.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lightning-flash) (📥 11K · ⏱️ 08.11.2022):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 7 · 🔀 110 · 📋 25 - 4% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 25 · 🔀 150 · 📋 310 - 6% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/torch-scatter) (📥 55K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_scatter) (📥 160K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/dreamquark-ai/tabnet) (👨‍💻 19 · 🔀 410 · 📋 250 - 6% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/pytorch-tabnet) (📥 28K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch-tabnet) (📥 3.7K · ⏱️ 22.02.2023):
	```
	conda install -c conda-forge pytorch-tabnet
	```
</details>
<details><summary><b><a href="https://github.com/rusty1s/pytorch_sparse">PyTorch Sparse</a></b> (🥈22 ·  ⭐ 800) - PyTorch Extension Library of Optimized Autograd Sparse.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 39 · 🔀 130 · 📋 230 - 12% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/torch-sparse) (📥 39K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytorch_sparse) (📥 180K · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/parrt/tensor-sensor) (👨‍💻 4 · 🔀 37 · 📦 17 · 📋 24 - 33% open · ⏱️ 07.04.2022):
...
- [PyPi](https://pypi.org/project/tensor-sensor) (📥 2.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensor-sensor) (📥 2K · ⏱️ 11.12.2021):
	```
...
- [GitHub](https://github.com/abhishekkrthakur/tez) (👨‍💻 2 · 🔀 140 · 📦 40 · 📋 41 - 56% open · ⏱️ 16.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/tez) (📥 770 / month):
	```
	pip install tez
	```
</details>
...
- <b><a href="https://github.com/karpathy/micrograd">micrograd</a></b> (🥉18 ·  ⭐ 4.5K · 💀) - A tiny scalar-valued autograd engine and a neural net library.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/facebookresearch/madgrad">madgrad</a></b> (🥉15 ·  ⭐ 780 · 💀) - MADGRAD Optimization Method. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/TorchDrift/TorchDrift">TorchDrift</a></b> (🥉13 ·  ⭐ 280 · 💤) - Drift Detection for your PyTorch Models. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.4K · 🔀 4.5K · 📥 370K · 📦 700K · 📋 9K - 15% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/scipy/scipy
	```
- [PyPi](https://pypi.org/project/scipy) (📥 57M / month):
	```
	pip install scipy
	```
- [Conda](https://anaconda.org/conda-forge/scipy) (📥 35M · ⏱️ 26.02.2023):
	```
	conda install -c conda-forge scipy
	```
</details>
<details><summary><b><a href="https://github.com/streamlit/streamlit">Streamlit</a></b> (🥇40 ·  ⭐ 24K) - Streamlit The fastest way to build data apps in Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 170 · 🔀 2.1K · 📦 660 · 📋 3.2K - 19% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/streamlit/streamlit
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 1.5M / month):
	```
	pip install streamlit
	```
</details>
<details><summary><b><a href="https://github.com/gradio-app/gradio">Gradio</a></b> (🥇39 ·  ⭐ 15K · 📈) - Wrap UIs around any model, share with anyone. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 140 · 🔀 970 · 📦 4.8K · 📋 1.9K - 14% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/deepchem/deepchem">DeepChem</a></b> (🥇37 ·  ⭐ 4.2K) - Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 210 · 🔀 1.4K · 📦 180 · 📋 1.6K - 25% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/deepchem) (📥 16K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/deepchem) (📥 94K · ⏱️ 02.12.2022):
	```
	conda install -c conda-forge deepchem
	```
</details>
<details><summary><b><a href="https://github.com/yzhao062/pyod">PyOD</a></b> (🥇35 ·  ⭐ 6.9K) - A Comprehensive and Scalable Python Library for Outlier Detection (Anomaly.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 48 · 🔀 1.2K · 📦 2.1K · 📋 290 - 51% open · ⏱️ 20.03.2023):
...
- [PyPi](https://pypi.org/project/pyod) (📥 680K / month):
	...
	pip install pyod
	```
- [Conda](https://anaconda.org/conda-forge/pyod) (📥 61K · ⏱️ 20.03.2023):
	```
	conda install -c conda-forge pyod
	```
</details>
<details><summary><b><a href="https://github.com/simonw/datasette">Datasette</a></b> (🥇33 ·  ⭐ 7.3K) - An open source multi-tool for exploring and publishing data. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/simonw/datasette) (👨‍💻 75 · 🔀 490 · 📥 43 · 📦 960 · 📋 1.6K - 29% open · ⏱️ 31.03.2023):
...
- [PyPi](https://pypi.org/project/datasette) (📥 42K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/datasette) (📥 18K · ⏱️ 11.03.2023):
	```
	conda install -c conda-forge datasette
	```
</details>
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleHub">PaddleHub</a></b> (🥈32 ·  ⭐ 11K) - Awesome pre-trained models toolkit based on PaddlePaddle... <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleHub) (👨‍💻 69 · 🔀 2K · 📥 600 · 📦 1.2K · 📋 1.2K - 43% open · ⏱️ 28.03.2023):

	```
	git clone https://github.com/PaddlePaddle/PaddleHub
	```
- [PyPi](https://pypi.org/project/paddlehub) (📥 7.3K / month):
	```
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 52 · 🔀 820 · 📦 4.9K · 📋 380 - 40% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/autograd) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/autograd) (📥 300K · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 95 · 🔀 460 · 📦 260 · 📋 410 - 1% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/online-ml/river
	```
- [PyPi](https://pypi.org/project/river) (📥 16K / month):
	```
	pip install river
	```
- [Conda](https://anaconda.org/conda-forge/river) (📥 32K · ⏱️ 31.10.2022):
	```
	conda install -c conda-forge river
	```
</details>
<details><summary><b><a href="https://github.com/adapter-hub/adapter-transformers">adapter-transformers</a></b> (🥈32 ·  ⭐ 1.4K) - Huggingface Transformers + Adapters =. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code>huggingface</code></summary>

- [GitHub](https://github.com/adapter-hub/adapter-transformers) (👨‍💻 1.7K · 🔀 240 · 📦 140 · 📋 290 - 16% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 110 · 🔀 160 · 📦 340 · 📋 530 - 20% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 68 · 🔀 180 · 📦 650 · 📋 800 - 13% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/pythran) (📥 280K / month):
	...
	pip install pythran
	```
- [Conda](https://anaconda.org/conda-forge/pythran) (📥 340K · ⏱️ 15.01.2023):
	```
...
- [GitHub](https://github.com/SeldonIO/alibi-detect) (👨‍💻 17 · 🔀 170 · 📦 330 · 📋 310 - 31% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 130 · 🔀 440 · 📥 65 · 📋 910 - 21% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pennylane) (📥 22K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pennylane) (📥 8.4K · ⏱️ 04.04.2023):
	```
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 64 · 🔀 210 · 📥 4 · 📦 24 · 📋 650 - 13% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/tableau/TabPy) (👨‍💻 47 · 🔀 530 · 📦 120 · 📋 300 - 2% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/tabpy) (📥 16K / month):
	...
	pip install tabpy
	```
- [Conda](https://anaconda.org/anaconda/tabpy-client) (📥 3.7K · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/nicodv/kmodes) (👨‍💻 21 · 🔀 390 · 📦 1.9K · 📋 150 - 10% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/kmodes) (📥 300K / month):
	...
	pip install kmodes
	```
- [Conda](https://anaconda.org/conda-forge/kmodes) (📥 27K · ⏱️ 06.09.2022):
	```
...
- [GitHub](https://github.com/deepmind/pysc2) (👨‍💻 36 · 🔀 1.1K · 📥 30K · 📦 510 · 📋 270 - 16% open · ⏱️ 07.08.2022):
...
<details><summary><b><a href="https://github.com/google/trax">Trax</a></b> (🥉26 ·  ⭐ 7.4K) - Trax Deep Learning with Clear Code and Speed. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/trax) (👨‍💻 78 · 🔀 760 · 📦 100 · 📋 220 - 44% open · ⏱️ 29.03.2023):

	```
	git clone https://github.com/google/trax
	```
- [PyPi](https://pypi.org/project/trax) (📥 8.9K / month):
	```
	pip install trax
	```
</details>
...
- [GitHub](https://github.com/scikit-learn-contrib/metric-learn) (👨‍💻 22 · 🔀 220 · 📦 260 · 📋 160 - 26% open · ⏱️ 21.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/metric-learn) (📥 31K / month):
	```
	pip install metric-learn
	```
- [Conda](https://anaconda.org/conda-forge/metric-learn) (📥 8.7K · ⏱️ 02.07.2020):
	```
...
<details><summary><b><a href="https://github.com/MaxHalford/prince">Prince</a></b> (🥉26 ·  ⭐ 970) - Multivariate exploratory data analysis in Python: PCA, CA, MCA, MFA,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 14 · 🔀 160 · 📦 330 · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 10 · 🔀 230 · 📦 350 · 📋 210 - 9% open · ⏱️ 04.08.2022):

	```
	git clone https://github.com/trevorstephens/gplearn
	```
- [PyPi](https://pypi.org/project/gplearn) (📥 6.6K / month):
	```
	pip install gplearn
	```
- [Conda](https://anaconda.org/conda-forge/gplearn) (📥 4.7K · ⏱️ 04.05.2022):
	```
	conda install -c conda-forge gplearn
	```
</details>
<details><summary><b><a href="https://github.com/dstackai/dstack">dstack</a></b> (🥉25 ·  ⭐ 590 · 📈) - Universal ML workflows as code on any cloud. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/dstackai/dstack) (👨‍💻 10 · 🔀 33 · 📦 11 · 📋 200 - 17% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/Project-MONAI/MONAILabel) (👨‍💻 45 · 🔀 140 · 📥 47K · 📋 390 - 11% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/BioPandas/biopandas">BioPandas</a></b> (🥉23 ·  ⭐ 590) - Working with molecular structures in pandas DataFrames. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1S" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/BioPandas/biopandas) (👨‍💻 10 · 🔀 110 · 📦 160 · 📋 49 - 36% open · ⏱️ 01.04.2023):
...
<details><summary><b><a href="https://github.com/kLabUM/rrcf">rrcf</a></b> (🥉22 ·  ⭐ 430) - Implementation of the Robust Random Cut Forest algorithm for anomaly detection.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/kLabUM/rrcf) (👨‍💻 5 · 🔀 95 · 📦 44 · 📋 44 - 56% open · ⏱️ 15.03.2023):

	```
	git clone https://github.com/kLabUM/rrcf
	```
- [PyPi](https://pypi.org/project/rrcf) (📥 16K / month):
	```
	pip install rrcf
	```
</details>
...
- [GitHub](https://github.com/pykale/pykale) (👨‍💻 18 · 🔀 54 · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/SforAiDl/KD_Lib">KD-Lib</a></b> (🥉15 ·  ⭐ 490) - A Pytorch Knowledge Distillation library for benchmarking and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/SforAiDl/KD_Lib) (👨‍💻 6 · 🔀 47 · 📋 62 - 20% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/KD-Lib) (📥 33 / month):
	```
	pip install KD-Lib
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/NeuralCompression) (👨‍💻 5 · 🔀 29 · 📋 61 - 3% open · ⏱️ 03.04.2023):
...
- <b><a href="https://github.com/carla-simulator/carla">carla</a></b> (🥇33 ·  ⭐ 9K) - Open-source simulator for autonomous driving research. <code>❗Unlicensed</code>
- <b><a href="https://github.com/cleanlab/cleanlab">cleanlab</a></b> (🥈30 ·  ⭐ 5.7K) - The standard data-centric AI package for data quality and machine.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- <b><a href="https://github.com/jmschrei/apricot">apricot</a></b> (🥉16 ·  ⭐ 470 · 💀) - apricot implements submodular optimization for the purpose of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/Palashio/nylon">nylon</a></b> (🥉9 ·  ⭐ 80 · 💀) - An intelligent, flexible grammar of machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
